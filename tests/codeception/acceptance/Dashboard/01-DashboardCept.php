...
$I->see(MyTasksPage::$startTaskButton);
$I->dontSee(MyTasksPage::$continueTaskButton);

$I->click(
    MyTasksPage::$startTaskButton,
    MyTasksPage::translateModelContext('Dashboard test video', 'VideoFile', 'pt')
);
