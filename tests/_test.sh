...
# API V2
start_api_mock_server $PROJECT_BASEPATH/yiiapps/rest-api/app/modules/v2/api-blueprint.md
codecept run api-v2 $CODECEPTION_GROUP_ARGS --debug --fail-fast --env=apiary
stop_api_mock_server

activate_test_config
codecept run api-v2 $CODECEPTION_GROUP_ARGS --debug --fail-fast --env=cms-rest-api
inactivate_test_config
