...
<h1>
    <?php echo Yii::t('crud', 'Presentation') ?> <small><?php echo Yii::t('crud', 'View') ?> #<?php echo $model->id ?></small></h1>
...
<ul>
    ...
    ?></ul><p><?php
    echo CHtml::link(
        Yii::t('app', 'Create'), array('sectionContent/create', 'SectionContent' => array('presentation_id' => $model->{$model->tableSchema->primaryKey}))
    );
    ?></p>
<h2>
