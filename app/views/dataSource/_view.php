<?php
/* @var DataSourceController|WorkflowUiControllerTrait $this */
/* @var DataSource|ItemTrait $data */
?>
<div class="admin-container hide">
    <?php echo TbHtml::link(
        '<i class="glyphicon-eye-open"></i> ' . Yii::t('model', 'View {model}', array('{model}' => Yii::t('model', 'Data Source'))),
        array('dataSource/view', 'id' => $data->id), array('class' => 'btn')
    ); ?>
</div>
<?php $this->widget(
    'ItemDetails',
...
<b><?php echo CHtml::encode($data->getAttributeLabel('data_source_qa_state_id')); ?>:</b>
<?php echo CHtml::encode($data->data_source_qa_state_id); ?>
<br />
...
<?php if (Yii::app()->user->checkAccess('DataSource.*')): ?>
    <div class="admin-container hide">
        <?php echo TbHtml::link(
            '<i class="glyphicon-edit"></i> ' . Yii::t('model', 'Edit {model}', array('{model}' => Yii::t('model', 'Data Source'))),
            array('dataSource/continueAuthoring', 'id' => $data->id, 'returnUrl' => Yii::app()->request->url), array('class' => 'btn')
        ); ?>
    </div>
<?php endif; ?>
<?php if (Yii::app()->user->checkAccess('Developer')): ?>
    <div class="admin-container hide">
        ...
        <?php echo TbHtml::link(
            '<i class="glyphicon-edit"></i> ' . Yii::t('model', 'Update {model}', array('{model}' => Yii::t('model', 'Data Source'))),
            array('dataSource/update', 'id' => $data->id, 'returnUrl' => Yii::app()->request->url), array('class' => 'btn')
        ); ?>
    </div>
<?php endif; ?>
