<?php
/* @var $this TeachersGuideController */
...
$this->beginWidget('bootstrap.widgets.TbModal', array('id' => 'teachers-guide-form-modal'));
...
<div class="modal-header">
	<button type="button" class="close" data-toggle="modal" data-target="#teachers-guide-form-modal">×</button>
...
<div class="modal-footer">
	<a href="#" class="btn" data-toggle="modal" data-target="#teachers-guide-form-modal">Cancel</a>
	<?php
	echo CHtml::ajaxSubmitButton('Save', CHtml::normalizeUrl(array('teachersGuide/editableCreator', 'render' => true)), array(
		...
		'success' => 'function(data, config) {
				...
				if (data && data.' . $pk . ') {
					...
					$("#teachers-guide-form-modal").modal("hide");
					$("' . $inputSelector . '")
