<?php
/* @var WaffleCategoryThing|ItemTrait $model */
/* @var WaffleCategoryThingController|WorkflowUiControllerTrait $this */
?>
<div class="<?php echo $this->getCssClasses($model); ?>">
    ...
    <?php echo CHtml::link(CHtml::encode($model->id), array('waffleCategoryThing/view', 'id' => $model->id)); ?>
    <br/>
