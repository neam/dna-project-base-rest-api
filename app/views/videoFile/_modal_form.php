...
$this->beginWidget('bootstrap.widgets.TbModal', array('id' => 'video-file-form-modal'));
...
<div class="modal-header">
	<button type="button" class="close" data-toggle="modal" data-target="#video-file-form-modal">×</button>
...
<div class="modal-footer">
	<a href="#" class="btn" data-toggle="modal" data-target="#video-file-form-modal">Cancel</a>
	<?php
	echo CHtml::ajaxSubmitButton('Save', CHtml::normalizeUrl(array('videoFile/editableCreator', 'render' => true)), array(
		...
		'success' => 'function(data, config) {
				...
				if (data && data.' . $pk . ') {
					...
					$("#video-file-form-modal").modal("hide");
					$("' . $inputSelector . '")
