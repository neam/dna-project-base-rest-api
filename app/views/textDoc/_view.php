<?php
/* @var TextDocController|WorkflowUiControllerTrait $this */
/* @var TextDoc|ItemTrait $data */
?>
<div class="admin-container hide">
    <?php echo CHtml::link('<i class="glyphicon-eye-open"></i> ' . Yii::t('model', 'View {model}', array('{model}' => Yii::t('model', 'Text Doc'))), array('textDoc/view', 'id' => $data->id), array('class' => 'btn')); ?>
</div>
<?php $this->widget(
    'ItemDetails',
    array(
...
<b><?php echo CHtml::encode($data->getAttributeLabel('text_doc_qa_state_id')); ?>:</b>
<?php echo CHtml::encode($data->text_doc_qa_state_id); ?>
<br />
...
<?php if (Yii::app()->user->checkAccess('TextDoc.*')): ?>
    <div class="admin-container hide">
        <?php echo CHtml::link(
            '<i class="glyphicon-edit"></i> ' . Yii::t('model', 'Edit {model}', array('{model}' => Yii::t('model', 'Text Doc'))),
            array('textDoc/continueAuthoring', 'id' => $data->id, 'returnUrl' => Yii::app()->request->url), array('class' => 'btn')
        ); ?>
    </div>
<?php endif; ?>
<?php if (Yii::app()->user->checkAccess('Developer')): ?>
    <div class="admin-container hide">
        ...
        <?php echo CHtml::link(
            '<i class="glyphicon-edit"></i> ' . Yii::t('model', 'Update {model}', array('{model}' => Yii::t('model', 'Text Doc'))),
            array('textDoc/update', 'id' => $data->id, 'returnUrl' => Yii::app()->request->url), array('class' => 'btn')
        ); ?>
    </div>
<?php endif; ?>
