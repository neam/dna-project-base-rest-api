...
<div class="modal-header">
	<button type="button" class="close" data-toggle="modal" data-target="#viz-view-form-modal">×</button>
...
<div class="modal-footer">
	<a href="#" class="btn" data-toggle="modal" data-target="#viz-view-form-modal">Cancel</a>
	<?php
