    ...
    <?php if ($this->action->id == 'admin'): ?>    <div class="btn-group">
        ...
        <div class="btn-group">
            ...
            $this->widget('bootstrap.widgets.TbButtonGroup', array(
                'buttons' => array(
                    array('label' => Yii::t('crud', 'Relations'), 'icon' => 'icon-search', 'items' => array(array('label' => 'originalMedia - P3Media', 'url' => array('p3Media/admin')), array('label' => 'processedMedia - P3Media', 'url' => array('p3Media/admin')),
                        )
                    ),
                ),
            ));
