<?php
/* @var WaffleIndicator|ItemTrait $model */
/* @var WaffleIndicatorController|WorkflowUiControllerTrait $this */
?>
<div class="<?php echo $this->getCssClasses($model); ?>">
    ...
    <?php echo CHtml::link(CHtml::encode($model->id), array('waffleIndicator/view', 'id' => $model->id)); ?>
    <br/>
