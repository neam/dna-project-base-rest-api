...
<h1>
	<?php echo Yii::t('crud', 'Data Chunk') ?> <small><?php echo Yii::t('crud', 'Update') ?> #<?php echo $model->id ?></small></h1>
...
<div class="btn-group">
	...
	$this->widget('bootstrap.widgets.TbButtonGroup', array(
		...
		'buttons' => array(
			array('label' => Yii::t('crud', 'Create'), 'icon' => 'icon-plus', 'url' => array('sectionContent/create', 'data_chunk_id' => $model->id), array('class' => ''))
		),
	));
	?></div>
