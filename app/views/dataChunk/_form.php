<div class="">
	...
	<div class="row">
		<div class="span8"> <!-- main inputs -->
			...
			<div class="row-fluid input-block-level-container">
				<div class="span12">
					<label for="dataSource"><?php echo Yii::t('crud', 'DataSource'); ?></label>
					<?php
					$this->widget(
					    'Relation', array(
						'model' => $model,
			...
			<div class="row-fluid input-block-level-container">
				<div class="span12">
					<label for="slideshowFile"><?php echo Yii::t('crud', 'SlideshowFile'); ?></label>
					<?php
					$this->widget(
					    'Relation', array(
						'model' => $model,
	...
	<div class="form-actions">
		...
		echo CHtml::Button(Yii::t('crud', 'Cancel'), array(
			'submit' => (isset($_GET['returnUrl'])) ? $_GET['returnUrl'] : array('datachunk/admin'),
			'class' => 'btn'
		));
