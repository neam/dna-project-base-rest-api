...
<h1>
	<?php echo Yii::t('crud', 'Exercise') ?> <small><?php echo Yii::t('crud', 'Update') ?> #<?php echo $model->id ?></small></h1>
...
<div class="btn-group">
	...
	$this->widget('bootstrap.widgets.TbButtonGroup', array(
		...
		'buttons' => array(
			array('label' => Yii::t('crud', 'Create'), 'icon' => 'icon-plus', 'url' => array('sectionContent/create', 'SectionContent' => array('exercise_id' => $model->id), 'returnUrl' => Yii::app()->request->url), array('class' => ''))
		),
	));
	?></div>
