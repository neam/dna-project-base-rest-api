<?php
/* @var WaffleTag|ItemTrait $model */
/* @var WaffleTagController|WorkflowUiControllerTrait $this */
?>
<div class="<?php echo $this->getCssClasses($model); ?>">
    ...
    <?php echo CHtml::link(CHtml::encode($model->id), array('waffleTag/view', 'id' => $model->id)); ?>
    <br/>
