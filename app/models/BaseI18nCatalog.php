...
abstract class BaseI18nCatalog extends ActiveRecord
{
    ...
    public function rules()
    {
        return array_merge(
            parent::rules(), array(
                array('version, cloned_from_id, title, about, i18n_category, po_contents, pot_import_media_id, created, modified, owner_id, i18n_catalog_qa_state_id', 'default', 'setOnEmpty' => true, 'value' => null),
                array('version, pot_import_media_id, owner_id', 'numerical', 'integerOnly' => true),
                array('cloned_from_id, i18n_catalog_qa_state_id', 'length', 'max' => 20),
                array('title, i18n_category', 'length', 'max' => 255),
                array('about, po_contents, created, modified', 'safe'),
                array('id, version, cloned_from_id, title, about, i18n_category, po_contents, pot_import_media_id, created, modified, owner_id, i18n_catalog_qa_state_id', 'safe', 'on' => 'search'),
            )
        );
    }
