...
/**
 * This is the model base class for the table "waffle_indicator_qa_state".
 *
 * Columns in table "waffle_indicator_qa_state" available as properties of the model:
 * @property string $id
 ...
 *
 * Relations of table "waffle_indicator_qa_state" available as properties of the model:
 * @property WaffleIndicator[] $waffleIndicators
 */
abstract class BaseWaffleIndicatorQaState extends ActiveRecord
{
    ...
    {
        return 'waffle_indicator_qa_state';
    }
    ...
    public function relations()
    {
        return array_merge(
            parent::relations(), array(
                'waffleIndicators' => array(self::HAS_MANY, 'WaffleIndicator', 'waffle_indicator_qa_state_id'),
            )
        );
    }
