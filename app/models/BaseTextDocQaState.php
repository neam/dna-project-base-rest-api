...
/**
 * This is the model base class for the table "text_doc_qa_state".
 *
 * Columns in table "text_doc_qa_state" available as properties of the model:
 * @property string $id
