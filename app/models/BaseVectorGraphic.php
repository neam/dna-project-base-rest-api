...
abstract class BaseVectorGraphic extends ActiveRecord
{
    ...
    public function rules()
    {
        return array_merge(
            parent::rules(), array(
                array('title, slug, about, file_media_id, created, modified', 'default', 'setOnEmpty' => true, 'value' => null),
                array('file_media_id', 'numerical', 'integerOnly' => true),
                array('title, slug, about', 'length', 'max' => 255),
                array('created, modified', 'safe'),
                array('id, title, slug, about, file_media_id, created, modified', 'safe', 'on' => 'search'),
            )
        );
    }
