...
abstract class BaseVectorGraphic extends ActiveRecord
{
    ...
    public function rules()
    {
        return array_merge(
            parent::rules(), array(
                array('version, cloned_from_id, title_en, slug_en, about_en, original_media_id, processed_media_id_en, authoring_workflow_execution_id, created, modified, node_id, slug_es, slug_fa, slug_hi, slug_pt, slug_sv, slug_cn, slug_de, title_es, title_fa, title_hi, title_pt, title_sv, title_cn, title_de, about_es, about_fa, about_hi, about_pt, about_sv, about_cn, about_de, processed_media_id_es, processed_media_id_fa, processed_media_id_hi, processed_media_id_pt, processed_media_id_sv, processed_media_id_cn, processed_media_id_de', 'default', 'setOnEmpty' => true, 'value' => null),
                ...
                array('id, version, cloned_from_id, title_en, slug_en, about_en, original_media_id, processed_media_id_en, authoring_workflow_execution_id, created, modified, node_id, slug_es, slug_fa, slug_hi, slug_pt, slug_sv, slug_cn, slug_de, title_es, title_fa, title_hi, title_pt, title_sv, title_cn, title_de, about_es, about_fa, about_hi, about_pt, about_sv, about_cn, about_de, processed_media_id_es, processed_media_id_fa, processed_media_id_hi, processed_media_id_pt, processed_media_id_sv, processed_media_id_cn, processed_media_id_de', 'safe', 'on' => 'search'),
            )
        );
    }
