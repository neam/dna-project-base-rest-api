 ...
 * @property integer $youtube_url_approved
 * @property integer $youtube_url_proofed
 *
...
abstract class BaseVideoFileQaState extends ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return array(
            ...
            'youtube_url_approved' => Yii::t('model', 'Youtube Url Approved'),
            'youtube_url_proofed' => Yii::t('model', 'Youtube Url Proofed'),
        );
    }
    ...
    public function searchCriteria($criteria = null)
    {
        ...
        $criteria->compare('t.youtube_url_approved', $this->youtube_url_approved);
        $criteria->compare('t.youtube_url_proofed', $this->youtube_url_proofed);
