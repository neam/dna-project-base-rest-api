...
/**
 * This is the model base class for the table "gui_section_qa_state".
 *
 * Columns in table "gui_section_qa_state" available as properties of the model:
 * @property string $id
 ...
 *
 * Relations of table "gui_section_qa_state" available as properties of the model:
 * @property GuiSection[] $guiSections
 */
abstract class BaseGuiSectionQaState extends ActiveRecord
{
    ...
    public function relations()
    {
        return array_merge(
            parent::relations(), array(
                'guiSections' => array(self::HAS_MANY, 'GuiSection', 'gui_section_qa_state_id'),
            )
        );
    }
