...
abstract class BaseExercise extends ActiveRecord
{
    ...
    public function rules()
    {
        return array_merge(
            parent::rules(), array(
                array('version, cloned_from_id, title_en, slug_en, question_en, description_en, thumbnail_media_id, slideshow_file_id, authoring_workflow_execution_id, created, modified, node_id, title_es, title_fa, title_hi, title_pt, title_sv, title_cn, title_de, slug_es, slug_fa, slug_hi, slug_pt, slug_sv, slug_cn, slug_de, question_es, question_fa, question_hi, question_pt, question_sv, question_cn, question_de, description_es, description_fa, description_hi, description_pt, description_sv, description_cn, description_de', 'default', 'setOnEmpty' => true, 'value' => null),
                ...
                array('id, version, cloned_from_id, title_en, slug_en, question_en, description_en, thumbnail_media_id, slideshow_file_id, authoring_workflow_execution_id, created, modified, node_id, title_es, title_fa, title_hi, title_pt, title_sv, title_cn, title_de, slug_es, slug_fa, slug_hi, slug_pt, slug_sv, slug_cn, slug_de, question_es, question_fa, question_hi, question_pt, question_sv, question_cn, question_de, description_es, description_fa, description_hi, description_pt, description_sv, description_cn, description_de', 'safe', 'on' => 'search'),
            )
        );
    }
