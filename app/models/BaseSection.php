    ...
    public function rules()
    {
        return array_merge(
            parent::rules(), array(
                ...
                array('title_en, slug_en, ordinal, menu_label_en, created, modified, slug_es, title_es, slug_fa, title_fa, slug_hi, title_hi, slug_pt, title_pt, slug_sv, title_sv, slug_de, title_de, menu_label_es, menu_label_fa, menu_label_hi, menu_label_pt, menu_label_sv, menu_label_de, slug_cn, title_cn, menu_label_cn', 'default', 'setOnEmpty' => true, 'value' => null),
                array('ordinal', 'numerical', 'integerOnly' => true),
                array('chapter_id', 'length', 'max' => 20),
                array('title_en, slug_en, menu_label_en, slug_es, title_es, slug_fa, title_fa, slug_hi, title_hi, slug_pt, title_pt, slug_sv, title_sv, slug_de, title_de, menu_label_es, menu_label_fa, menu_label_hi, menu_label_pt, menu_label_sv, menu_label_de, slug_cn, title_cn, menu_label_cn', 'length', 'max' => 255),
                array('created, modified', 'safe'),
                array('id, chapter_id, title_en, slug_en, ordinal, menu_label_en, created, modified, slug_es, title_es, slug_fa, title_fa, slug_hi, title_hi, slug_pt, title_pt, slug_sv, title_sv, slug_de, title_de, menu_label_es, menu_label_fa, menu_label_hi, menu_label_pt, menu_label_sv, menu_label_de, slug_cn, title_cn, menu_label_cn', 'safe', 'on' => 'search'),
            )
        );
    }
