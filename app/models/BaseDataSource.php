...
abstract class BaseDataSource extends ActiveRecord
{
    ...
    public function rules()
    {
        return array_merge(
            parent::rules(), array(
                array('version, cloned_from_id, title, slug_en, about, logo_media_id, mini_logo_media_id, link, created, modified, node_id, slug_es, slug_fa, slug_hi, slug_pt, slug_sv, slug_cn, slug_de, data_source_qa_state_id_en, data_source_qa_state_id_es, data_source_qa_state_id_fa, data_source_qa_state_id_hi, data_source_qa_state_id_pt, data_source_qa_state_id_sv, data_source_qa_state_id_cn, data_source_qa_state_id_de', 'default', 'setOnEmpty' => true, 'value' => null),
                ...
                array('id, version, cloned_from_id, title, slug_en, about, logo_media_id, mini_logo_media_id, link, created, modified, node_id, slug_es, slug_fa, slug_hi, slug_pt, slug_sv, slug_cn, slug_de, data_source_qa_state_id_en, data_source_qa_state_id_es, data_source_qa_state_id_fa, data_source_qa_state_id_hi, data_source_qa_state_id_pt, data_source_qa_state_id_sv, data_source_qa_state_id_cn, data_source_qa_state_id_de', 'safe', 'on' => 'search'),
            )
        );
    }
