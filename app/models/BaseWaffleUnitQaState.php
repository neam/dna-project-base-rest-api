...
/**
 * This is the model base class for the table "waffle_unit_qa_state".
 *
 * Columns in table "waffle_unit_qa_state" available as properties of the model:
 * @property string $id
 ...
 *
 * Relations of table "waffle_unit_qa_state" available as properties of the model:
 * @property WaffleUnit[] $waffleUnits
 */
abstract class BaseWaffleUnitQaState extends ActiveRecord
{
    ...
    public function relations()
    {
        return array_merge(
            parent::relations(), array(
                'waffleUnits' => array(self::HAS_MANY, 'WaffleUnit', 'waffle_unit_qa_state_id'),
            )
        );
    }
