 ...
 * @property ChapterAssociation[] $chapterAssociations
 */
abstract class BaseChapter extends CActiveRecord{
	...
	{
		return array(
			'chapterAssociations' => array(self::HAS_MANY, 'ChapterAssociation', 'chapter_id'),
		);
	}
