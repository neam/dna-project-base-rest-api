...
/**
 * This is the model base class for the table "chapter_association".
 *
 * Columns in table "chapter_association" available as properties of the model:
 * @property string $id
 ...
 *
 * Relations of table "chapter_association" available as properties of the model:
 ...
 */
abstract class BaseChapterAssociation extends CActiveRecord{
	...
	public function rules()
	{
		return array_merge(
		    parent::rules(), array(
			array('chapter_id, viz_view_id, video_file_id, teachers_guide_id, exercise_id, presentation_id, data_chunk_id', 'required'),
			array('ordinal, title, created, modified', 'default', 'setOnEmpty' => true, 'value' => null),
			array('ordinal', 'numerical', 'integerOnly'=>true),
			array('chapter_id, viz_view_id, video_file_id, teachers_guide_id, exercise_id, presentation_id, data_chunk_id', 'length', 'max'=>20),
			array('title', 'length', 'max'=>255),
			array('created, modified', 'safe'),
			array('id, chapter_id, ordinal, title, created, modified, viz_view_id, video_file_id, teachers_guide_id, exercise_id, presentation_id, data_chunk_id', 'safe', 'on'=>'search'),
		    )
		);
	}
