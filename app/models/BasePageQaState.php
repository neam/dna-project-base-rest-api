...
/**
 * This is the model base class for the table "page_qa_state".
 *
 * Columns in table "page_qa_state" available as properties of the model:
 * @property string $id
 ...
 *
 * Relations of table "page_qa_state" available as properties of the model:
 * @property Page[] $pages
 */
abstract class BasePageQaState extends ActiveRecord
{
    ...
    public function relations()
    {
        return array_merge(
            parent::relations(), array(
                'pages' => array(self::HAS_MANY, 'Page', 'page_qa_state_id'),
            )
        );
    }
