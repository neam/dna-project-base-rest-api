...
/**
 * This is the model base class for the table "vector_graphic_qa_state".
 *
 * Columns in table "vector_graphic_qa_state" available as properties of the model:
 * @property string $id
 ...
 * @property integer $processed_media_id_en_approved
 ...
 * @property integer $processed_media_id_en_proofed
...
abstract class BaseVectorGraphicQaState extends ActiveRecord
{
    ...
    {
        return 'vector_graphic_qa_state';
    }
    ...
    public function rules()
    {
        return array_merge(
            parent::rules(), array(
                array('status, translations_draft_validation_progress, translations_preview_validation_progress, translations_public_validation_progress, translations_approval_progress, translations_proofing_progress, slug_approved, file_approved, draft_validation_progress, slug_proofed, preview_validation_progress, file_proofed, public_validation_progress, translate_into_en_validation_progress, translate_into_ar_validation_progress, translate_into_bg_validation_progress, translate_into_ca_validation_progress, translate_into_cs_validation_progress, translate_into_da_validation_progress, translate_into_de_validation_progress, translate_into_en_gb_validation_progress, translate_into_en_us_validation_progress, translate_into_el_validation_progress, translate_into_es_validation_progress, translate_into_fi_validation_progress, translate_into_fil_validation_progress, translate_into_fr_validation_progress, translate_into_hi_validation_progress, translate_into_hr_validation_progress, translate_into_hu_validation_progress, translate_into_id_validation_progress, translate_into_iw_validation_progress, translate_into_it_validation_progress, translate_into_ja_validation_progress, translate_into_ko_validation_progress, translate_into_lt_validation_progress, translate_into_lv_validation_progress, translate_into_nl_validation_progress, translate_into_no_validation_progress, translate_into_pl_validation_progress, translate_into_pt_validation_progress, translate_into_pt_br_validation_progress, translate_into_pt_pt_validation_progress, translate_into_ro_validation_progress, translate_into_ru_validation_progress, translate_into_sk_validation_progress, translate_into_sl_validation_progress, translate_into_sr_validation_progress, translate_into_sv_validation_progress, translate_into_th_validation_progress, translate_into_tr_validation_progress, translate_into_uk_validation_progress, translate_into_vi_validation_progress, translate_into_zh_validation_progress, approval_progress, proofing_progress, translate_into_zh_cn_validation_progress, previewing_welcome, translate_into_zh_tw_validation_progress, candidate_for_public_status, slug_en_approved, title_en_approved, original_media_id_approved, processed_media_id_en_approved, title_approved, slug_en_proofed, title_en_proofed, original_media_id_proofed, processed_media_id_en_proofed, title_proofed', 'default', 'setOnEmpty' => true, 'value' => null),
                array('translations_draft_validation_progress, translations_preview_validation_progress, translations_public_validation_progress, translations_approval_progress, translations_proofing_progress, slug_approved, file_approved, draft_validation_progress, slug_proofed, preview_validation_progress, file_proofed, public_validation_progress, translate_into_en_validation_progress, translate_into_ar_validation_progress, translate_into_bg_validation_progress, translate_into_ca_validation_progress, translate_into_cs_validation_progress, translate_into_da_validation_progress, translate_into_de_validation_progress, translate_into_en_gb_validation_progress, translate_into_en_us_validation_progress, translate_into_el_validation_progress, translate_into_es_validation_progress, translate_into_fi_validation_progress, translate_into_fil_validation_progress, translate_into_fr_validation_progress, translate_into_hi_validation_progress, translate_into_hr_validation_progress, translate_into_hu_validation_progress, translate_into_id_validation_progress, translate_into_iw_validation_progress, translate_into_it_validation_progress, translate_into_ja_validation_progress, translate_into_ko_validation_progress, translate_into_lt_validation_progress, translate_into_lv_validation_progress, translate_into_nl_validation_progress, translate_into_no_validation_progress, translate_into_pl_validation_progress, translate_into_pt_validation_progress, translate_into_pt_br_validation_progress, translate_into_pt_pt_validation_progress, translate_into_ro_validation_progress, translate_into_ru_validation_progress, translate_into_sk_validation_progress, translate_into_sl_validation_progress, translate_into_sr_validation_progress, translate_into_sv_validation_progress, translate_into_th_validation_progress, translate_into_tr_validation_progress, translate_into_uk_validation_progress, translate_into_vi_validation_progress, translate_into_zh_validation_progress, approval_progress, proofing_progress, translate_into_zh_cn_validation_progress, previewing_welcome, translate_into_zh_tw_validation_progress, candidate_for_public_status, slug_en_approved, title_en_approved, original_media_id_approved, processed_media_id_en_approved, title_approved, slug_en_proofed, title_en_proofed, original_media_id_proofed, processed_media_id_en_proofed, title_proofed', 'numerical', 'integerOnly' => true),
                array('status', 'length', 'max' => 255),
                array('id, status, translations_draft_validation_progress, translations_preview_validation_progress, translations_public_validation_progress, translations_approval_progress, translations_proofing_progress, slug_approved, file_approved, draft_validation_progress, slug_proofed, preview_validation_progress, file_proofed, public_validation_progress, translate_into_en_validation_progress, translate_into_ar_validation_progress, translate_into_bg_validation_progress, translate_into_ca_validation_progress, translate_into_cs_validation_progress, translate_into_da_validation_progress, translate_into_de_validation_progress, translate_into_en_gb_validation_progress, translate_into_en_us_validation_progress, translate_into_el_validation_progress, translate_into_es_validation_progress, translate_into_fi_validation_progress, translate_into_fil_validation_progress, translate_into_fr_validation_progress, translate_into_hi_validation_progress, translate_into_hr_validation_progress, translate_into_hu_validation_progress, translate_into_id_validation_progress, translate_into_iw_validation_progress, translate_into_it_validation_progress, translate_into_ja_validation_progress, translate_into_ko_validation_progress, translate_into_lt_validation_progress, translate_into_lv_validation_progress, translate_into_nl_validation_progress, translate_into_no_validation_progress, translate_into_pl_validation_progress, translate_into_pt_validation_progress, translate_into_pt_br_validation_progress, translate_into_pt_pt_validation_progress, translate_into_ro_validation_progress, translate_into_ru_validation_progress, translate_into_sk_validation_progress, translate_into_sl_validation_progress, translate_into_sr_validation_progress, translate_into_sv_validation_progress, translate_into_th_validation_progress, translate_into_tr_validation_progress, translate_into_uk_validation_progress, translate_into_vi_validation_progress, translate_into_zh_validation_progress, approval_progress, proofing_progress, translate_into_zh_cn_validation_progress, previewing_welcome, translate_into_zh_tw_validation_progress, candidate_for_public_status, slug_en_approved, title_en_approved, original_media_id_approved, processed_media_id_en_approved, title_approved, slug_en_proofed, title_en_proofed, original_media_id_proofed, processed_media_id_en_proofed, title_proofed', 'safe', 'on' => 'search'),
            )
        );
    }
    ...
    public function attributeLabels()
    {
        return array(
            ...
            'processed_media_id_en_approved' => Yii::t('model', 'Processed Media Id En Approved'),
            ...
            'processed_media_id_en_proofed' => Yii::t('model', 'Processed Media Id En Proofed'),
    ...
    public function searchCriteria($criteria = null)
    {
        ...
        $criteria->compare('t.processed_media_id_en_approved', $this->processed_media_id_en_approved);
        ...
        $criteria->compare('t.processed_media_id_en_proofed', $this->processed_media_id_en_proofed);
