 ...
 * @property integer $translate_into_he_validation_progress
...
abstract class BaseVectorGraphicQaState extends ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return array(
            ...
            'translate_into_he_validation_progress' => Yii::t('model', 'Translate Into He Validation Progress'),
    ...
    public function searchCriteria($criteria = null)
    {
        ...
        $criteria->compare('t.translate_into_he_validation_progress', $this->translate_into_he_validation_progress);
