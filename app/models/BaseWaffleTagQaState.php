...
/**
 * This is the model base class for the table "waffle_tag_qa_state".
 *
 * Columns in table "waffle_tag_qa_state" available as properties of the model:
 * @property string $id
 ...
 *
 * Relations of table "waffle_tag_qa_state" available as properties of the model:
 * @property WaffleTag[] $waffleTags
 */
abstract class BaseWaffleTagQaState extends ActiveRecord
{
    ...
    public function relations()
    {
        return array_merge(
            parent::relations(), array(
                'waffleTags' => array(self::HAS_MANY, 'WaffleTag', 'waffle_tag_qa_state_id'),
            )
        );
    }
