...
/**
 * This is the model base class for the table "menu_qa_state".
 *
 * Columns in table "menu_qa_state" available as properties of the model:
 * @property string $id
 ...
 * @property integer $pages_approved
 * @property integer $title_proofed
 * @property integer $slug_proofed
 * @property integer $pages_proofed
 * @property integer $translate_into_fa_validation_progress
 *
 * Relations of table "menu_qa_state" available as properties of the model:
 * @property Menu[] $menus
 */
abstract class BaseMenuQaState extends ActiveRecord
{
    ...
    public function relations()
    {
        return array_merge(
            parent::relations(), array(
                'menus' => array(self::HAS_MANY, 'Menu', 'menu_qa_state_id'),
            )
        );
    }
    ...
    public function attributeLabels()
    {
        return array(
            ...
            'pages_approved' => Yii::t('model', 'Pages Approved'),
            'title_proofed' => Yii::t('model', 'Title Proofed'),
            'slug_proofed' => Yii::t('model', 'Slug Proofed'),
            'pages_proofed' => Yii::t('model', 'Pages Proofed'),
    ...
    public function searchCriteria($criteria = null)
    {
        ...
        $criteria->compare('t.pages_approved', $this->pages_approved);
        $criteria->compare('t.title_proofed', $this->title_proofed);
        $criteria->compare('t.slug_proofed', $this->slug_proofed);
        $criteria->compare('t.pages_proofed', $this->pages_proofed);
