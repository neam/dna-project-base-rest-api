<div class="view well well-white">
    ...
    <div class="admin-container hide">
        <?php echo CHtml::link('<i class="icon-eye-open"></i> ' . Yii::t('model', 'View {model}', array('{model}' => Yii::t('model', 'Source Message'))), array('sourceMessage/view', 'id' => $data->id), array('class' => 'btn')); ?>
    </div>
