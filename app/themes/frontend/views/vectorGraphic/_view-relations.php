...
$this->widget(
    ...
    array(
        ...
        'buttons' => array(
            array(
                'icon' => 'icon-list-alt',
                'url' => array('///dataChunk/admin', 'DataChunk' => array('vector_graphic_id' => $model->{$model->tableSchema->primaryKey}))
            ),
            array(
                'icon' => 'icon-plus',
                'url' => array(
                    '///dataChunk/create',
                    'DataChunk' => array('vector_graphic_id' => $model->{$model->tableSchema->primaryKey})
                )
            ),
