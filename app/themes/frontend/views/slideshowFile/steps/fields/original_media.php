...
$("#SlideshowFile_original_media_id").data('select2opts', select2opts);
$("#SlideshowFile_original_media_id").select2($("#SlideshowFile_original_media_id").data('select2opts'));
...
<?php
$formId = 'chapter-original_media_id-' . \uniqid() . '-form';
?>
...
<p class="alert alert-info help-block">
    <?php echo $model->getAttributeHint("original_media_id"); ?>
</p>