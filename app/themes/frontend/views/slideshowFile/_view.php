<div class="view well well-white">
    ...
    <div class="admin-container show">
        <?php echo CHtml::link('<i class="icon-eye"></i> ' . Yii::t('model', 'View {model}', array('{model}' => Yii::t('model', 'Slideshow File'))), array('slideshowFile/view', 'id' => $data->id), array('class' => 'btn')); ?>
    </div>
    ...
    <b><?php echo CHtml::encode($data->getAttributeLabel('slideshow_file_qa_state_id_en')); ?>:</b>
    <?php echo CHtml::encode($data->slideshow_file_qa_state_id_en); ?>
    <br />

    <b><?php echo CHtml::encode($data->getAttributeLabel('slideshow_file_qa_state_id_es')); ?>:</b>
    <?php echo CHtml::encode($data->slideshow_file_qa_state_id_es); ?>
    <br />

    <b><?php echo CHtml::encode($data->getAttributeLabel('slideshow_file_qa_state_id_fa')); ?>:</b>
    <?php echo CHtml::encode($data->slideshow_file_qa_state_id_fa); ?>
    <br />

    <b><?php echo CHtml::encode($data->getAttributeLabel('slideshow_file_qa_state_id_hi')); ?>:</b>
    <?php echo CHtml::encode($data->slideshow_file_qa_state_id_hi); ?>
    <br />

    <b><?php echo CHtml::encode($data->getAttributeLabel('slideshow_file_qa_state_id_pt')); ?>:</b>
    <?php echo CHtml::encode($data->slideshow_file_qa_state_id_pt); ?>
    <br />

    <b><?php echo CHtml::encode($data->getAttributeLabel('slideshow_file_qa_state_id_sv')); ?>:</b>
    <?php echo CHtml::encode($data->slideshow_file_qa_state_id_sv); ?>
    <br />

    <b><?php echo CHtml::encode($data->getAttributeLabel('slideshow_file_qa_state_id_cn')); ?>:</b>
    <?php echo CHtml::encode($data->slideshow_file_qa_state_id_cn); ?>
    <br />

    <b><?php echo CHtml::encode($data->getAttributeLabel('slideshow_file_qa_state_id_de')); ?>:</b>
    <?php echo CHtml::encode($data->slideshow_file_qa_state_id_de); ?>
    <br />
