<div class="view well well-white">
    ...
    <div class="admin-container hide">
        <?php echo CHtml::link('<i class="glyphicon-eye-open"></i> ' . Yii::t('model', 'View {model}', array('{model}' => Yii::t('model', 'Slideshow File'))), array('slideshowFile/view', 'id' => $data->id), array('class' => 'btn')); ?>
    </div>
