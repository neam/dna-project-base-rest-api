    ...
    array(
        ...
        'buttons' => array(
            array(
                ...
                'url' => array('///waffleIndicator/admin', 'WaffleIndicator' => array('cloned_from_id' => $model->{$model->tableSchema->primaryKey}))
            ),
            array(
                'icon' => 'glyphicon-plus',
                'url' => array(
                    '///waffleIndicator/create',
                    'WaffleIndicator' => array('cloned_from_id' => $model->{$model->tableSchema->primaryKey})
                )
            ),
