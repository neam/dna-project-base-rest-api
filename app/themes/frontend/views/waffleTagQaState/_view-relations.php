    ...
    array(
        ...
        'buttons' => array(
            array(
                ...
                'url' => array('///waffleTag/admin', 'WaffleTag' => array('waffle_tag_qa_state_id' => $model->{$model->tableSchema->primaryKey}))
            ),
            array(
                'icon' => 'glyphicon-plus',
                'url' => array(
                    '///waffleTag/create',
                    'WaffleTag' => array('waffle_tag_qa_state_id' => $model->{$model->tableSchema->primaryKey})
                )
            ),
