    ...
    array(
        ...
        'buttons' => array(
            array(
                ...
                'url' => array('///waffleDataSource/admin', 'WaffleDataSource' => array('cloned_from_id' => $model->{$model->tableSchema->primaryKey}))
            ),
            array(
                'icon' => 'glyphicon-plus',
                'url' => array(
                    '///waffleDataSource/create',
                    'WaffleDataSource' => array('cloned_from_id' => $model->{$model->tableSchema->primaryKey})
                )
            ),
