    ...
    array(
        ...
        'buttons' => array(
            array(
                ...
                'url' => array('///guiSection/admin', 'GuiSection' => array('i18n_catalog_id' => $model->{$model->tableSchema->primaryKey}))
            ),
            array(
                'icon' => 'glyphicon-plus',
                'url' => array(
                    '///guiSection/create',
                    'GuiSection' => array('i18n_catalog_id' => $model->{$model->tableSchema->primaryKey})
                )
            ),
...
$this->widget(
    ...
    array(
        ...
        'buttons' => array(
            array(
                'icon' => 'glyphicon-list-alt',
                'url' => array('///i18nCatalog/admin', 'I18nCatalog' => array('cloned_from_id' => $model->{$model->tableSchema->primaryKey}))
            ),
            array(
                'icon' => 'glyphicon-plus',
                'url' => array(
                    '///i18nCatalog/create',
                    'I18nCatalog' => array('cloned_from_id' => $model->{$model->tableSchema->primaryKey})
                )
            ),
...
$this->widget(
    ...
    array(
        ...
        'buttons' => array(
            array(
                'icon' => 'glyphicon-list-alt',
                'url' => array('///tool/admin', 'Tool' => array('i18n_catalog_id' => $model->{$model->tableSchema->primaryKey}))
            ),
            array(
                'icon' => 'glyphicon-plus',
                'url' => array(
                    '///tool/create',
                    'Tool' => array('i18n_catalog_id' => $model->{$model->tableSchema->primaryKey})
                )
            ),
