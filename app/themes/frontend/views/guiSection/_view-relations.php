    ...
    array(
        ...
        'buttons' => array(
            array(
                ...
                'url' => array('///guiSection/admin', 'GuiSection' => array('cloned_from_id' => $model->{$model->tableSchema->primaryKey}))
            ),
            array(
                'icon' => 'glyphicon-plus',
                'url' => array(
                    '///guiSection/create',
                    'GuiSection' => array('cloned_from_id' => $model->{$model->tableSchema->primaryKey})
                )
            ),
