<div class="view">
    ...
    <?php echo CHtml::link(CHtml::encode($data->id), array('vizView/view', 'id' => $data->id)); ?>
    <br/>
    ...
    */
    ...
    <?php if (Yii::app()->user->checkAccess('VizView.*')): ?>
        <div class="admin-container show">
            <?php echo CHtml::link('<i class="icon-edit"></i> ' . Yii::t('model', 'Update {model}', array('{model}' => Yii::t('model', 'Viz View'))), array('vizView/update', 'id' => $data->id, 'returnUrl' => Yii::app()->request->url), array('class' => 'btn')); ?>
        </div>
    <?php endif; ?>
