    ...
    array(
        ...
        'buttons' => array(
            array(
                ...
                'url' => array('///waffleIndicator/admin', 'WaffleIndicator' => array('waffle_indicator_qa_state_id' => $model->{$model->tableSchema->primaryKey}))
            ),
            array(
                'icon' => 'glyphicon-plus',
                'url' => array(
                    '///waffleIndicator/create',
                    'WaffleIndicator' => array('waffle_indicator_qa_state_id' => $model->{$model->tableSchema->primaryKey})
                )
            ),
