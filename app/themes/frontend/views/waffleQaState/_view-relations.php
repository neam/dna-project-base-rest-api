    ...
    array(
        ...
        'buttons' => array(
            array(
                ...
                'url' => array('///waffle/admin', 'Waffle' => array('waffle_qa_state_id' => $model->{$model->tableSchema->primaryKey}))
            ),
            array(
                'icon' => 'glyphicon-plus',
                'url' => array(
                    '///waffle/create',
                    'Waffle' => array('waffle_qa_state_id' => $model->{$model->tableSchema->primaryKey})
                )
            ),
