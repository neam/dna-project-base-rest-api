<div class="view well well-white">
    ...
    <div class="admin-container show">
        <?php echo CHtml::link('<i class="icon-eye-open"></i> ' . Yii::t('model', 'View {model}', array('{model}' => Yii::t('model', 'Data Chunk'))), array('dataChunk/view', 'id' => $data->id), array('class' => 'btn')); ?>
    </div>
    ...
    */
    ...
    <?php if (Yii::app()->user->checkAccess('DataChunk.*')): ?>
        <div class="admin-container show">
            <?php echo CHtml::link('<i class="icon-edit"></i> ' . Yii::t('model', 'Edit {model}', array('{model}' => Yii::t('model', 'Data Chunk'))), array('dataChunk/continueAuthoring', 'id' => $data->id, 'returnUrl' => Yii::app()->request->url), array('class' => 'btn')); ?>
        </div>
    <?php endif; ?>
