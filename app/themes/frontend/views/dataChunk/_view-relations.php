    ...
    array(
        ...
        'buttons' => array(
            array(
                ...
                'url' => array('///dataArticle/admin', 'DataArticle' => array('cloned_from_id' => $model->{$model->tableSchema->primaryKey}))
            ),
            array(
                'icon' => 'glyphicon-plus',
                'url' => array(
                    '///dataArticle/create',
                    'DataArticle' => array('cloned_from_id' => $model->{$model->tableSchema->primaryKey})
                )
            ),
...
$this->widget(
    ...
    array(
        ...
        'buttons' => array(
            array(
                'icon' => 'glyphicon-list-alt',
                'url' => array('///sectionContent/admin', 'SectionContent' => array('data_chunk_id' => $model->{$model->tableSchema->primaryKey}))
            ),
            array(
                'icon' => 'glyphicon-plus',
                'url' => array(
