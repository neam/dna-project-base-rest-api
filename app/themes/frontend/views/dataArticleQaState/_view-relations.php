    ...
    array(
        ...
        'buttons' => array(
            array(
                ...
                'url' => array('///dataArticle/admin', 'DataArticle' => array('data_article_qa_state_id' => $model->{$model->tableSchema->primaryKey}))
            ),
            array(
                'icon' => 'glyphicon-plus',
                'url' => array(
                    '///dataArticle/create',
                    'DataArticle' => array('data_article_qa_state_id' => $model->{$model->tableSchema->primaryKey})
                )
            ),
