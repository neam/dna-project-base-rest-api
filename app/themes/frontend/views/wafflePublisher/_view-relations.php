    ...
    array(
        ...
        'buttons' => array(
            array(
                ...
                'url' => array('///waffle/admin', 'Waffle' => array('waffle_publisher_id' => $model->{$model->tableSchema->primaryKey}))
            ),
            array(
                'icon' => 'glyphicon-plus',
                'url' => array(
                    '///waffle/create',
                    'Waffle' => array('waffle_publisher_id' => $model->{$model->tableSchema->primaryKey})
                )
            ),
...
$this->widget(
    ...
    array(
        ...
        'buttons' => array(
            array(
                'icon' => 'glyphicon-list-alt',
                'url' => array('///wafflePublisher/admin', 'WafflePublisher' => array('cloned_from_id' => $model->{$model->tableSchema->primaryKey}))
            ),
            array(
                'icon' => 'glyphicon-plus',
                'url' => array(
                    '///wafflePublisher/create',
                    'WafflePublisher' => array('cloned_from_id' => $model->{$model->tableSchema->primaryKey})
                )
            ),
