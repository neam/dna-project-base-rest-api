    ...
    array(
        ...
        'buttons' => array(
            array(
                ...
                'url' => array('///waffleUnit/admin', 'WaffleUnit' => array('waffle_unit_qa_state_id' => $model->{$model->tableSchema->primaryKey}))
            ),
            array(
                'icon' => 'glyphicon-plus',
                'url' => array(
                    '///waffleUnit/create',
                    'WaffleUnit' => array('waffle_unit_qa_state_id' => $model->{$model->tableSchema->primaryKey})
                )
            ),
