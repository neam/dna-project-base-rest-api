    ...
    array(
        ...
        'buttons' => array(
            array(
                ...
                'url' => array('///waffleCategory/admin', 'WaffleCategory' => array('waffle_category_qa_state_id' => $model->{$model->tableSchema->primaryKey}))
            ),
            array(
                'icon' => 'glyphicon-plus',
                'url' => array(
                    '///waffleCategory/create',
                    'WaffleCategory' => array('waffle_category_qa_state_id' => $model->{$model->tableSchema->primaryKey})
                )
            ),
