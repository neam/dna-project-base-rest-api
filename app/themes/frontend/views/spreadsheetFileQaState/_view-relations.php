    ...
    array(
        ...
        'buttons' => array(
            array(
                ...
                'url' => array('///spreadsheetFile/admin', 'SpreadsheetFile' => array('spreadsheet_file_qa_state_id' => $model->{$model->tableSchema->primaryKey}))
            ),
            array(
                'icon' => 'glyphicon-plus',
                'url' => array(
                    '///spreadsheetFile/create',
                    'SpreadsheetFile' => array('spreadsheet_file_qa_state_id' => $model->{$model->tableSchema->primaryKey})
                )
            ),
