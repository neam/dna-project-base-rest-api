<div class="view well well-white">
    ...
    <div class="admin-container hide">
        <?php echo CHtml::link('<i class="glyphicon-eye-open"></i> ' . Yii::t('model', 'View {model}', array('{model}' => Yii::t('model', 'Spreadsheet File Qa State'))), array('spreadsheetFileQaState/view', 'id' => $data->id), array('class' => 'btn')); ?>
    </div>
    <b><?php echo CHtml::encode($data->getAttributeLabel('id')); ?>:</b>
    <?php echo CHtml::link(CHtml::encode($data->id), array('spreadsheetFileQaState/view', 'id' => $data->id)); ?>
    <br/>
    ...
    <b><?php echo CHtml::encode($data->getAttributeLabel('processed_media_id_en_approved')); ?>:</b>
    <?php echo CHtml::encode($data->processed_media_id_en_approved); ?>
    <br />
    ...
    <b><?php echo CHtml::encode($data->getAttributeLabel('processed_media_id_en_proofed')); ?>:</b>
    <?php echo CHtml::encode($data->processed_media_id_en_proofed); ?>
    <br />
    ...
    */
    ?>
    <?php if (Yii::app()->user->checkAccess('SpreadsheetFileQaState.*')): ?>
        <div class="admin-container hide">
            <?php echo CHtml::link('<i class="glyphicon-edit"></i> ' . Yii::t('model', 'Edit {model}', array('{model}' => Yii::t('model', 'Spreadsheet File Qa State'))), array('spreadsheetFileQaState/continueAuthoring', 'id' => $data->id, 'returnUrl' => Yii::app()->request->url), array('class' => 'btn')); ?>
        </div>
    <?php endif; ?>
    <?php if (Yii::app()->user->checkAccess('Developer')): ?>
        <div class="admin-container hide">
            <h3>Developer access</h3>
            <?php echo CHtml::link('<i class="glyphicon-edit"></i> ' . Yii::t('model', 'Update {model}', array('{model}' => Yii::t('model', 'Spreadsheet File Qa State'))), array('spreadsheetFileQaState/update', 'id' => $data->id, 'returnUrl' => Yii::app()->request->url), array('class' => 'btn')); ?>
        </div>
    <?php endif; ?>
