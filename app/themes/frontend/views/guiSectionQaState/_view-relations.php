    ...
    array(
        ...
        'buttons' => array(
            array(
                ...
                'url' => array('///guiSection/admin', 'GuiSection' => array('gui_section_qa_state_id' => $model->{$model->tableSchema->primaryKey}))
            ),
            array(
                'icon' => 'glyphicon-plus',
                'url' => array(
                    '///guiSection/create',
                    'GuiSection' => array('gui_section_qa_state_id' => $model->{$model->tableSchema->primaryKey})
                )
            ),
