    ...
    array(
        ...
        'buttons' => array(
            array(
                ...
                'url' => array('///waffleTag/admin', 'WaffleTag' => array('cloned_from_id' => $model->{$model->tableSchema->primaryKey}))
            ),
            array(
                'icon' => 'glyphicon-plus',
                'url' => array(
                    '///waffleTag/create',
                    'WaffleTag' => array('cloned_from_id' => $model->{$model->tableSchema->primaryKey})
                )
            ),
