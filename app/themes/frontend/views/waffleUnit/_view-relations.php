    ...
    array(
        ...
        'buttons' => array(
            array(
                ...
                'url' => array('///waffleUnit/admin', 'WaffleUnit' => array('cloned_from_id' => $model->{$model->tableSchema->primaryKey}))
            ),
            array(
                'icon' => 'glyphicon-plus',
                'url' => array(
                    '///waffleUnit/create',
                    'WaffleUnit' => array('cloned_from_id' => $model->{$model->tableSchema->primaryKey})
                )
            ),
