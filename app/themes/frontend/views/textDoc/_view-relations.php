...
$this->widget(
    ...
    array(
        ...
        'buttons' => array(
            array(
                'icon' => 'icon-list-alt',
                'url' => array('///textDoc/admin', 'TextDoc' => array('cloned_from_id' => $model->{$model->tableSchema->primaryKey}))
            ),
            array(
                'icon' => 'icon-plus',
                'url' => array(
                    '///textDoc/create',
                    'TextDoc' => array('cloned_from_id' => $model->{$model->tableSchema->primaryKey})
                )
            ),
