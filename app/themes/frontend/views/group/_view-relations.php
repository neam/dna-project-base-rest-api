    ...
    array(
        ...
        'buttons' => array(
            array(
                ...
                'url' => array('///groupHasAccount/admin', 'GroupHasAccount' => array('group_id' => $model->{$model->tableSchema->primaryKey}))
            ),
            array(
                'icon' => 'glyphicon-plus',
                'url' => array(
                    '///groupHasAccount/create',
                    'GroupHasAccount' => array('group_id' => $model->{$model->tableSchema->primaryKey})
                )
            ),
...
$this->widget(
    ...
    array(
        ...
        'buttons' => array(
            array(
                'icon' => 'glyphicon-list-alt',
                'url' => array('///nodeHasGroup/admin', 'NodeHasGroup' => array('group_id' => $model->{$model->tableSchema->primaryKey}))
            ),
            array(
                'icon' => 'glyphicon-plus',
                'url' => array(
                    '///nodeHasGroup/create',
                    'NodeHasGroup' => array('group_id' => $model->{$model->tableSchema->primaryKey})
                )
            ),
