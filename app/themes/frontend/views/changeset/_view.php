<div class="view well well-white">
    ...
    <div class="admin-container show">
        <?php echo CHtml::link('<i class="icon-eye-open"></i> ' . Yii::t('model', 'View {model}', array('{model}' => Yii::t('model', 'Changeset'))), array('changeset/view', 'id' => $data->id), array('class' => 'btn')); ?>
    </div>
    ...
    <?php if (Yii::app()->user->checkAccess('Changeset.*')): ?>
        <div class="admin-container show">
            <?php echo CHtml::link('<i class="icon-edit"></i> ' . Yii::t('model', 'Edit {model}', array('{model}' => Yii::t('model', 'Changeset'))), array('changeset/continueAuthoring', 'id' => $data->id, 'returnUrl' => Yii::app()->request->url), array('class' => 'btn')); ?>
        </div>
    <?php endif; ?>
