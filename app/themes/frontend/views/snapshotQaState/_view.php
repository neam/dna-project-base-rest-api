<div class="view well well-white">
    ...
    <div class="admin-container show">
        <?php echo CHtml::link('<i class="icon-eye"></i> ' . Yii::t('model', 'View {model}', array('{model}' => Yii::t('model', 'Snapshot Qa State'))), array('snapshotQaState/view', 'id' => $data->id), array('class' => 'btn')); ?>
    </div>
