    ...
    array(
        ...
        'buttons' => array(
            array(
                ...
                'url' => array('///waffleCategory/admin', 'WaffleCategory' => array('cloned_from_id' => $model->{$model->tableSchema->primaryKey}))
            ),
            array(
                'icon' => 'glyphicon-plus',
                'url' => array(
                    '///waffleCategory/create',
                    'WaffleCategory' => array('cloned_from_id' => $model->{$model->tableSchema->primaryKey})
                )
            ),
...
$this->widget(
    ...
    array(
        ...
        'buttons' => array(
            array(
                'icon' => 'glyphicon-list-alt',
                'url' => array('///waffleCategoryElement/admin', 'WaffleCategoryElement' => array('waffle_category_id' => $model->{$model->tableSchema->primaryKey}))
            ),
            array(
                'icon' => 'glyphicon-plus',
                'url' => array(
                    '///waffleCategoryElement/create',
                    'WaffleCategoryElement' => array('waffle_category_id' => $model->{$model->tableSchema->primaryKey})
                )
            ),
