<div class="view well well-white">
    ...
    <div class="admin-container show">
        <?php echo CHtml::link('<i class="icon-eye"></i> ' . Yii::t('model', 'View {model}', array('{model}' => Yii::t('model', 'Vector Graphic Qa State'))), array('vectorGraphicQaState/view', 'id' => $data->id), array('class' => 'btn')); ?>
    </div>
