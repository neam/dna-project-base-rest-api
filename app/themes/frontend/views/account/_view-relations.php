...
$this->widget(
    ...
    array(
        ...
        'buttons' => array(
            array(
                'icon' => 'glyphicon-list-alt',
                'url' => array('///waffleCategoryThing/admin', 'WaffleCategoryThing' => array('owner_id' => $model->{$model->tableSchema->primaryKey}))
            ),
            array(
                'icon' => 'glyphicon-plus',
                'url' => array(
                    '///waffleCategoryThing/create',
                    'WaffleCategoryThing' => array('owner_id' => $model->{$model->tableSchema->primaryKey})
                )
            ),
...
$this->widget(
    ...
    array(
        ...
        'buttons' => array(
            array(
                'icon' => 'glyphicon-list-alt',
                'url' => array('///wafflePublisher/admin', 'WafflePublisher' => array('owner_id' => $model->{$model->tableSchema->primaryKey}))
            ),
            array(
                'icon' => 'glyphicon-plus',
                'url' => array(
                    '///wafflePublisher/create',
                    'WafflePublisher' => array('owner_id' => $model->{$model->tableSchema->primaryKey})
                )
            ),
