<?php
$this->breadcrumbs[Yii::t('model', 'Waffle Tags')] = array('admin');
$this->breadcrumbs[] = $model->id;
?>
<?php $this->widget("\TbBreadcrumb", array("links" => $this->breadcrumbs)) ?>
<h1>

    <?php echo Yii::t('model', 'Waffle Tag'); ?>
    <small>
...
<b><?php echo CHtml::encode($model->getAttributeLabel('waffle_tag_qa_state_id')); ?>:</b>
<?php echo CHtml::encode($model->waffle_tag_qa_state_id); ?>
<br />
                ...
                'attributes' => array(
                    ...
                    array(
                        ...
                        'value' => ($model->clonedFrom !== null) ? CHtml::link(
                                    ...
                                    array('//waffleTag/view', 'id' => $model->clonedFrom->id),
                                    array('class' => '')) . ' ' . CHtml::link(
                                    '<i class="icon glyphicon-pencil"></i> ',
                                    array('//waffleTag/update', 'id' => $model->clonedFrom->id),
                                    array('class' => '')) : 'n/a',
                        'type' => 'html',
                    ),
                    array(
                    ...
                    array(
                        ...
                        'value' => ($model->waffleTagQaState !== null) ? CHtml::link(
                                    '<i class="icon glyphicon-circle-arrow-left"></i> ' . $model->waffleTagQaState->itemLabel,
                                    array('//waffleTagQaState/view', 'id' => $model->waffleTagQaState->id),
                                    array('class' => '')) . ' ' . CHtml::link(
                                    '<i class="icon glyphicon-pencil"></i> ',
                                    array('//waffleTagQaState/update', 'id' => $model->waffleTagQaState->id),
                                    array('class' => '')) : 'n/a',
                        'type' => 'html',
                    ),
                ),
