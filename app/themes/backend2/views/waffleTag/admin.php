<?php
$this->setPageTitle(
    Yii::t('model', 'Waffle Tags')
    . ' - '
    . Yii::t('crud', 'Manage')
);

$this->breadcrumbs[] = Yii::t('model', 'Waffle Tags');
...
<?php Yii::beginProfile('WaffleTag.view.grid'); ?>
        ...
        'columns' => array(
            ...
            */
            ...
            array(
                ...
                'buttons' => array(
                    'view' => array('visible' => 'Yii::app()->user->checkAccess("WaffleTag.View")'),
                    'update' => array('visible' => 'Yii::app()->user->checkAccess("WaffleTag.Update")'),
                    'delete' => array('visible' => 'Yii::app()->user->checkAccess("WaffleTag.Delete")'),
                ),
...
?>
<?php Yii::endProfile('WaffleTag.view.grid'); ?>