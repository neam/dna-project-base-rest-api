<?php
$this->setPageTitle(
    Yii::t('model', 'Spreadsheet File Qa State')
    . ' - '
    . Yii::t('model', 'Update')
    . ': '
    . $model->getItemLabel()
...
<div class="btn-group">
    <?php $this->widget('\TbButtonGroup', array(
        ...
        'buttons' => array(
            array('label' => Yii::t('model', 'Create'), 'icon' => 'glyphicon-plus', 'url' => array('spreadsheetFile/create', 'SpreadsheetFile' => array('spreadsheet_file_qa_state_id' => $model->id), 'returnUrl' => Yii::app()->request->url), array('class' => ''))
        ),
    ));
    ?></div>
