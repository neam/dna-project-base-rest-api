<?php
$this->breadcrumbs[Yii::t('model', 'Spreadsheet File Qa States')] = array('admin');
$this->breadcrumbs[] = $model->id;
?>
<?php $this->widget("\TbBreadcrumb", array("links" => $this->breadcrumbs)) ?>
<h1>

    <?php echo Yii::t('model', 'Spreadsheet File Qa State'); ?>
    <small>
...
<b><?php echo CHtml::encode($model->getAttributeLabel('processed_media_id_en_approved')); ?>:</b>
<?php echo CHtml::encode($model->processed_media_id_en_approved); ?>
<br />
...
<b><?php echo CHtml::encode($model->getAttributeLabel('processed_media_id_en_proofed')); ?>:</b>
<?php echo CHtml::encode($model->processed_media_id_en_proofed); ?>
<br />
                ...
                'attributes' => array(
                    ...
                    array(
                        ...
                        'value' => $this->widget(
                                ...
                                array(
                                    'model' => $model,
                                    'attribute' => 'processed_media_id_en_approved',
                                    'url' => $this->createUrl('/spreadsheetFileQaState/editableSaver'),
                                ),
                                true
                            )
                    ...
                    array(
                        ...
                        'value' => $this->widget(
                                ...
                                array(
                                    'model' => $model,
                                    'attribute' => 'processed_media_id_en_proofed',
                                    'url' => $this->createUrl('/spreadsheetFileQaState/editableSaver'),
                                ),
                                true
                            )
