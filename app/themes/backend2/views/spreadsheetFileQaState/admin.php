<?php
$this->setPageTitle(
    Yii::t('model', 'Spreadsheet File Qa States')
    . ' - '
    . Yii::t('crud', 'Manage')
);

$this->breadcrumbs[] = Yii::t('model', 'Spreadsheet File Qa States');
Yii::app()->clientScript->registerScript('search', "
    ...
    $('.search-form form').submit(function(){
        $.fn.yiiGridView.update(
            'spreadsheet-file-qa-state-grid',
            {data: $(this).serialize()}
        );
        return false;
    });
...
<?php $this->widget("\TbBreadcrumb", array("links" => $this->breadcrumbs)) ?>
    <h1>
        ...
        <?php echo Yii::t('model', 'Spreadsheet File Qa States'); ?>
...
<?php Yii::beginProfile('SpreadsheetFileQaState.view.grid'); ?>


<?php
$this->widget('\TbGridView',
    array(
        'id' => 'spreadsheet-file-qa-state-grid',
        ...
        'columns' => array(
            ...
            array(
                ...
                'name' => 'id',
                'editable' => array(
                    'url' => $this->createUrl('/spreadsheetFileQaState/editableSaver'),
                    //'placement' => 'right',
                )
            ),
            array(
            ...
            array(
                'class' => 'TbEditableColumn',
                'name' => 'processed_media_id_en_approved',
                'editable' => array(
                    'url' => $this->createUrl('/spreadsheetFileQaState/editableSaver'),
                    //'placement' => 'right',
                )
            ...
            array(
                'class' => 'TbEditableColumn',
                'name' => 'processed_media_id_en_proofed',
                'editable' => array(
                    'url' => $this->createUrl('/spreadsheetFileQaState/editableSaver'),
                    //'placement' => 'right',
                )
            ...
            */
            ...
            array(
                ...
                'buttons' => array(
                    'view' => array('visible' => 'Yii::app()->user->checkAccess("SpreadsheetFileQaState.View")'),
                    'update' => array('visible' => 'Yii::app()->user->checkAccess("SpreadsheetFileQaState.Update")'),
                    'delete' => array('visible' => 'Yii::app()->user->checkAccess("SpreadsheetFileQaState.Delete")'),
                ),
...
?>
<?php Yii::endProfile('SpreadsheetFileQaState.view.grid'); ?>