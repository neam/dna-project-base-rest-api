            ...
            $this->widget('\TbButtonGroup', array(
                'buttons' => array(
                    array(
                        ...
                        'icon' => 'glyphicon-search',
                        'items' => array(array('label' => 'account - Account', 'url' => array('//account/admin')), array('label' => 'group - Group', 'url' => array('//group/admin')), array('label' => 'role - Role', 'url' => array('//role/admin'))
                        )
                    ),
                ),
            ));
