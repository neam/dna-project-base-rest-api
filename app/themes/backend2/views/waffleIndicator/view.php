<?php
$this->breadcrumbs[Yii::t('model', 'Waffle Indicators')] = array('admin');
$this->breadcrumbs[] = $model->id;
?>
<?php $this->widget("\TbBreadcrumb", array("links" => $this->breadcrumbs)) ?>
<h1>

    <?php echo Yii::t('model', 'Waffle Indicator'); ?>
    <small>
...
<b><?php echo CHtml::encode($model->getAttributeLabel('waffle_indicator_qa_state_id')); ?>:</b>
<?php echo CHtml::encode($model->waffle_indicator_qa_state_id); ?>
<br />
                ...
                'attributes' => array(
                    ...
                    array(
                        ...
                        'value' => ($model->clonedFrom !== null) ? CHtml::link(
                                    ...
                                    array('//waffleIndicator/view', 'id' => $model->clonedFrom->id),
                                    array('class' => '')) . ' ' . CHtml::link(
                                    '<i class="icon glyphicon-pencil"></i> ',
                                    array('//waffleIndicator/update', 'id' => $model->clonedFrom->id),
                                    array('class' => '')) : 'n/a',
                        'type' => 'html',
                    ),
                    array(
                    ...
                    array(
                        ...
                        'value' => ($model->waffleIndicatorQaState !== null) ? CHtml::link(
                                    '<i class="icon glyphicon-circle-arrow-left"></i> ' . $model->waffleIndicatorQaState->itemLabel,
                                    array('//waffleIndicatorQaState/view', 'id' => $model->waffleIndicatorQaState->id),
                                    array('class' => '')) . ' ' . CHtml::link(
                                    '<i class="icon glyphicon-pencil"></i> ',
                                    array('//waffleIndicatorQaState/update', 'id' => $model->waffleIndicatorQaState->id),
                                    array('class' => '')) : 'n/a',
                        'type' => 'html',
                    ),
                ),
