<div class="row">
    <div class="span8"> <!-- main inputs -->
        ...
        <div class="form-horizontal">
            ...
            <?php
            $formId = 'waffle-indicator-waffle_id-' . \uniqid() . '-form';
            ?>
            ...
            $this->renderPartial('//waffle/_modal_form', array(
                'formId' => $formId,
                'inputSelector' => '#WaffleIndicator_waffle_id',
                'model' => new Waffle,
                'pk' => 'id',
                'field' => 'itemLabel',
            ));
            ...
            <?php
            $formId = 'waffle-indicator-owner_id-' . \uniqid() . '-form';
            ?>
            ...
            $this->renderPartial('//account/_modal_form', array(
                'formId' => $formId,
                'inputSelector' => '#WaffleIndicator_owner_id',
                'model' => new Account,
                'pk' => 'id',
                'field' => 'itemLabel',
            ));
            ...
            <?php echo $form->textFieldRow($model, 'waffle_indicator_qa_state_id', array('maxlength' => 20)); ?>
        </div>
    </div>
    <!-- main inputs -->
