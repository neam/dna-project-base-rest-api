<?php
$this->setPageTitle(
    Yii::t('model', 'Waffle Units')
    . ' - '
    . Yii::t('crud', 'Manage')
);

$this->breadcrumbs[] = Yii::t('model', 'Waffle Units');
...
<?php Yii::beginProfile('WaffleUnit.view.grid'); ?>
        ...
        'columns' => array(
            ...
            */
            ...
            array(
                ...
                'buttons' => array(
                    'view' => array('visible' => 'Yii::app()->user->checkAccess("WaffleUnit.View")'),
                    'update' => array('visible' => 'Yii::app()->user->checkAccess("WaffleUnit.Update")'),
                    'delete' => array('visible' => 'Yii::app()->user->checkAccess("WaffleUnit.Delete")'),
                ),
...
?>
<?php Yii::endProfile('WaffleUnit.view.grid'); ?>