<?php
$this->setPageTitle(
    Yii::t('model', 'Waffle Indicator Qa States')
    . ' - '
    . Yii::t('crud', 'Manage')
);

$this->breadcrumbs[] = Yii::t('model', 'Waffle Indicator Qa States');
Yii::app()->clientScript->registerScript('search', "
    ...
    $('.search-form form').submit(function(){
        $.fn.yiiGridView.update(
            'waffle-indicator-qa-state-grid',
            {data: $(this).serialize()}
        );
        return false;
    });
...
<?php $this->widget("\TbBreadcrumb", array("links" => $this->breadcrumbs)) ?>
    <h1>
        ...
        <?php echo Yii::t('model', 'Waffle Indicator Qa States'); ?>
...
<?php Yii::beginProfile('WaffleIndicatorQaState.view.grid'); ?>


<?php
$this->widget('\TbGridView',
    array(
        'id' => 'waffle-indicator-qa-state-grid',
        ...
        'columns' => array(
            ...
            */
            ...
            array(
                ...
                'buttons' => array(
                    'view' => array('visible' => 'Yii::app()->user->checkAccess("WaffleIndicatorQaState.View")'),
                    'update' => array('visible' => 'Yii::app()->user->checkAccess("WaffleIndicatorQaState.Update")'),
                    'delete' => array('visible' => 'Yii::app()->user->checkAccess("WaffleIndicatorQaState.Delete")'),
                ),
...
?>
<?php Yii::endProfile('WaffleIndicatorQaState.view.grid'); ?>