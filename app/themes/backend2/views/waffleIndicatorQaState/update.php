<?php
$this->setPageTitle(
    Yii::t('model', 'Waffle Indicator Qa State')
    . ' - '
    . Yii::t('model', 'Update')
    . ': '
    . $model->getItemLabel()
);
$this->breadcrumbs[Yii::t('model', 'Waffle Indicator Qa States')] = array('admin');
...
<h1>
    ...
    <?php echo Yii::t('model', 'Waffle Indicator Qa State'); ?>
    <small>
...
<div class="btn-group">
    <?php $this->widget('\TbButtonGroup', array(
        ...
        'buttons' => array(
            array('label' => Yii::t('model', 'Create'), 'icon' => 'glyphicon-plus', 'url' => array('waffleIndicator/create', 'WaffleIndicator' => array('waffle_indicator_qa_state_id' => $model->id), 'returnUrl' => Yii::app()->request->url), array('class' => ''))
        ),
    ));
    ?></div>
