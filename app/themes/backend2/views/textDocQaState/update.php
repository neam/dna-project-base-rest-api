...
<?php
$relatedSearchModel = $this->getRelatedSearchModel($model, 'textDocs1');
$this->widget('TbGridView',
    array(
        'id' => 'textDoc-grid',
        'dataProvider' => $relatedSearchModel->search(),
        'filter' => $relatedSearchModel, // TODO: Restore similar functionality without oom problems: count($model->textDocs1) > 1 ? $relatedSearchModel : null,
        'pager' => array(
            'class' => 'TbPager',
            'displayFirstAndLast' => true,
        ),
...
<?php
$relatedSearchModel = $this->getRelatedSearchModel($model, 'textDocs2');
$this->widget('TbGridView',
    array(
        'id' => 'textDoc-grid',
        'dataProvider' => $relatedSearchModel->search(),
        'filter' => $relatedSearchModel, // TODO: Restore similar functionality without oom problems: count($model->textDocs2) > 1 ? $relatedSearchModel : null,
        'pager' => array(
            'class' => 'TbPager',
            'displayFirstAndLast' => true,
        ),
...
<?php
$relatedSearchModel = $this->getRelatedSearchModel($model, 'textDocs3');
$this->widget('TbGridView',
    array(
        'id' => 'textDoc-grid',
        'dataProvider' => $relatedSearchModel->search(),
        'filter' => $relatedSearchModel, // TODO: Restore similar functionality without oom problems: count($model->textDocs3) > 1 ? $relatedSearchModel : null,
        'pager' => array(
            'class' => 'TbPager',
            'displayFirstAndLast' => true,
        ),
...
<?php
$relatedSearchModel = $this->getRelatedSearchModel($model, 'textDocs4');
$this->widget('TbGridView',
    array(
        'id' => 'textDoc-grid',
        'dataProvider' => $relatedSearchModel->search(),
        'filter' => $relatedSearchModel, // TODO: Restore similar functionality without oom problems: count($model->textDocs4) > 1 ? $relatedSearchModel : null,
        'pager' => array(
            'class' => 'TbPager',
            'displayFirstAndLast' => true,
        ),
...
<?php
$relatedSearchModel = $this->getRelatedSearchModel($model, 'textDocs5');
$this->widget('TbGridView',
    array(
        'id' => 'textDoc-grid',
        'dataProvider' => $relatedSearchModel->search(),
        'filter' => $relatedSearchModel, // TODO: Restore similar functionality without oom problems: count($model->textDocs5) > 1 ? $relatedSearchModel : null,
        'pager' => array(
            'class' => 'TbPager',
            'displayFirstAndLast' => true,
        ),
...
<?php
$relatedSearchModel = $this->getRelatedSearchModel($model, 'textDocs6');
$this->widget('TbGridView',
    array(
        'id' => 'textDoc-grid',
        'dataProvider' => $relatedSearchModel->search(),
        'filter' => $relatedSearchModel, // TODO: Restore similar functionality without oom problems: count($model->textDocs6) > 1 ? $relatedSearchModel : null,
        'pager' => array(
            'class' => 'TbPager',
            'displayFirstAndLast' => true,
        ),
...
<?php
$relatedSearchModel = $this->getRelatedSearchModel($model, 'textDocs7');
$this->widget('TbGridView',
    array(
        'id' => 'textDoc-grid',
        'dataProvider' => $relatedSearchModel->search(),
        'filter' => $relatedSearchModel, // TODO: Restore similar functionality without oom problems: count($model->textDocs7) > 1 ? $relatedSearchModel : null,
        'pager' => array(
            'class' => 'TbPager',
            'displayFirstAndLast' => true,
        ),
