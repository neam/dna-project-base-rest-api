<?php
$this->setPageTitle(
    Yii::t('model', 'Tool Qa States')
    . ' - '
    . Yii::t('crud', 'Manage')
);

$this->breadcrumbs[] = Yii::t('model', 'Tool Qa States');
        ...
        'columns' => array(
            ...
            */
            ...
            array(
                ...
                'buttons' => array(
                    'view' => array('visible' => 'Yii::app()->user->checkAccess("17a79fbd.ToolQaState.View")'),
                    'update' => array('visible' => 'Yii::app()->user->checkAccess("17a79fbd.ToolQaState.Update")'),
                    'delete' => array('visible' => 'Yii::app()->user->checkAccess("17a79fbd.ToolQaState.Delete")'),
                ),
