<?php
$this->setPageTitle(
    Yii::t('model', 'Menu Qa States')
    . ' - '
    . Yii::t('crud', 'Manage')
);

$this->breadcrumbs[] = Yii::t('model', 'Menu Qa States');
...
<?php $this->widget("\TbBreadcrumb", array("links" => $this->breadcrumbs)) ?>
    <h1>
        ...
        <?php echo Yii::t('model', 'Menu Qa States'); ?>
...
<?php Yii::beginProfile('MenuQaState.view.grid'); ?>


<?php
$this->widget('\TbGridView',
    array(
        'id' => 'menu-qa-state-grid',
        ...
        'columns' => array(
            ...
            array(
                ...
                'name' => 'id',
                'editable' => array(
                    'url' => $this->createUrl('/menuQaState/editableSaver'),
                    //'placement' => 'right',
                )
            ),
            array(
            ...
            */
            ...
            array(
                ...
                'buttons' => array(
                    'view' => array('visible' => 'Yii::app()->user->checkAccess("MenuQaState.View")'),
                    'update' => array('visible' => 'Yii::app()->user->checkAccess("MenuQaState.Update")'),
                    'delete' => array('visible' => 'Yii::app()->user->checkAccess("MenuQaState.Delete")'),
                ),
...
?>
<?php Yii::endProfile('MenuQaState.view.grid'); ?>