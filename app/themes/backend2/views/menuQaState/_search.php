<div class="wide form">
    ...
    <div class="row">
        <?php echo $form->label($model, 'pages_approved'); ?>
        <?php echo $form->checkBox($model, 'pages_approved'); ?>
    </div>
    ...
    <div class="row">
        <?php echo $form->label($model, 'pages_proofed'); ?>
        <?php echo $form->checkBox($model, 'pages_proofed'); ?>
    </div>
