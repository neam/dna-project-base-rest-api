<?php
$this->setPageTitle(
    Yii::t('model', 'Waffle Publishers')
    . ' - '
    . Yii::t('crud', 'Manage')
);

$this->breadcrumbs[] = Yii::t('model', 'Waffle Publishers');
...
<?php Yii::beginProfile('WafflePublisher.view.grid'); ?>


<?php
$this->widget('\TbGridView',
    array(
        'id' => 'waffle-publisher-grid',
        ...
        'columns' => array(
            ...
            */
            ...
            array(
                ...
                'buttons' => array(
                    'view' => array('visible' => 'Yii::app()->user->checkAccess("WafflePublisher.View")'),
                    'update' => array('visible' => 'Yii::app()->user->checkAccess("WafflePublisher.Update")'),
                    'delete' => array('visible' => 'Yii::app()->user->checkAccess("WafflePublisher.Delete")'),
                ),
...
?>
<?php Yii::endProfile('WafflePublisher.view.grid'); ?>