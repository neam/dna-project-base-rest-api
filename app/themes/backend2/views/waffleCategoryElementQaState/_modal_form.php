<?php
/* @var $this WaffleCategoryThingQaStateController */
...
?>
    ...
    <div class="modal-body">
        ...
        <?php
        $this->renderPartial('/waffleCategoryThingQaState/_elements', array(
            'model' => $model,
            'form' => $form,
        ));
        ?>
    ...
    <div class="modal-footer">
        ...
        <?php
        echo CHtml::ajaxSubmitButton('Save', CHtml::normalizeUrl(array('waffleCategoryThingQaState/editableCreator', 'render' => true)), array(
            'dataType' => 'json',
            'type' => 'post',
