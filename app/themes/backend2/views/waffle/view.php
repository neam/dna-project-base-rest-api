                ...
                'attributes' => array(
                    ...
                    array(
                        ...
                        'value' => ($model->clonedFrom !== null) ? CHtml::link(
                                    ...
                                    array('//waffle/view', 'id' => $model->clonedFrom->id),
                    ...
                    array(
                        ...
                        'value' => ($model->waffleQaState !== null) ? CHtml::link(
                                    '<i class="icon glyphicon-circle-arrow-left"></i> ' . $model->waffleQaState->itemLabel,
                                    array('//waffleQaState/view', 'id' => $model->waffleQaState->id),
                                    array('class' => '')) . ' ' . CHtml::link(
                                    '<i class="icon glyphicon-pencil"></i> ',
                                    array('//waffleQaState/update', 'id' => $model->waffleQaState->id),
                                    array('class' => '')) : 'n/a',
                        'type' => 'html',
                    ),
                ),
