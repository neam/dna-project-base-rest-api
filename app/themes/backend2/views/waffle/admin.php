...
$this->breadcrumbs[] = Yii::t('model', 'Waffles');
...
<?php Yii::beginProfile('Waffle.view.grid'); ?>
        ...
        'columns' => array(
            ...
            */
            ...
            array(
                ...
                'buttons' => array(
                    'view' => array('visible' => 'Yii::app()->user->checkAccess("Waffle.View")'),
                    'update' => array('visible' => 'Yii::app()->user->checkAccess("Waffle.Update")'),
                    'delete' => array('visible' => 'Yii::app()->user->checkAccess("Waffle.Delete")'),
                ),
...
?>
<?php Yii::endProfile('Waffle.view.grid'); ?>