<div class="wide form">
    ...
    <div class="row">
        <?php echo $form->label($model, 'source_node_id_approved'); ?>
        <?php echo $form->checkBox($model, 'source_node_id_approved'); ?>
    </div>

    <div class="row">
        <?php echo $form->label($model, 'alternatives_approved'); ?>
        <?php echo $form->checkBox($model, 'alternatives_approved'); ?>
    </div>
    ...
    <div class="row">
        <?php echo $form->label($model, 'source_node_id_proofed'); ?>
        <?php echo $form->checkBox($model, 'source_node_id_proofed'); ?>
    </div>

    <div class="row">
        <?php echo $form->label($model, 'alternatives_proofed'); ?>
        <?php echo $form->checkBox($model, 'alternatives_proofed'); ?>
    </div>
