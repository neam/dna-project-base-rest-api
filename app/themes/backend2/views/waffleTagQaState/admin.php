<?php
$this->setPageTitle(
    Yii::t('model', 'Waffle Tag Qa States')
    . ' - '
    . Yii::t('crud', 'Manage')
);

$this->breadcrumbs[] = Yii::t('model', 'Waffle Tag Qa States');
...
<?php $this->widget("\TbBreadcrumb", array("links" => $this->breadcrumbs)) ?>
    <h1>
        ...
        <?php echo Yii::t('model', 'Waffle Tag Qa States'); ?>
...
<?php Yii::beginProfile('WaffleTagQaState.view.grid'); ?>


<?php
$this->widget('\TbGridView',
    array(
        'id' => 'waffle-tag-qa-state-grid',
        ...
        'columns' => array(
            ...
            array(
                ...
                'name' => 'id',
                'editable' => array(
                    'url' => $this->createUrl('/waffleTagQaState/editableSaver'),
                    //'placement' => 'right',
                )
            ),
            array(
            ...
            */
            ...
            array(
                ...
                'buttons' => array(
                    'view' => array('visible' => 'Yii::app()->user->checkAccess("WaffleTagQaState.View")'),
                    'update' => array('visible' => 'Yii::app()->user->checkAccess("WaffleTagQaState.Update")'),
                    'delete' => array('visible' => 'Yii::app()->user->checkAccess("WaffleTagQaState.Delete")'),
                ),
...
?>
<?php Yii::endProfile('WaffleTagQaState.view.grid'); ?>