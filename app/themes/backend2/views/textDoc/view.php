...
<b><?php echo CHtml::encode($model->getAttributeLabel('text_doc_qa_state_id')); ?>:</b>
<?php echo CHtml::encode($model->text_doc_qa_state_id); ?>
<br />
            ...
            array(
                ...
                'attributes' => array(
                    ...
                    array(
                        ...
                        'value' => ($model->textDocQaState !== null) ? CHtml::link(
                                    '<i class="icon glyphicon-circle-arrow-left"></i> ' . $model->textDocQaState->itemLabel,
                                    array('//textDocQaState/view', 'id' => $model->textDocQaState->id),
                                    array('class' => '')) . ' ' . CHtml::link(
                                    '<i class="icon glyphicon-pencil"></i> ',
                                    array('//textDocQaState/update', 'id' => $model->textDocQaState->id),
                                    array('class' => '')) : 'n/a',
                        'type' => 'html',
                    ),
                    array(
