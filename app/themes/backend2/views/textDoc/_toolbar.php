            ...
            $this->widget('bootstrap.widgets.TbButtonGroup', array(
                    'buttons' => array(
                        array(
                            ...
                            'icon' => 'icon-search',
                            'items' => array(array('label' => 'outEdges - Edge', 'url' => array('//edge/admin')), array('label' => 'outNodes - Node', 'url' => array('//node/admin')), array('label' => 'inEdges - Edge', 'url' => array('//edge/admin')), array('label' => 'inNodes - Node', 'url' => array('//node/admin')), array('label' => 'textDocQaStateIdEn - textDocQaState', 'url' => array('//textDocQaState/admin')), array('label' => 'textDocQaStateIdCn - textDocQaState', 'url' => array('//textDocQaState/admin')), array('label' => 'textDocQaStateIdDe - textDocQaState', 'url' => array('//textDocQaState/admin')), array('label' => 'textDocQaStateIdEs - textDocQaState', 'url' => array('//textDocQaState/admin')), array('label' => 'textDocQaStateIdFa - textDocQaState', 'url' => array('//textDocQaState/admin')), array('label' => 'textDocQaStateIdHi - textDocQaState', 'url' => array('//textDocQaState/admin')), array('label' => 'textDocQaStateIdPt - textDocQaState', 'url' => array('//textDocQaState/admin')), array('label' => 'textDocQaStateIdSv - textDocQaState', 'url' => array('//textDocQaState/admin')), array('label' => 'clonedFrom - textDoc', 'url' => array('//textDoc/admin')), array('label' => 'textDocs - textDoc', 'url' => array('//textDoc/admin')), array('label' => 'node - Node', 'url' => array('//node/admin')), array('label' => 'thumbnailMedia - P3Media', 'url' => array('//p3Media/admin')), array('label' => 'videos - VideoFile', 'url' => array('//videoFile/admin')), array('label' => 'exercises - Exercise', 'url' => array('//exercise/admin')), array('label' => 'textDocs - SlideshowFile', 'url' => array('//textDoc/admin'))
                            )
                        ),
                    ),
                ));
