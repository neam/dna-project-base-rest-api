<div class="row">
    <div class="span8"> <!-- main inputs -->
        ...
        <div class="form-horizontal">
            ...
            <?php
            $formId = 'text-doc-processed_media_id_fa-' . \uniqid() . '-form';
            ?>
            ...
            $this->renderPartial('//p3Media/_modal_form', array(
                'formId' => $formId,
                'inputSelector' => '#TextDoc_processed_media_id_fa',
                'model' => new P3Media,
                'pk' => 'id',
                'field' => 'itemLabel',
            ));
            ...
            <?php
            $formId = 'text-doc-processed_media_id_cn-' . \uniqid() . '-form';
            ?>
            ...
            $this->renderPartial('//p3Media/_modal_form', array(
                'formId' => $formId,
                'inputSelector' => '#TextDoc_processed_media_id_cn',
                'model' => new P3Media,
                'pk' => 'id',
                'field' => 'itemLabel',
            ));
            ...
            <?php echo $form->textFieldRow($model, 'text_doc_qa_state_id_en', array('maxlength' => 20)); ?>

            <?php echo $form->textFieldRow($model, 'text_doc_qa_state_id_es', array('maxlength' => 20)); ?>

            <?php echo $form->textFieldRow($model, 'text_doc_qa_state_id_fa', array('maxlength' => 20)); ?>

            <?php echo $form->textFieldRow($model, 'text_doc_qa_state_id_hi', array('maxlength' => 20)); ?>

            <?php echo $form->textFieldRow($model, 'text_doc_qa_state_id_pt', array('maxlength' => 20)); ?>

            <?php echo $form->textFieldRow($model, 'text_doc_qa_state_id_sv', array('maxlength' => 20)); ?>

            <?php echo $form->textFieldRow($model, 'text_doc_qa_state_id_cn', array('maxlength' => 20)); ?>

            <?php echo $form->textFieldRow($model, 'text_doc_qa_state_id_de', array('maxlength' => 20)); ?>
        </div>
    </div>
    <!-- main inputs -->
