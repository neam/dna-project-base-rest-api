            ...
            $this->widget('bootstrap.widgets.TbButtonGroup', array(
                    'buttons' => array(
                        array(
                            ...
                            'icon' => 'icon-search',
                            'items' => array(array('label' => 'outEdges - Edge', 'url' => array('//edge/admin')), array('label' => 'outNodes - Node', 'url' => array('//node/admin')), array('label' => 'inEdges - Edge', 'url' => array('//edge/admin')), array('label' => 'inNodes - Node', 'url' => array('//node/admin')), array('label' => 'vectorGraphicQaStateIdEn - vectorGraphicQaState', 'url' => array('//vectorGraphicQaState/admin')), array('label' => 'vectorGraphicQaStateIdCn - vectorGraphicQaState', 'url' => array('//vectorGraphicQaState/admin')), array('label' => 'vectorGraphicQaStateIdDe - vectorGraphicQaState', 'url' => array('//vectorGraphicQaState/admin')), array('label' => 'vectorGraphicQaStateIdEs - vectorGraphicQaState', 'url' => array('//vectorGraphicQaState/admin')), array('label' => 'vectorGraphicQaStateIdFa - vectorGraphicQaState', 'url' => array('//vectorGraphicQaState/admin')), array('label' => 'vectorGraphicQaStateIdHi - vectorGraphicQaState', 'url' => array('//vectorGraphicQaState/admin')), array('label' => 'vectorGraphicQaStateIdPt - vectorGraphicQaState', 'url' => array('//vectorGraphicQaState/admin')), array('label' => 'vectorGraphicQaStateIdSv - vectorGraphicQaState', 'url' => array('//vectorGraphicQaState/admin')), array('label' => 'clonedFrom - vectorGraphic', 'url' => array('//vectorGraphic/admin')), array('label' => 'vectorGraphics - vectorGraphic', 'url' => array('//vectorGraphic/admin')), array('label' => 'node - Node', 'url' => array('//node/admin')), array('label' => 'thumbnailMedia - P3Media', 'url' => array('//p3Media/admin')), array('label' => 'videos - VideoFile', 'url' => array('//videoFile/admin')), array('label' => 'exercises - Exercise', 'url' => array('//exercise/admin')), array('label' => 'vectorGraphics - VectorGraphic', 'url' => array('//vectorGraphic/admin'))
                            )
                        ),
                    ),
                ));
