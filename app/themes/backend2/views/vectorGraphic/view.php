...
<b><?php echo CHtml::encode($model->getAttributeLabel('vector_graphic_qa_state_id')); ?>:</b>
<?php echo CHtml::encode($model->vector_graphic_qa_state_id); ?>
<br />
            ...
            array(
                ...
                'attributes' => array(
                    ...
                    array(
                        ...
                        'value' => ($model->vectorGraphicQaState !== null) ? CHtml::link(
                                    '<i class="icon glyphicon-circle-arrow-left"></i> ' . $model->vectorGraphicQaState->itemLabel,
                                    array('//vectorGraphicQaState/view', 'id' => $model->vectorGraphicQaState->id),
                                    array('class' => '')) . ' ' . CHtml::link(
                                    '<i class="icon glyphicon-pencil"></i> ',
                                    array('//vectorGraphicQaState/update', 'id' => $model->vectorGraphicQaState->id),
                                    array('class' => '')) : 'n/a',
                        'type' => 'html',
                    ),
                    array(
