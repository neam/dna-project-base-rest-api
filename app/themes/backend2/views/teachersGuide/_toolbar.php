            ...
            $this->widget('\TbButtonGroup', array(
                'buttons' => array(
                    array(
                        ...
                        'icon' => 'icon-search',
                        'items' => array(array('label' => 'sectionContents - SectionContent', 'url' => array('//sectionContent/admin')), array('label' => 'node - Node', 'url' => array('//node/admin')), array('label' => 'clonedFrom - TeachersGuide', 'url' => array('//teachersGuide/admin')), array('label' => 'teachersGuides - TeachersGuide', 'url' => array('//teachersGuide/admin'))
                        )
                    ),
                ),
            ));
