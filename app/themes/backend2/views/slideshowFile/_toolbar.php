            ...
            $this->widget('bootstrap.widgets.TbButtonGroup', array(
                    'buttons' => array(
                        array(
                            ...
                            'icon' => 'icon-search',
                            'items' => array(array('label' => 'outEdges - Edge', 'url' => array('//edge/admin')), array('label' => 'outNodes - Node', 'url' => array('//node/admin')), array('label' => 'inEdges - Edge', 'url' => array('//edge/admin')), array('label' => 'inNodes - Node', 'url' => array('//node/admin')), array('label' => 'slideshowFileQaStateIdEn - slideshowFileQaState', 'url' => array('//slideshowFileQaState/admin')), array('label' => 'slideshowFileQaStateIdCn - slideshowFileQaState', 'url' => array('//slideshowFileQaState/admin')), array('label' => 'slideshowFileQaStateIdDe - slideshowFileQaState', 'url' => array('//slideshowFileQaState/admin')), array('label' => 'slideshowFileQaStateIdEs - slideshowFileQaState', 'url' => array('//slideshowFileQaState/admin')), array('label' => 'slideshowFileQaStateIdFa - slideshowFileQaState', 'url' => array('//slideshowFileQaState/admin')), array('label' => 'slideshowFileQaStateIdHi - slideshowFileQaState', 'url' => array('//slideshowFileQaState/admin')), array('label' => 'slideshowFileQaStateIdPt - slideshowFileQaState', 'url' => array('//slideshowFileQaState/admin')), array('label' => 'slideshowFileQaStateIdSv - slideshowFileQaState', 'url' => array('//slideshowFileQaState/admin')), array('label' => 'clonedFrom - slideshowFile', 'url' => array('//slideshowFile/admin')), array('label' => 'slideshowFiles - slideshowFile', 'url' => array('//slideshowFile/admin')), array('label' => 'node - Node', 'url' => array('//node/admin')), array('label' => 'thumbnailMedia - P3Media', 'url' => array('//p3Media/admin')), array('label' => 'videos - VideoFile', 'url' => array('//videoFile/admin')), array('label' => 'exercises - Exercise', 'url' => array('//exercise/admin')), array('label' => 'slideshowFiles - SlideshowFile', 'url' => array('//slideshowFile/admin'))
                            )
                        ),
                    ),
                ));
