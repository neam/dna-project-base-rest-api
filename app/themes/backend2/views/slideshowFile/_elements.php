<div class="row">
    <div class="span8"> <!-- main inputs -->
        ...
        <div class="form-horizontal">
            ...
            <?php
            $formId = 'slideshow-file-processed_media_id_en-' . \uniqid() . '-form';
            ?>
            ...
            <?php
            $formId = 'slideshow-file-owner_id-' . \uniqid() . '-form';
            ?>
            ...
            $this->renderPartial('//account/_modal_form', array(
                'formId' => $formId,
                'inputSelector' => '#SlideshowFile_owner_id',
                'model' => new Account,
                'pk' => 'id',
                'field' => 'itemLabel',
            ));
            ...
            <?php
            $formId = 'slideshow-file-processed_media_id_es-' . \uniqid() . '-form';
            ?>
            ...
            $this->renderPartial('//p3Media/_modal_form', array(
                'formId' => $formId,
                'inputSelector' => '#SlideshowFile_processed_media_id_es',
                'model' => new P3Media,
                'pk' => 'id',
                'field' => 'itemLabel',
            ));
            ...
            <?php
            $formId = 'slideshow-file-processed_media_id_hi-' . \uniqid() . '-form';
            ?>
            ...
            $this->renderPartial('//p3Media/_modal_form', array(
                'formId' => $formId,
                'inputSelector' => '#SlideshowFile_processed_media_id_hi',
                'model' => new P3Media,
                'pk' => 'id',
                'field' => 'itemLabel',
            ));
            ...
            <?php
            $formId = 'slideshow-file-processed_media_id_pt-' . \uniqid() . '-form';
            ?>
            ...
            $this->renderPartial('//p3Media/_modal_form', array(
                'formId' => $formId,
                'inputSelector' => '#SlideshowFile_processed_media_id_pt',
                'model' => new P3Media,
                'pk' => 'id',
                'field' => 'itemLabel',
            ));
            ...
            <?php
            $formId = 'slideshow-file-processed_media_id_sv-' . \uniqid() . '-form';
            ?>
            ...
            $this->renderPartial('//p3Media/_modal_form', array(
                'formId' => $formId,
                'inputSelector' => '#SlideshowFile_processed_media_id_sv',
                'model' => new P3Media,
                'pk' => 'id',
                'field' => 'itemLabel',
            ));
            ...
            <?php
            $formId = 'slideshow-file-processed_media_id_de-' . \uniqid() . '-form';
            ?>
            ...
            $this->renderPartial('//p3Media/_modal_form', array(
                'formId' => $formId,
                'inputSelector' => '#SlideshowFile_processed_media_id_de',
                'model' => new P3Media,
                'pk' => 'id',
                'field' => 'itemLabel',
            ));
            ...
            <?php echo $form->textFieldRow($model, 'slideshow_file_qa_state_id', array('maxlength' => 20)); ?>
            ...
            <?php
            $formId = 'slideshow-file-processed_media_id_zh-' . \uniqid() . '-form';
            ?>
            ...
            $this->renderPartial('//p3Media/_modal_form', array(
                'formId' => $formId,
                'inputSelector' => '#SlideshowFile_processed_media_id_zh',
                'model' => new P3Media,
                'pk' => 'id',
                'field' => 'itemLabel',
            ));
            ...
            <?php
            $formId = 'slideshow-file-processed_media_id_ar-' . \uniqid() . '-form';
            ?>
            ...
            $this->renderPartial('//p3Media/_modal_form', array(
                'formId' => $formId,
                'inputSelector' => '#SlideshowFile_processed_media_id_ar',
                'model' => new P3Media,
                'pk' => 'id',
                'field' => 'itemLabel',
            ));
            ...
            <?php
            $formId = 'slideshow-file-processed_media_id_bg-' . \uniqid() . '-form';
            ?>
            ...
            $this->renderPartial('//p3Media/_modal_form', array(
                'formId' => $formId,
                'inputSelector' => '#SlideshowFile_processed_media_id_bg',
                'model' => new P3Media,
                'pk' => 'id',
                'field' => 'itemLabel',
            ));
            ...
            <?php
            $formId = 'slideshow-file-processed_media_id_ca-' . \uniqid() . '-form';
            ?>
            ...
            $this->renderPartial('//p3Media/_modal_form', array(
                'formId' => $formId,
                'inputSelector' => '#SlideshowFile_processed_media_id_ca',
                'model' => new P3Media,
                'pk' => 'id',
                'field' => 'itemLabel',
            ));
            ...
            <?php
            $formId = 'slideshow-file-processed_media_id_cs-' . \uniqid() . '-form';
            ?>
            ...
            $this->renderPartial('//p3Media/_modal_form', array(
                'formId' => $formId,
                'inputSelector' => '#SlideshowFile_processed_media_id_cs',
                'model' => new P3Media,
                'pk' => 'id',
                'field' => 'itemLabel',
            ));
            ...
            <?php
            $formId = 'slideshow-file-processed_media_id_da-' . \uniqid() . '-form';
            ?>
            ...
            $this->renderPartial('//p3Media/_modal_form', array(
                'formId' => $formId,
                'inputSelector' => '#SlideshowFile_processed_media_id_da',
                'model' => new P3Media,
                'pk' => 'id',
                'field' => 'itemLabel',
            ));
            ...
            <?php
            $formId = 'slideshow-file-processed_media_id_en_gb-' . \uniqid() . '-form';
            ?>
            ...
            $this->renderPartial('//p3Media/_modal_form', array(
                'formId' => $formId,
                'inputSelector' => '#SlideshowFile_processed_media_id_en_gb',
                'model' => new P3Media,
                'pk' => 'id',
                'field' => 'itemLabel',
            ));
            ...
            <?php
            $formId = 'slideshow-file-processed_media_id_en_us-' . \uniqid() . '-form';
            ?>
            ...
            $this->renderPartial('//p3Media/_modal_form', array(
                'formId' => $formId,
                'inputSelector' => '#SlideshowFile_processed_media_id_en_us',
                'model' => new P3Media,
                'pk' => 'id',
                'field' => 'itemLabel',
            ));
            ...
            <?php
            $formId = 'slideshow-file-processed_media_id_el-' . \uniqid() . '-form';
            ?>
            ...
            $this->renderPartial('//p3Media/_modal_form', array(
                'formId' => $formId,
                'inputSelector' => '#SlideshowFile_processed_media_id_el',
                'model' => new P3Media,
                'pk' => 'id',
                'field' => 'itemLabel',
            ));
            ...
            <?php
            $formId = 'slideshow-file-processed_media_id_fi-' . \uniqid() . '-form';
            ?>
            ...
            $this->renderPartial('//p3Media/_modal_form', array(
                'formId' => $formId,
                'inputSelector' => '#SlideshowFile_processed_media_id_fi',
                'model' => new P3Media,
                'pk' => 'id',
                'field' => 'itemLabel',
            ));
            ...
            <?php
            $formId = 'slideshow-file-processed_media_id_fil-' . \uniqid() . '-form';
            ?>
            ...
            $this->renderPartial('//p3Media/_modal_form', array(
                'formId' => $formId,
                'inputSelector' => '#SlideshowFile_processed_media_id_fil',
                'model' => new P3Media,
                'pk' => 'id',
                'field' => 'itemLabel',
            ));
            ...
            <?php
            $formId = 'slideshow-file-processed_media_id_fr-' . \uniqid() . '-form';
            ?>
            ...
            $this->renderPartial('//p3Media/_modal_form', array(
                'formId' => $formId,
                'inputSelector' => '#SlideshowFile_processed_media_id_fr',
                'model' => new P3Media,
                'pk' => 'id',
                'field' => 'itemLabel',
            ));
            ...
            <?php
            $formId = 'slideshow-file-processed_media_id_hr-' . \uniqid() . '-form';
            ?>
            ...
            $this->renderPartial('//p3Media/_modal_form', array(
                'formId' => $formId,
                'inputSelector' => '#SlideshowFile_processed_media_id_hr',
                'model' => new P3Media,
                'pk' => 'id',
                'field' => 'itemLabel',
            ));
            ...
            <?php
            $formId = 'slideshow-file-processed_media_id_hu-' . \uniqid() . '-form';
            ?>
            ...
            $this->renderPartial('//p3Media/_modal_form', array(
                'formId' => $formId,
                'inputSelector' => '#SlideshowFile_processed_media_id_hu',
                'model' => new P3Media,
                'pk' => 'id',
                'field' => 'itemLabel',
            ));
            ...
            <?php
            $formId = 'slideshow-file-processed_media_id_id-' . \uniqid() . '-form';
            ?>
            ...
            $this->renderPartial('//p3Media/_modal_form', array(
                'formId' => $formId,
                'inputSelector' => '#SlideshowFile_processed_media_id_id',
                'model' => new P3Media,
                'pk' => 'id',
                'field' => 'itemLabel',
            ));
            ...
            <?php
            $formId = 'slideshow-file-processed_media_id_iw-' . \uniqid() . '-form';
            ?>
            ...
            $this->renderPartial('//p3Media/_modal_form', array(
                'formId' => $formId,
                'inputSelector' => '#SlideshowFile_processed_media_id_iw',
                'model' => new P3Media,
                'pk' => 'id',
                'field' => 'itemLabel',
            ));
            ...
            <?php
            $formId = 'slideshow-file-processed_media_id_it-' . \uniqid() . '-form';
            ?>
            ...
            $this->renderPartial('//p3Media/_modal_form', array(
                'formId' => $formId,
                'inputSelector' => '#SlideshowFile_processed_media_id_it',
                'model' => new P3Media,
                'pk' => 'id',
                'field' => 'itemLabel',
            ));
            ...
            <?php
            $formId = 'slideshow-file-processed_media_id_ja-' . \uniqid() . '-form';
            ?>
            ...
            $this->renderPartial('//p3Media/_modal_form', array(
                'formId' => $formId,
                'inputSelector' => '#SlideshowFile_processed_media_id_ja',
                'model' => new P3Media,
                'pk' => 'id',
                'field' => 'itemLabel',
            ));
            ...
            <?php
            $formId = 'slideshow-file-processed_media_id_ko-' . \uniqid() . '-form';
            ?>
            ...
            $this->renderPartial('//p3Media/_modal_form', array(
                'formId' => $formId,
                'inputSelector' => '#SlideshowFile_processed_media_id_ko',
                'model' => new P3Media,
                'pk' => 'id',
                'field' => 'itemLabel',
            ));
            ...
            <?php
            $formId = 'slideshow-file-processed_media_id_lt-' . \uniqid() . '-form';
            ?>
            ...
            $this->renderPartial('//p3Media/_modal_form', array(
                'formId' => $formId,
                'inputSelector' => '#SlideshowFile_processed_media_id_lt',
                'model' => new P3Media,
                'pk' => 'id',
                'field' => 'itemLabel',
            ));
            ...
            <?php
            $formId = 'slideshow-file-processed_media_id_lv-' . \uniqid() . '-form';
            ?>
            ...
            $this->renderPartial('//p3Media/_modal_form', array(
                'formId' => $formId,
                'inputSelector' => '#SlideshowFile_processed_media_id_lv',
                'model' => new P3Media,
                'pk' => 'id',
                'field' => 'itemLabel',
            ));
            ...
            <?php
            $formId = 'slideshow-file-processed_media_id_nl-' . \uniqid() . '-form';
            ?>
            ...
            $this->renderPartial('//p3Media/_modal_form', array(
                'formId' => $formId,
                'inputSelector' => '#SlideshowFile_processed_media_id_nl',
                'model' => new P3Media,
                'pk' => 'id',
                'field' => 'itemLabel',
            ));
            ...
            <?php
            $formId = 'slideshow-file-processed_media_id_no-' . \uniqid() . '-form';
            ?>
            ...
            $this->renderPartial('//p3Media/_modal_form', array(
                'formId' => $formId,
                'inputSelector' => '#SlideshowFile_processed_media_id_no',
                'model' => new P3Media,
                'pk' => 'id',
                'field' => 'itemLabel',
            ));
            ...
            <?php
            $formId = 'slideshow-file-processed_media_id_pl-' . \uniqid() . '-form';
            ?>
            ...
            $this->renderPartial('//p3Media/_modal_form', array(
                'formId' => $formId,
                'inputSelector' => '#SlideshowFile_processed_media_id_pl',
                'model' => new P3Media,
                'pk' => 'id',
                'field' => 'itemLabel',
            ));
            ...
            <?php
            $formId = 'slideshow-file-processed_media_id_pt_br-' . \uniqid() . '-form';
            ?>
            ...
            $this->renderPartial('//p3Media/_modal_form', array(
                'formId' => $formId,
                'inputSelector' => '#SlideshowFile_processed_media_id_pt_br',
                'model' => new P3Media,
                'pk' => 'id',
                'field' => 'itemLabel',
            ));
            ...
            <?php
            $formId = 'slideshow-file-processed_media_id_pt_pt-' . \uniqid() . '-form';
            ?>
            ...
            $this->renderPartial('//p3Media/_modal_form', array(
                'formId' => $formId,
                'inputSelector' => '#SlideshowFile_processed_media_id_pt_pt',
                'model' => new P3Media,
                'pk' => 'id',
                'field' => 'itemLabel',
            ));
            ...
            <?php
            $formId = 'slideshow-file-processed_media_id_ro-' . \uniqid() . '-form';
            ?>
            ...
            $this->renderPartial('//p3Media/_modal_form', array(
                'formId' => $formId,
                'inputSelector' => '#SlideshowFile_processed_media_id_ro',
                'model' => new P3Media,
                'pk' => 'id',
                'field' => 'itemLabel',
            ));
            ...
            <?php
            $formId = 'slideshow-file-processed_media_id_ru-' . \uniqid() . '-form';
            ?>
            ...
            $this->renderPartial('//p3Media/_modal_form', array(
                'formId' => $formId,
                'inputSelector' => '#SlideshowFile_processed_media_id_ru',
                'model' => new P3Media,
                'pk' => 'id',
                'field' => 'itemLabel',
            ));
            ...
            <?php
            $formId = 'slideshow-file-processed_media_id_sk-' . \uniqid() . '-form';
            ?>
            ...
            $this->renderPartial('//p3Media/_modal_form', array(
                'formId' => $formId,
                'inputSelector' => '#SlideshowFile_processed_media_id_sk',
                'model' => new P3Media,
                'pk' => 'id',
                'field' => 'itemLabel',
            ));
            ...
            <?php
            $formId = 'slideshow-file-processed_media_id_sl-' . \uniqid() . '-form';
            ?>
            ...
            $this->renderPartial('//p3Media/_modal_form', array(
                'formId' => $formId,
                'inputSelector' => '#SlideshowFile_processed_media_id_sl',
                'model' => new P3Media,
                'pk' => 'id',
                'field' => 'itemLabel',
            ));
            ...
            <?php
            $formId = 'slideshow-file-processed_media_id_sr-' . \uniqid() . '-form';
            ?>
            ...
            $this->renderPartial('//p3Media/_modal_form', array(
                'formId' => $formId,
                'inputSelector' => '#SlideshowFile_processed_media_id_sr',
                'model' => new P3Media,
                'pk' => 'id',
                'field' => 'itemLabel',
            ));
            ...
            <?php
            $formId = 'slideshow-file-processed_media_id_th-' . \uniqid() . '-form';
            ?>
            ...
            $this->renderPartial('//p3Media/_modal_form', array(
                'formId' => $formId,
                'inputSelector' => '#SlideshowFile_processed_media_id_th',
                'model' => new P3Media,
                'pk' => 'id',
                'field' => 'itemLabel',
            ));
            ...
            <?php
            $formId = 'slideshow-file-processed_media_id_tr-' . \uniqid() . '-form';
            ?>
            ...
            $this->renderPartial('//p3Media/_modal_form', array(
                'formId' => $formId,
                'inputSelector' => '#SlideshowFile_processed_media_id_tr',
                'model' => new P3Media,
                'pk' => 'id',
                'field' => 'itemLabel',
            ));
            ...
            <?php
            $formId = 'slideshow-file-processed_media_id_uk-' . \uniqid() . '-form';
            ?>
            ...
            $this->renderPartial('//p3Media/_modal_form', array(
                'formId' => $formId,
                'inputSelector' => '#SlideshowFile_processed_media_id_uk',
                'model' => new P3Media,
                'pk' => 'id',
                'field' => 'itemLabel',
            ));
            ...
            <?php
            $formId = 'slideshow-file-processed_media_id_vi-' . \uniqid() . '-form';
            ?>
            ...
            $this->renderPartial('//p3Media/_modal_form', array(
                'formId' => $formId,
                'inputSelector' => '#SlideshowFile_processed_media_id_vi',
                'model' => new P3Media,
                'pk' => 'id',
                'field' => 'itemLabel',
            ));
            ...
            <?php
            $formId = 'slideshow-file-processed_media_id_zh_cn-' . \uniqid() . '-form';
            ?>
            ...
            $this->renderPartial('//p3Media/_modal_form', array(
                'formId' => $formId,
                'inputSelector' => '#SlideshowFile_processed_media_id_zh_cn',
                'model' => new P3Media,
                'pk' => 'id',
                'field' => 'itemLabel',
            ));
            ...
            <?php
            $formId = 'slideshow-file-processed_media_id_zh_tw-' . \uniqid() . '-form';
            ?>
            ...
            $this->renderPartial('//p3Media/_modal_form', array(
                'formId' => $formId,
                'inputSelector' => '#SlideshowFile_processed_media_id_zh_tw',
                'model' => new P3Media,
                'pk' => 'id',
                'field' => 'itemLabel',
            ));
