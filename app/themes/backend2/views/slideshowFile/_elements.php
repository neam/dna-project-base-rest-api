<div class="row">
    <div class="span8"> <!-- main inputs -->
        ...
        <div class="form-horizontal">
            ...
            <?php
            $formId = 'slideshow-file-processed_media_id_fa-' . \uniqid() . '-form';
            ?>
            ...
            $this->renderPartial('//p3Media/_modal_form', array(
                'formId' => $formId,
                'inputSelector' => '#SlideshowFile_processed_media_id_fa',
                'model' => new P3Media,
                'pk' => 'id',
                'field' => 'itemLabel',
            ));
            ...
            <?php
            $formId = 'slideshow-file-processed_media_id_cn-' . \uniqid() . '-form';
            ?>
            ...
            $this->renderPartial('//p3Media/_modal_form', array(
                'formId' => $formId,
                'inputSelector' => '#SlideshowFile_processed_media_id_cn',
                'model' => new P3Media,
                'pk' => 'id',
                'field' => 'itemLabel',
            ));
            ...
            <?php echo $form->textFieldRow($model, 'slideshow_file_qa_state_id_en', array('maxlength' => 20)); ?>

            <?php echo $form->textFieldRow($model, 'slideshow_file_qa_state_id_es', array('maxlength' => 20)); ?>

            <?php echo $form->textFieldRow($model, 'slideshow_file_qa_state_id_fa', array('maxlength' => 20)); ?>

            <?php echo $form->textFieldRow($model, 'slideshow_file_qa_state_id_hi', array('maxlength' => 20)); ?>

            <?php echo $form->textFieldRow($model, 'slideshow_file_qa_state_id_pt', array('maxlength' => 20)); ?>

            <?php echo $form->textFieldRow($model, 'slideshow_file_qa_state_id_sv', array('maxlength' => 20)); ?>

            <?php echo $form->textFieldRow($model, 'slideshow_file_qa_state_id_cn', array('maxlength' => 20)); ?>

            <?php echo $form->textFieldRow($model, 'slideshow_file_qa_state_id_de', array('maxlength' => 20)); ?>
        </div>
    </div>
    <!-- main inputs -->
