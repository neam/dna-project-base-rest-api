...
<b><?php echo CHtml::encode($model->getAttributeLabel('description_en_approved')); ?>:</b>
<?php echo CHtml::encode($model->description_en_approved); ?>
<br />
...
<?php echo CHtml::encode($model->description_en_proofed); ?>
<br />
                ...
                'attributes' => array(
                    ...
                    array(
                        ...
                        'value' => $this->widget(
                                ...
                                array(
                                    'model' => $model,
                                    'attribute' => 'description_en_approved',
                                    'url' => $this->createUrl('/exerciseQaState/editableSaver'),
                                ),
                                true
                            )
                    ...
                    array(
                        ...
                        'value' => $this->widget(
                                ...
                                array(
                                    'model' => $model,
                                    'attribute' => 'description_en_proofed',
                                    'url' => $this->createUrl('/exerciseQaState/editableSaver'),
                                ),
                                true
                            )
