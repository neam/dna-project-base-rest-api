            ...
            $this->widget('\TbButtonGroup', array(
                'buttons' => array(
                    array(
                        ...
                        'icon' => 'glyphicon-search',
                        'items' => array(array('label' => 'outEdges - Edge', 'url' => array('//edge/admin')), array('label' => 'outNodes - Node', 'url' => array('//node/admin')), array('label' => 'inEdges - Edge', 'url' => array('//edge/admin')), array('label' => 'inNodes - Node', 'url' => array('//node/admin')), array('label' => 'owner - Account', 'url' => array('//account/admin')), array('label' => 'dataArticleQaState - DataArticleQaState', 'url' => array('//dataArticleQaState/admin')), array('label' => 'clonedFrom - DataArticle', 'url' => array('//dataArticle/admin')), array('label' => 'dataArticles - DataArticle', 'url' => array('//dataArticle/admin')), array('label' => 'node - Node', 'url' => array('//node/admin')), array('label' => 'fileMedia - P3Media', 'url' => array('//p3Media/admin'))
                        )
                    ),
                ),
            ));
