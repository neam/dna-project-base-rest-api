<?php
$this->setPageTitle(
    Yii::t('model', 'Data Articles')
    . ' - '
    . Yii::t('crud', 'Manage')
);

$this->breadcrumbs[] = Yii::t('model', 'Data Articles');
...
<?php Yii::beginProfile('DataArticle.view.grid'); ?>


<?php
$this->widget('\TbGridView',
    array(
        'id' => 'data-article-grid',
        ...
        'columns' => array(
            ...
            */
            ...
            array(
                ...
                'buttons' => array(
                    'view' => array('visible' => 'Yii::app()->user->checkAccess("DataArticle.View")'),
                    'update' => array('visible' => 'Yii::app()->user->checkAccess("DataArticle.Update")'),
                    'delete' => array('visible' => 'Yii::app()->user->checkAccess("DataArticle.Delete")'),
                ),
...
?>
<?php Yii::endProfile('DataArticle.view.grid'); ?>