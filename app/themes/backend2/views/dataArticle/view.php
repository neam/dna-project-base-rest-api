<?php
$this->breadcrumbs[Yii::t('model', 'Data Articles')] = array('admin');
$this->breadcrumbs[] = $model->id;
?>
<?php $this->widget("\TbBreadcrumb", array("links" => $this->breadcrumbs)) ?>
<h1>

    <?php echo Yii::t('model', 'Data Article'); ?>
    <small>
...
<b><?php echo CHtml::encode($model->getAttributeLabel('data_article_qa_state_id')); ?>:</b>
<?php echo CHtml::encode($model->data_article_qa_state_id); ?>
<br />
                ...
                'attributes' => array(
                    ...
                    array(
                        ...
                        'value' => ($model->fileMedia !== null) ? CHtml::link(
                                    '<i class="icon glyphicon-circle-arrow-left"></i> ' . $model->fileMedia->itemLabel,
                    ...
                    array(
                        ...
                        'value' => ($model->dataArticleQaState !== null) ? CHtml::link(
                                    '<i class="icon glyphicon-circle-arrow-left"></i> ' . $model->dataArticleQaState->itemLabel,
