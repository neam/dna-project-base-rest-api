<?php
$this->setPageTitle(
    Yii::t('model', 'Section Qa States')
    . ' - '
    . Yii::t('crud', 'Manage')
);

$this->breadcrumbs[] = Yii::t('model', 'Section Qa States');
...
<?php $this->widget("\TbBreadcrumb", array("links" => $this->breadcrumbs)) ?>
    <h1>
        ...
        <?php echo Yii::t('model', 'Section Qa States'); ?>
...
<?php Yii::beginProfile('SectionQaState.view.grid'); ?>


<?php
$this->widget('\TbGridView',
    array(
        'id' => 'section-qa-state-grid',
        ...
        'columns' => array(
            ...
            array(
                ...
                'name' => 'id',
                'editable' => array(
                    'url' => $this->createUrl('/sectionQaState/editableSaver'),
                    //'placement' => 'right',
                )
            ),
            array(
            ...
            */
            ...
            array(
                ...
                'buttons' => array(
                    'view' => array('visible' => 'Yii::app()->user->checkAccess("SectionQaState.View")'),
                    'update' => array('visible' => 'Yii::app()->user->checkAccess("SectionQaState.Update")'),
                    'delete' => array('visible' => 'Yii::app()->user->checkAccess("SectionQaState.Delete")'),
                ),
...
?>
<?php Yii::endProfile('SectionQaState.view.grid'); ?>