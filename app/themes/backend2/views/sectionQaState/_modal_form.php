<?php
/* @var $this SectionQaStateController */
...
?>
    ...
    <div class="modal-header">
        ...
        <h3><?php echo Yii::t('model', 'Create {model}', array('{model}' => Yii::t('model', 'Section Qa State'))); ?></h3>
    </div>
    <div class="modal-body">

        <?php
        $this->renderPartial('/sectionQaState/_elements', array(
            'model' => $model,
            'form' => $form,
        ));
        ?>
    ...
    <div class="modal-footer">
        ...
        <?php
        echo CHtml::ajaxSubmitButton('Save', CHtml::normalizeUrl(array('sectionQaState/editableCreator', 'render' => true)), array(
            'dataType' => 'json',
            'type' => 'post',
