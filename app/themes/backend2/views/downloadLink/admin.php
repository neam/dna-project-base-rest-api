<?php
$this->setPageTitle(
    Yii::t('model', 'Download Links')
    . ' - '
    . Yii::t('crud', 'Manage')
);

$this->breadcrumbs[] = Yii::t('model', 'Download Links');
        ...
        'columns' => array(
            ...
            */
            ...
            array(
                ...
                'buttons' => array(
                    'view' => array('visible' => 'Yii::app()->user->checkAccess("B61b08a5.DownloadLink.View")'),
                    'update' => array('visible' => 'Yii::app()->user->checkAccess("B61b08a5.DownloadLink.Update")'),
                    'delete' => array('visible' => 'Yii::app()->user->checkAccess("B61b08a5.DownloadLink.Delete")'),
                ),
