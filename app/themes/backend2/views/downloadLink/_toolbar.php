            ...
            $this->widget('bootstrap.widgets.TbButtonGroup', array(
                'buttons' => array(
                    array(
                        ...
                        'icon' => 'icon-search',
                        'items' => array(array('label' => 'authoringWorkflowExecutionIdDe - EzcExecution', 'url' => array('//ezcExecution/admin')), array('label' => 'clonedFrom - DownloadLink', 'url' => array('//downloadLink/admin')), array('label' => 'downloadLinks - DownloadLink', 'url' => array('//downloadLink/admin')), array('label' => 'authoringWorkflowExecutionIdEn - EzcExecution', 'url' => array('//ezcExecution/admin')), array('label' => 'authoringWorkflowExecutionIdCn - EzcExecution', 'url' => array('//ezcExecution/admin')), array('label' => 'authoringWorkflowExecutionIdEs - EzcExecution', 'url' => array('//ezcExecution/admin')), array('label' => 'authoringWorkflowExecutionIdFa - EzcExecution', 'url' => array('//ezcExecution/admin')), array('label' => 'authoringWorkflowExecutionIdHi - EzcExecution', 'url' => array('//ezcExecution/admin')), array('label' => 'authoringWorkflowExecutionIdPt - EzcExecution', 'url' => array('//ezcExecution/admin')), array('label' => 'authoringWorkflowExecutionIdSv - EzcExecution', 'url' => array('//ezcExecution/admin')), array('label' => 'node - Node', 'url' => array('//node/admin')), array('label' => 'fileMedia - P3Media', 'url' => array('//p3Media/admin')), array('label' => 'sectionContents - SectionContent', 'url' => array('//sectionContent/admin'))
                        )
                    ),
                ),
            ));
