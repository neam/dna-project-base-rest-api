            ...
            $this->widget('\TbButtonGroup', array(
                'buttons' => array(
                    array(
                        ...
                        'icon' => 'glyphicon-search',
                        'items' => array(array('label' => 'outEdges - Edge', 'url' => array('//edge/admin')), array('label' => 'outNodes - Node', 'url' => array('//node/admin')), array('label' => 'inEdges - Edge', 'url' => array('//edge/admin')), array('label' => 'inNodes - Node', 'url' => array('//node/admin')), array('label' => 'owner - Account', 'url' => array('//account/admin')), array('label' => 'downloadLinkQaState - DownloadLinkQaState', 'url' => array('//downloadLinkQaState/admin')), array('label' => 'clonedFrom - DownloadLink', 'url' => array('//downloadLink/admin')), array('label' => 'downloadLinks - DownloadLink', 'url' => array('//downloadLink/admin')), array('label' => 'node - Node', 'url' => array('//node/admin')), array('label' => 'fileMedia - P3Media', 'url' => array('//p3Media/admin'))
                        )
                    ),
                ),
            ));
