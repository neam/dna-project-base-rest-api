<?php
$this->setPageTitle(
    Yii::t('model', 'Waffle Data Sources')
    . ' - '
    . Yii::t('crud', 'Manage')
);

$this->breadcrumbs[] = Yii::t('model', 'Waffle Data Sources');
...
<?php Yii::beginProfile('WaffleDataSource.view.grid'); ?>


<?php
$this->widget('\TbGridView',
    array(
        'id' => 'waffle-data-source-grid',
        ...
        'columns' => array(
            ...
            */
            ...
            array(
                ...
                'buttons' => array(
                    'view' => array('visible' => 'Yii::app()->user->checkAccess("WaffleDataSource.View")'),
                    'update' => array('visible' => 'Yii::app()->user->checkAccess("WaffleDataSource.Update")'),
                    'delete' => array('visible' => 'Yii::app()->user->checkAccess("WaffleDataSource.Delete")'),
                ),
...
?>
<?php Yii::endProfile('WaffleDataSource.view.grid'); ?>