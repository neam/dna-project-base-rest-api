            ...
            $this->widget('\TbButtonGroup', array(
                'buttons' => array(
                    array(
                        ...
                        'icon' => 'glyphicon-search',
                        'items' => array(array('label' => 'outEdges - Edge', 'url' => array('//edge/admin')), array('label' => 'outNodes - Node', 'url' => array('//node/admin')), array('label' => 'inEdges - Edge', 'url' => array('//edge/admin')), array('label' => 'inNodes - Node', 'url' => array('//node/admin')), array('label' => 'owner - Account', 'url' => array('//account/admin')), array('label' => 'node - Node', 'url' => array('//node/admin')), array('label' => 'waffle - Waffle', 'url' => array('//waffle/admin')), array('label' => 'imageSmallMedia - P3Media', 'url' => array('//p3Media/admin')), array('label' => 'imageLargeMedia - P3Media', 'url' => array('//p3Media/admin')), array('label' => 'clonedFrom - WaffleDataSource', 'url' => array('//waffleDataSource/admin')), array('label' => 'waffleDataSources - WaffleDataSource', 'url' => array('//waffleDataSource/admin')), array('label' => 'waffleDataSourceQaState - WaffleDataSourceQaState', 'url' => array('//waffleDataSourceQaState/admin'))
                        )
                    ),
                ),
            ));
