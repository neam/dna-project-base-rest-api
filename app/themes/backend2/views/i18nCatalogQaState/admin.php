<?php
$this->setPageTitle(
    Yii::t('model', 'I18n Catalog Qa States')
    . ' - '
    . Yii::t('crud', 'Manage')
);

$this->breadcrumbs[] = Yii::t('model', 'I18n Catalog Qa States');
...
<?php $this->widget("\TbBreadcrumb", array("links" => $this->breadcrumbs)) ?>
    <h1>
        ...
        <?php echo Yii::t('model', 'I18n Catalog Qa States'); ?>
...
<?php Yii::beginProfile('I18nCatalogQaState.view.grid'); ?>


<?php
$this->widget('\TbGridView',
    array(
        'id' => 'i18n-catalog-qa-state-grid',
        ...
        'columns' => array(
            ...
            */
            ...
            array(
                ...
                'buttons' => array(
                    'view' => array('visible' => 'Yii::app()->user->checkAccess("I18nCatalogQaState.View")'),
                    'update' => array('visible' => 'Yii::app()->user->checkAccess("I18nCatalogQaState.Update")'),
                    'delete' => array('visible' => 'Yii::app()->user->checkAccess("I18nCatalogQaState.Delete")'),
                ),
...
?>
<?php Yii::endProfile('I18nCatalogQaState.view.grid'); ?>