...
<?php echo CHtml::encode($model->pot_import_media_id_approved); ?>
<br />
...
<b><?php echo CHtml::encode($model->getAttributeLabel('pot_import_media_id_proofed')); ?>:</b>
                ...
                'attributes' => array(
                    ...
                    array(
                        ...
                        'value' => $this->widget(
                                ...
                                array(
                                    'model' => $model,
                                    'attribute' => 'pot_import_media_id_approved',
                                    'url' => $this->createUrl('/i18nCatalogQaState/editableSaver'),
                                ),
                                true
                            )
