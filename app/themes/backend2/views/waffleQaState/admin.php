<?php
$this->setPageTitle(
    Yii::t('model', 'Waffle Qa States')
    . ' - '
    . Yii::t('crud', 'Manage')
);

$this->breadcrumbs[] = Yii::t('model', 'Waffle Qa States');
...
<?php $this->widget("\TbBreadcrumb", array("links" => $this->breadcrumbs)) ?>
    <h1>
        ...
        <?php echo Yii::t('model', 'Waffle Qa States'); ?>
...
<?php Yii::beginProfile('WaffleQaState.view.grid'); ?>


<?php
$this->widget('\TbGridView',
    array(
        'id' => 'waffle-qa-state-grid',
        ...
        'columns' => array(
            ...
            array(
                'class' => 'TbEditableColumn',
                'name' => 'waffle_publisher_id_approved',
                'editable' => array(
                    'url' => $this->createUrl('/waffleQaState/editableSaver'),
                    //'placement' => 'right',
                )
            ...
            array(
                'class' => 'TbEditableColumn',
                'name' => 'waffle_publisher_id_proofed',
                'editable' => array(
                    'url' => $this->createUrl('/waffleQaState/editableSaver'),
                    //'placement' => 'right',
                )
            ...
            */
            ...
            array(
                ...
                'buttons' => array(
                    'view' => array('visible' => 'Yii::app()->user->checkAccess("WaffleQaState.View")'),
                    'update' => array('visible' => 'Yii::app()->user->checkAccess("WaffleQaState.Update")'),
                    'delete' => array('visible' => 'Yii::app()->user->checkAccess("WaffleQaState.Delete")'),
                ),
...
?>
<?php Yii::endProfile('WaffleQaState.view.grid'); ?>