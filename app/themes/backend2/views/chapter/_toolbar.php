            ...
            $this->widget('bootstrap.widgets.TbButtonGroup', array(
                'buttons' => array(
                    array(
                        ...
                        'icon' => 'icon-search',
                        'items' => array(array('label' => 'chapterQaStateIdEn - ChapterQaState', 'url' => array('//chapterQaState/admin')), array('label' => 'chapterQaStateIdCn - ChapterQaState', 'url' => array('//chapterQaState/admin')), array('label' => 'chapterQaStateIdDe - ChapterQaState', 'url' => array('//chapterQaState/admin')), array('label' => 'chapterQaStateIdEs - ChapterQaState', 'url' => array('//chapterQaState/admin')), array('label' => 'chapterQaStateIdFa - ChapterQaState', 'url' => array('//chapterQaState/admin')), array('label' => 'chapterQaStateIdHi - ChapterQaState', 'url' => array('//chapterQaState/admin')), array('label' => 'chapterQaStateIdPt - ChapterQaState', 'url' => array('//chapterQaState/admin')), array('label' => 'chapterQaStateIdSv - ChapterQaState', 'url' => array('//chapterQaState/admin')), array('label' => 'clonedFrom - Chapter', 'url' => array('//chapter/admin')), array('label' => 'chapters - Chapter', 'url' => array('//chapter/admin')), array('label' => 'node - Node', 'url' => array('//node/admin')), array('label' => 'thumbnailMedia - P3Media', 'url' => array('//p3Media/admin')), array('label' => 'sections - Section', 'url' => array('//section/admin'))
                        )
                    ),
                ),
            ));
