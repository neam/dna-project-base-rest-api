<div class="wide form">
    ...
    <div class="row">
        <?php echo $form->label($model, 'markup_en_approved'); ?>
        <?php echo $form->checkBox($model, 'markup_en_approved'); ?>
    </div>

    <div class="row">
        <?php echo $form->label($model, 'correct_approved'); ?>
        <?php echo $form->checkBox($model, 'correct_approved'); ?>
    </div>
    ...
    <div class="row">
        <?php echo $form->label($model, 'markup_en_proofed'); ?>
        <?php echo $form->checkBox($model, 'markup_en_proofed'); ?>
    </div>

    <div class="row">
        <?php echo $form->label($model, 'correct_proofed'); ?>
        <?php echo $form->checkBox($model, 'correct_proofed'); ?>
    </div>
