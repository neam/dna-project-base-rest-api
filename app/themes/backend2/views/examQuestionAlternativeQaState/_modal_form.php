<?php
/* @var $this ExamQuestionAlternativeQaStateController */
...
?>
    ...
    <div class="modal-header">
        ...
        <h3><?php echo Yii::t('model', 'Create {model}', array('{model}' => Yii::t('model', 'Exam Question Alternative Qa State'))); ?></h3>
    </div>
    <div class="modal-body">

        <?php
        $this->renderPartial('/examQuestionAlternativeQaState/_elements', array(
            'model' => $model,
            'form' => $form,
        ));
        ?>
    ...
    <div class="modal-footer">
        ...
        <?php
        echo CHtml::ajaxSubmitButton('Save', CHtml::normalizeUrl(array('examQuestionAlternativeQaState/editableCreator', 'render' => true)), array(
            'dataType' => 'json',
            'type' => 'post',
