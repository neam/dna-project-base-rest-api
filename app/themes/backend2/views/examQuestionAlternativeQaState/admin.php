<?php
$this->setPageTitle(
    Yii::t('model', 'Exam Question Alternative Qa States')
    . ' - '
    . Yii::t('crud', 'Manage')
);

$this->breadcrumbs[] = Yii::t('model', 'Exam Question Alternative Qa States');
Yii::app()->clientScript->registerScript('search', "
    ...
    $('.search-form form').submit(function(){
        $.fn.yiiGridView.update(
            'exam-question-alternative-qa-state-grid',
            {data: $(this).serialize()}
        );
        return false;
    });
...
<?php $this->widget("\TbBreadcrumb", array("links" => $this->breadcrumbs)) ?>
    <h1>
        ...
        <?php echo Yii::t('model', 'Exam Question Alternative Qa States'); ?>
...
<?php Yii::beginProfile('ExamQuestionAlternativeQaState.view.grid'); ?>


<?php
$this->widget('\TbGridView',
    array(
        'id' => 'exam-question-alternative-qa-state-grid',
        ...
        'columns' => array(
            ...
            array(
                ...
                'name' => 'id',
                'editable' => array(
                    'url' => $this->createUrl('/examQuestionAlternativeQaState/editableSaver'),
                    //'placement' => 'right',
                )
            ),
            array(
            ...
            */
            ...
            array(
                ...
                'buttons' => array(
                    'view' => array('visible' => 'Yii::app()->user->checkAccess("ExamQuestionAlternativeQaState.View")'),
                    'update' => array('visible' => 'Yii::app()->user->checkAccess("ExamQuestionAlternativeQaState.Update")'),
                    'delete' => array('visible' => 'Yii::app()->user->checkAccess("ExamQuestionAlternativeQaState.Delete")'),
                ),
...
?>
<?php Yii::endProfile('ExamQuestionAlternativeQaState.view.grid'); ?>