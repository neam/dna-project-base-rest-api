<div class="wide form">
    ...
    <div class="row">
        <?php echo $form->label($model, 'processed_media_id_en_approved'); ?>
        <?php echo $form->checkBox($model, 'processed_media_id_en_approved'); ?>
    </div>
    ...
    <div class="row">
        <?php echo $form->label($model, 'processed_media_id_en_proofed'); ?>
        <?php echo $form->checkBox($model, 'processed_media_id_en_proofed'); ?>
    </div>
