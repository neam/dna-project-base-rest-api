<?php
$this->setPageTitle(
    Yii::t('model', 'Vector Graphic Qa States')
    . ' - '
    . Yii::t('crud', 'Manage')
);

$this->breadcrumbs[] = Yii::t('model', 'Vector Graphic Qa States');
...
<?php $this->widget("\TbBreadcrumb", array("links" => $this->breadcrumbs)) ?>
    <h1>
        ...
        <?php echo Yii::t('model', 'Vector Graphic Qa States'); ?>
...
<?php Yii::beginProfile('VectorGraphicQaState.view.grid'); ?>


<?php
$this->widget('\TbGridView',
    array(
        'id' => 'vector-graphic-qa-state-grid',
        ...
        'columns' => array(
            ...
            */
            ...
            array(
                ...
                'buttons' => array(
                    'view' => array('visible' => 'Yii::app()->user->checkAccess("VectorGraphicQaState.View")'),
                    'update' => array('visible' => 'Yii::app()->user->checkAccess("VectorGraphicQaState.Update")'),
                    'delete' => array('visible' => 'Yii::app()->user->checkAccess("VectorGraphicQaState.Delete")'),
                ),
...
?>
<?php Yii::endProfile('VectorGraphicQaState.view.grid'); ?>