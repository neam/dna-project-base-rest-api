        ...
        'columns' => array(
            ...
            */
            ...
            array(
                ...
                'buttons' => array(
                    'view' => array('visible' => 'Yii::app()->user->checkAccess("92f9838d.DataSource.View")'),
                    'update' => array('visible' => 'Yii::app()->user->checkAccess("92f9838d.DataSource.Update")'),
                    'delete' => array('visible' => 'Yii::app()->user->checkAccess("92f9838d.DataSource.Delete")'),
                ),
