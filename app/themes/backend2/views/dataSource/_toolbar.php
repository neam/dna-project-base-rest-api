            ...
            $this->widget('bootstrap.widgets.TbButtonGroup', array(
                'buttons' => array(
                    array(
                        ...
                        'icon' => 'icon-search',
                        'items' => array(array('label' => 'dataChunks - DataChunk', 'url' => array('//dataChunk/admin')), array('label' => 'authoringWorkflowExecutionIdDe - EzcExecution', 'url' => array('//ezcExecution/admin')), array('label' => 'clonedFrom - Snapshot', 'url' => array('//snapshot/admin')), array('label' => 'authoringWorkflowExecutionIdEn - EzcExecution', 'url' => array('//ezcExecution/admin')), array('label' => 'authoringWorkflowExecutionIdCn - EzcExecution', 'url' => array('//ezcExecution/admin')), array('label' => 'authoringWorkflowExecutionIdEs - EzcExecution', 'url' => array('//ezcExecution/admin')), array('label' => 'authoringWorkflowExecutionIdFa - EzcExecution', 'url' => array('//ezcExecution/admin')), array('label' => 'authoringWorkflowExecutionIdHi - EzcExecution', 'url' => array('//ezcExecution/admin')), array('label' => 'authoringWorkflowExecutionIdPt - EzcExecution', 'url' => array('//ezcExecution/admin')), array('label' => 'authoringWorkflowExecutionIdSv - EzcExecution', 'url' => array('//ezcExecution/admin')), array('label' => 'node - Node', 'url' => array('//node/admin')), array('label' => 'logoMedia - P3Media', 'url' => array('//p3Media/admin')), array('label' => 'miniLogoMedia - P3Media', 'url' => array('//p3Media/admin')), array('label' => 'spreadsheetFiles - SpreadsheetFile', 'url' => array('//spreadsheetFile/admin'))
                        )
                    ),
                ),
            ));
