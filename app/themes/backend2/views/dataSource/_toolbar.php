            ...
            $this->widget('\TbButtonGroup', array(
                'buttons' => array(
                    array(
                        ...
                        'icon' => 'glyphicon-search',
                        'items' => array(array('label' => 'outEdges - Edge', 'url' => array('//edge/admin')), array('label' => 'outNodes - Node', 'url' => array('//node/admin')), array('label' => 'inEdges - Edge', 'url' => array('//edge/admin')), array('label' => 'inNodes - Node', 'url' => array('//node/admin')), array('label' => 'dataSourceQaState - DataSourceQaState', 'url' => array('//dataSourceQaState/admin')), array('label' => 'clonedFrom - Snapshot', 'url' => array('//snapshot/admin')), array('label' => 'node - Node', 'url' => array('//node/admin')), array('label' => 'logoMedia - P3Media', 'url' => array('//p3Media/admin')), array('label' => 'miniLogoMedia - P3Media', 'url' => array('//p3Media/admin')), array('label' => 'owner - Account', 'url' => array('//account/admin')), array('label' => 'spreadsheetFiles - SpreadsheetFile', 'url' => array('//spreadsheetFile/admin'))
                        )
                    ),
                ),
            ));
