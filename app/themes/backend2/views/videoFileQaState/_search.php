<div class="wide form">
    ...
    <div class="row">
        <?php echo $form->label($model, 'clip_approved'); ?>
        <?php echo $form->checkBox($model, 'clip_approved'); ?>
    </div>
    ...
    <div class="row">
        <?php echo $form->label($model, 'clip_proofed'); ?>
        <?php echo $form->checkBox($model, 'clip_proofed'); ?>
    </div>
    ...
    <div class="row">
        <?php echo $form->label($model, 'subtitles_en_approved'); ?>
        <?php echo $form->checkBox($model, 'subtitles_en_approved'); ?>
    </div>
