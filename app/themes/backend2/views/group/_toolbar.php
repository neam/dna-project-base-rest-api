            ...
            $this->widget('\TbButtonGroup', array(
                'buttons' => array(
                    array(
                        ...
                        'icon' => 'glyphicon-search',
                        'items' => array(array('label' => 'groupHasAccounts - GroupHasAccount', 'url' => array('//groupHasAccount/admin')), array('label' => 'nodeHasGroups - NodeHasGroup', 'url' => array('//nodeHasGroup/admin'))
                        )
                    ),
                ),
            ));
