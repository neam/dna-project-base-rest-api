<div class="wide form">
    ...
    <div class="row">
        <?php echo $form->label($model, 'link_approved'); ?>
        <?php echo $form->checkBox($model, 'link_approved'); ?>
    </div>
    ...
    <div class="row">
        <?php echo $form->label($model, 'link_proofed'); ?>
        <?php echo $form->checkBox($model, 'link_proofed'); ?>
    </div>
    ...
    <div class="row">
        <?php echo $form->label($model, 'vizabi_state_approved'); ?>
        <?php echo $form->checkBox($model, 'vizabi_state_approved'); ?>
    </div>
    ...
    <div class="row">
        <?php echo $form->label($model, 'vizabi_state_proofed'); ?>
        <?php echo $form->checkBox($model, 'vizabi_state_proofed'); ?>
    </div>
