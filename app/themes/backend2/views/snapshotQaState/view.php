...
<b><?php echo CHtml::encode($model->getAttributeLabel('vizabi_state_approved')); ?>:</b>
<?php echo CHtml::encode($model->vizabi_state_approved); ?>
<br />
...
<b><?php echo CHtml::encode($model->getAttributeLabel('vizabi_state_proofed')); ?>:</b>
<?php echo CHtml::encode($model->vizabi_state_proofed); ?>
<br />
        ...
        $this->widget(
            ...
            array(
                ...
                'attributes' => array(
                    ...
                    array(
                        'name' => 'vizabi_state_approved',
                        'type' => 'raw',
                        'value' => $this->widget(
                                'TbEditableField',
                                array(
                                    'model' => $model,
                                    'attribute' => 'vizabi_state_approved',
                                    'url' => $this->createUrl('/snapshotQaState/editableSaver'),
                                ),
                                true
                            )
                    ...
                    array(
                        'name' => 'vizabi_state_proofed',
                        'type' => 'raw',
                        'value' => $this->widget(
                                'TbEditableField',
                                array(
                                    'model' => $model,
                                    'attribute' => 'vizabi_state_proofed',
                                    'url' => $this->createUrl('/snapshotQaState/editableSaver'),
                                ),
                                true
                            )
