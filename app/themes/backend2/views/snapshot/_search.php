<div class="wide form">
    ...
    <div class="row">
        <?php echo $form->label($model, 'vizabi_state'); ?>
        <?php echo $form->textArea($model, 'vizabi_state', array('rows' => 6, 'cols' => 50)); ?>
    </div>
    ...
    <div class="row">
        <?php echo $form->label($model, 'snapshot_qa_state_id'); ?>
        <?php echo $form->textField($model, 'snapshot_qa_state_id', array('size' => 20, 'maxlength' => 20)); ?>
    </div>
