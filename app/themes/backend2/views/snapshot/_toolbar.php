    ...
    <?php if ($this->action->id == 'admin'): ?>
        ...
        <div class="btn-group">
            ...
            'label' => Yii::t('model', 'Relations'),
                        'icon' => 'icon-search',
                        'items' => array(array('label' => 'outEdges - Edge', 'url' => array('//edge/admin')), array('label' => 'outNodes - Node', 'url' => array('//node/admin')), array('label' => 'inEdges - Edge', 'url' => array('//edge/admin')), array('label' => 'inNodes - Node', 'url' => array('//node/admin')), array('label' => 'snapshotQaStateIdEn - snapshotQaState', 'url' => array('//snapshotQaState/admin')), array('label' => 'snapshotQaStateIdCn - snapshotQaState', 'url' => array('//snapshotQaState/admin')), array('label' => 'snapshotQaStateIdDe - snapshotQaState', 'url' => array('//snapshotQaState/admin')), array('label' => 'snapshotQaStateIdEs - snapshotQaState', 'url' => array('//snapshotQaState/admin')), array('label' => 'snapshotQaStateIdFa - snapshotQaState', 'url' => array('//snapshotQaState/admin')), array('label' => 'snapshotQaStateIdHi - snapshotQaState', 'url' => array('//snapshotQaState/admin')), array('label' => 'snapshotQaStateIdPt - snapshotQaState', 'url' => array('//snapshotQaState/admin')), array('label' => 'snapshotQaStateIdSv - snapshotQaState', 'url' => array('//snapshotQaState/admin')), array('label' => 'clonedFrom - snapshot', 'url' => array('//snapshot/admin')), array('label' => 'snapshots - snapshot', 'url' => array('//snapshot/admin')), array('label' => 'node - Node', 'url' => array('//node/admin')), array('label' => 'thumbnailMedia - P3Media', 'url' => array('//p3Media/admin')), array('label' => 'videos - VideoFile', 'url' => array('//videoFile/admin')), array('label' => 'exercises - Exercise', 'url' => array('//exercise/admin')), array('label' => 'snapshots - Snapshot', 'url' => array('//snapshot/admin'))
            )
                    ),
                ),
            ));
