            ...
            $this->widget('bootstrap.widgets.TbButtonGroup', array(
                'buttons' => array(
                    array(
                        ...
                        'icon' => 'icon-search',
                        'items' => array(array('label' => 'outEdges - Edge', 'url' => array('//edge/admin')), array('label' => 'outNodes - Node', 'url' => array('//node/admin')), array('label' => 'inEdges - Edge', 'url' => array('//edge/admin')), array('label' => 'inNodes - Node', 'url' => array('//node/admin')), array('label' => 'toolQaStateIdEn - ToolQaState', 'url' => array('//toolQaState/admin')), array('label' => 'toolQaStateIdCn - ToolQaState', 'url' => array('//toolQaState/admin')), array('label' => 'toolQaStateIdDe - ToolQaState', 'url' => array('//toolQaState/admin')), array('label' => 'toolQaStateIdEs - ToolQaState', 'url' => array('//toolQaState/admin')), array('label' => 'toolQaStateIdFa - ToolQaState', 'url' => array('//toolQaState/admin')), array('label' => 'toolQaStateIdHi - ToolQaState', 'url' => array('//toolQaState/admin')), array('label' => 'toolQaStateIdPt - ToolQaState', 'url' => array('//toolQaState/admin')), array('label' => 'toolQaStateIdSv - ToolQaState', 'url' => array('//toolQaState/admin')), array('label' => 'clonedFrom - Tool', 'url' => array('//tool/admin')), array('label' => 'tools - Tool', 'url' => array('//tool/admin')), array('label' => 'node - Node', 'url' => array('//node/admin')), array('label' => 'thumbnailMedia - P3Media', 'url' => array('//p3Media/admin')), array('label' => 'videos - VideoFile', 'url' => array('//videoFile/admin')), array('label' => 'exercises - Exercise', 'url' => array('//exercise/admin')), array('label' => 'snapshots - Snapshot', 'url' => array('//snapshot/admin'))
                        )
                    ),
                ),
            ));
