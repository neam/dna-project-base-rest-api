<?php
/* @var $this DataChunkQaStateController */
...
?>
    ...
    <div class="modal-body">
        ...
        <?php
        $this->renderPartial('/dataChunkQaState/_elements', array(
            'model' => $model,
            'form' => $form,
        ));
        ?>
    ...
    <div class="modal-footer">
        ...
        <?php
        echo CHtml::ajaxSubmitButton('Save', CHtml::normalizeUrl(array('dataChunkQaState/editableCreator', 'render' => true)), array(
            'dataType' => 'json',
            'type' => 'post',
