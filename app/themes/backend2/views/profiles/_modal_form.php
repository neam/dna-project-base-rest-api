...
?>
    ...
    <div class="modal-header">
        ...
        <h3><?php echo Yii::t('model', 'Create {model}', array('{model}' => Yii::t('model', 'Profiles'))); ?></h3>
    </div>
    ...
    <div class="modal-footer">
        ...
        <?php
        echo CHtml::ajaxSubmitButton('Save', CHtml::normalizeUrl(array('profiles/editableCreator', 'render' => true)), array(
            'dataType' => 'json',
            'type' => 'post',
