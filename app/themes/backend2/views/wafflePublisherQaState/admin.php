<?php
$this->setPageTitle(
    Yii::t('model', 'Waffle Publisher Qa States')
    . ' - '
    . Yii::t('crud', 'Manage')
);

$this->breadcrumbs[] = Yii::t('model', 'Waffle Publisher Qa States');
Yii::app()->clientScript->registerScript('search', "
    ...
    $('.search-form form').submit(function(){
        $.fn.yiiGridView.update(
            'waffle-publisher-qa-state-grid',
            {data: $(this).serialize()}
        );
        return false;
    });
...
<?php $this->widget("\TbBreadcrumb", array("links" => $this->breadcrumbs)) ?>
    <h1>
        ...
        <?php echo Yii::t('model', 'Waffle Publisher Qa States'); ?>
...
<?php Yii::beginProfile('WafflePublisherQaState.view.grid'); ?>


<?php
$this->widget('\TbGridView',
    array(
        'id' => 'waffle-publisher-qa-state-grid',
        ...
        'columns' => array(
            ...
            */
            ...
            array(
                ...
                'buttons' => array(
                    'view' => array('visible' => 'Yii::app()->user->checkAccess("WafflePublisherQaState.View")'),
                    'update' => array('visible' => 'Yii::app()->user->checkAccess("WafflePublisherQaState.Update")'),
                    'delete' => array('visible' => 'Yii::app()->user->checkAccess("WafflePublisherQaState.Delete")'),
                ),
...
?>
<?php Yii::endProfile('WafflePublisherQaState.view.grid'); ?>