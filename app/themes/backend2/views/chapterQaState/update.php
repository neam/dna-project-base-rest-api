...
<div class="btn-group">
    <?php $this->widget('\TbButtonGroup', array(
        ...
        'buttons' => array(
            array('label' => Yii::t('model', 'Create'), 'icon' => 'glyphicon-plus', 'url' => array('chapter/create', 'Chapter' => array('chapter_qa_state_id' => $model->id), 'returnUrl' => Yii::app()->request->url), array('class' => ''))
        ),
    ));
    ?></div>
