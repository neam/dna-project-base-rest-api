<?php
$this->setPageTitle(
    Yii::t('model', 'Chapter Qa States')
    . ' - '
    . Yii::t('crud', 'Manage')
);

$this->breadcrumbs[] = Yii::t('model', 'Chapter Qa States');
...
?>
<?php Yii::endProfile('ChapterQaState.view.grid'); ?>