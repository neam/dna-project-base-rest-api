<div class="wide form">
    ...
    <div class="row">
        <?php echo $form->label($model, 'file_media_id_approved'); ?>
        <?php echo $form->checkBox($model, 'file_media_id_approved'); ?>
    </div>
    ...
    <div class="row">
        <?php echo $form->label($model, 'file_media_id_proofed'); ?>
        <?php echo $form->checkBox($model, 'file_media_id_proofed'); ?>
    </div>
