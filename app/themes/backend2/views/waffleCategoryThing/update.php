<?php
$this->setPageTitle(
    Yii::t('model', 'Waffle Category Thing')
    . ' - '
    . Yii::t('model', 'Update')
    . ': '
    . $model->getItemLabel()
);
$this->breadcrumbs[Yii::t('model', 'Waffle Category Things')] = array('admin');
...
<h1>
    ...
    <?php echo Yii::t('model', 'Waffle Category Thing'); ?>
    <small>
...
<div class="btn-group">
    <?php $this->widget('\TbButtonGroup', array(
        'type' => '', // '', 'primary', 'info', 'success', 'warning', 'danger' or 'inverse'
        'buttons' => array(
            array('label' => Yii::t('model', 'Create'), 'icon' => 'glyphicon-plus', 'url' => array('waffleCategoryThing/create', 'WaffleCategoryThing' => array('cloned_from_id' => $model->id), 'returnUrl' => Yii::app()->request->url), array('class' => ''))
        ),
    ));
    ?></div>
