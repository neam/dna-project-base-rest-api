    ...
    <div class="span8"> <!-- main inputs -->
        ...
        <div class="form-horizontal">
            ...
            $input = $this->widget(
                ...
                , true);
            echo $form->customRow($model, 'waffle_category_id', $input);
            ?>

            <?php
            $formId = 'waffle-category-element-waffle_category_id-' . \uniqid() . '-form';
            ?>
            ...
            <div class="control-group">
                <div class="controls">
                    ...
                    echo $this->widget('\TbButton', array(
                        'label' => Yii::t('model', 'Create {model}', array('{model}' => Yii::t('model', 'Waffle Category'))),
                        'icon' => 'glyphicon-plus',
                        'htmlOptions' => array(
                            'data-toggle' => 'modal',
            ...
            <?php
            $formId = 'waffle-category-element-owner_id-' . \uniqid() . '-form';
            ?>
            ...
            $this->renderPartial('//account/_modal_form', array(
                'formId' => $formId,
                'inputSelector' => '#WaffleCategoryElement_owner_id',
                'model' => new Account,
                'pk' => 'id',
                'field' => 'itemLabel',
            ));
