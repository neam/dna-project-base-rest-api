            ...
            $this->widget('\TbButtonGroup', array(
                'buttons' => array(
                    array(
                        ...
                        'icon' => 'glyphicon-search',
                        'items' => array(array('label' => 'outEdges - Edge', 'url' => array('//edge/admin')), array('label' => 'outNodes - Node', 'url' => array('//node/admin')), array('label' => 'inEdges - Edge', 'url' => array('//edge/admin')), array('label' => 'inNodes - Node', 'url' => array('//node/admin')), array('label' => 'owner - Account', 'url' => array('//account/admin')), array('label' => 'node - Node', 'url' => array('//node/admin')), array('label' => 'waffleCategory - WaffleCategory', 'url' => array('//waffleCategory/admin')), array('label' => 'clonedFrom - WaffleCategoryElement', 'url' => array('//waffleCategoryElement/admin')), array('label' => 'waffleCategoryElements - WaffleCategoryElement', 'url' => array('//waffleCategoryElement/admin')), array('label' => 'waffleCategoryElementQaState - WaffleCategoryElementQaState', 'url' => array('//waffleCategoryElementQaState/admin'))
                        )
                    ),
                ),
            ));
