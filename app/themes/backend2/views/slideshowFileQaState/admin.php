<?php
$this->setPageTitle(
    Yii::t('model', 'Slideshow File Qa States')
    . ' - '
    . Yii::t('crud', 'Manage')
);

$this->breadcrumbs[] = Yii::t('model', 'Slideshow File Qa States');
...
<?php $this->widget("\TbBreadcrumb", array("links" => $this->breadcrumbs)) ?>
    <h1>
        ...
        <?php echo Yii::t('model', 'Slideshow File Qa States'); ?>
...
<?php Yii::beginProfile('SlideshowFileQaState.view.grid'); ?>


<?php
$this->widget('\TbGridView',
    array(
        'id' => 'slideshow-file-qa-state-grid',
        ...
        'columns' => array(
            ...
            */
            ...
            array(
                ...
                'buttons' => array(
                    'view' => array('visible' => 'Yii::app()->user->checkAccess("SlideshowFileQaState.View")'),
                    'update' => array('visible' => 'Yii::app()->user->checkAccess("SlideshowFileQaState.Update")'),
                    'delete' => array('visible' => 'Yii::app()->user->checkAccess("SlideshowFileQaState.Delete")'),
                ),
...
?>
<?php Yii::endProfile('SlideshowFileQaState.view.grid'); ?>