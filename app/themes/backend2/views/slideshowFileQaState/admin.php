        ...
        'columns' => array(
            ...
            */
            ...
            array(
                ...
                'buttons' => array(
                    'view' => array('visible' => 'Yii::app()->user->checkAccess("17a79fbd.SlideshowFileQaState.View")'),
                    'update' => array('visible' => 'Yii::app()->user->checkAccess("17a79fbd.SlideshowFileQaState.Update")'),
                    'delete' => array('visible' => 'Yii::app()->user->checkAccess("17a79fbd.SlideshowFileQaState.Delete")'),
                ),
