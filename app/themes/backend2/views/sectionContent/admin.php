        ...
        'columns' => array(
            ...
            */
            ...
            array(
                ...
                'buttons' => array(
                    'view' => array('visible' => 'Yii::app()->user->checkAccess("B61b08a5.SectionContent.View")'),
                    'update' => array('visible' => 'Yii::app()->user->checkAccess("B61b08a5.SectionContent.Update")'),
                    'delete' => array('visible' => 'Yii::app()->user->checkAccess("B61b08a5.SectionContent.Delete")'),
                ),
