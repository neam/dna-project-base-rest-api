            ...
            $this->widget('bootstrap.widgets.TbButtonGroup', array(
                'buttons' => array(
                    array(
                        ...
                        'icon' => 'icon-search',
                        'items' => array(array('label' => 'dataChunk - DataChunk', 'url' => array('//dataChunk/admin')), array('label' => 'downloadLink - DownloadLink', 'url' => array('//downloadLink/admin')), array('label' => 'examQuestion - ExamQuestion', 'url' => array('//examQuestion/admin')), array('label' => 'exercise - Exercise', 'url' => array('//exercise/admin')), array('label' => 'htmlChunk - HtmlChunk', 'url' => array('//htmlChunk/admin')), array('label' => 'node - Node', 'url' => array('//node/admin')), array('label' => 'section - Section', 'url' => array('//section/admin')), array('label' => 'slideshowFile - SlideshowFile', 'url' => array('//slideshowFile/admin')), array('label' => 'snapshot - Snapshot', 'url' => array('//snapshot/admin')), array('label' => 'teachersGuide - TeachersGuide', 'url' => array('//teachersGuide/admin')), array('label' => 'videoFile - VideoFile', 'url' => array('//videoFile/admin'))
                        )
                    ),
                ),
            ));
