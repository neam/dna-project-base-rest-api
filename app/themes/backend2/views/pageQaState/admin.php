<?php
$this->setPageTitle(
    Yii::t('model', 'Page Qa States')
    . ' - '
    . Yii::t('crud', 'Manage')
);

$this->breadcrumbs[] = Yii::t('model', 'Page Qa States');
...
<?php $this->widget("\TbBreadcrumb", array("links" => $this->breadcrumbs)) ?>
    <h1>
        ...
        <?php echo Yii::t('model', 'Page Qa States'); ?>
...
<?php Yii::beginProfile('PageQaState.view.grid'); ?>


<?php
$this->widget('\TbGridView',
    array(
        'id' => 'page-qa-state-grid',
        ...
        'columns' => array(
            ...
            array(
                ...
                'name' => 'id',
                'editable' => array(
                    'url' => $this->createUrl('/pageQaState/editableSaver'),
                    //'placement' => 'right',
                )
            ),
            array(
            ...
            */
            ...
            array(
                ...
                'buttons' => array(
                    'view' => array('visible' => 'Yii::app()->user->checkAccess("PageQaState.View")'),
                    'update' => array('visible' => 'Yii::app()->user->checkAccess("PageQaState.Update")'),
                    'delete' => array('visible' => 'Yii::app()->user->checkAccess("PageQaState.Delete")'),
                ),
...
?>
<?php Yii::endProfile('PageQaState.view.grid'); ?>