            ...
            $this->widget('bootstrap.widgets.TbButtonGroup', array(
                'buttons' => array(
                    array(
                        ...
                        'icon' => 'icon-search',
                        'items' => array(array('label' => 'poFileQaStateIdDe - PoFileQaState', 'url' => array('//poFileQaState/admin')), array('label' => 'node - Node', 'url' => array('//node/admin')), array('label' => 'originalMedia - P3Media', 'url' => array('//p3Media/admin')), array('label' => 'processedMediaIdEn - P3Media', 'url' => array('//p3Media/admin')), array('label' => 'processedMediaIdCn - P3Media', 'url' => array('//p3Media/admin')), array('label' => 'processedMediaIdDe - P3Media', 'url' => array('//p3Media/admin')), array('label' => 'processedMediaIdEs - P3Media', 'url' => array('//p3Media/admin')), array('label' => 'processedMediaIdFa - P3Media', 'url' => array('//p3Media/admin')), array('label' => 'processedMediaIdHi - P3Media', 'url' => array('//p3Media/admin')), array('label' => 'processedMediaIdPt - P3Media', 'url' => array('//p3Media/admin')), array('label' => 'processedMediaIdSv - P3Media', 'url' => array('//p3Media/admin')), array('label' => 'clonedFrom - PoFile', 'url' => array('//poFile/admin')), array('label' => 'poFiles - PoFile', 'url' => array('//poFile/admin')), array('label' => 'poFileQaStateIdEn - PoFileQaState', 'url' => array('//poFileQaState/admin')), array('label' => 'poFileQaStateIdCn - PoFileQaState', 'url' => array('//poFileQaState/admin')), array('label' => 'poFileQaStateIdEs - PoFileQaState', 'url' => array('//poFileQaState/admin')), array('label' => 'poFileQaStateIdFa - PoFileQaState', 'url' => array('//poFileQaState/admin')), array('label' => 'poFileQaStateIdHi - PoFileQaState', 'url' => array('//poFileQaState/admin')), array('label' => 'poFileQaStateIdPt - PoFileQaState', 'url' => array('//poFileQaState/admin')), array('label' => 'poFileQaStateIdSv - PoFileQaState', 'url' => array('//poFileQaState/admin')), array('label' => 'tools - Tool', 'url' => array('//tool/admin'))
                        )
                    ),
                ),
            ));
