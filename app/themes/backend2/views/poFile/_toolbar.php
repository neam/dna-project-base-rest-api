            ...
            $this->widget('bootstrap.widgets.TbButtonGroup', array(
                'buttons' => array(
                    array(
                        ...
                        'icon' => 'icon-search',
                        'items' => array(array('label' => 'outEdges - Edge', 'url' => array('//edge/admin')), array('label' => 'outNodes - Node', 'url' => array('//node/admin')), array('label' => 'inEdges - Edge', 'url' => array('//edge/admin')), array('label' => 'inNodes - Node', 'url' => array('//node/admin')), array('label' => 'pofileQaStateIdEn - PoFileQaState', 'url' => array('//pofileQaState/admin')), array('label' => 'pofileQaStateIdCn - PoFileQaState', 'url' => array('//pofileQaState/admin')), array('label' => 'pofileQaStateIdDe - PoFileQaState', 'url' => array('//pofileQaState/admin')), array('label' => 'pofileQaStateIdEs - PoFileQaState', 'url' => array('//pofileQaState/admin')), array('label' => 'pofileQaStateIdFa - PoFileQaState', 'url' => array('//pofileQaState/admin')), array('label' => 'pofileQaStateIdHi - PoFileQaState', 'url' => array('//pofileQaState/admin')), array('label' => 'pofileQaStateIdPt - PoFileQaState', 'url' => array('//pofileQaState/admin')), array('label' => 'pofileQaStateIdSv - PoFileQaState', 'url' => array('//pofileQaState/admin')), array('label' => 'clonedFrom - PoFile', 'url' => array('//pofile/admin')), array('label' => 'pofiles - PoFile', 'url' => array('//pofile/admin')), array('label' => 'node - Node', 'url' => array('//node/admin')), array('label' => 'thumbnailMedia - P3Media', 'url' => array('//p3Media/admin')), array('label' => 'videos - VideoFile', 'url' => array('//videoFile/admin')), array('label' => 'exercises - Exercise', 'url' => array('//exercise/admin')), array('label' => 'snapshots - Snapshot', 'url' => array('//snapshot/admin'))
                        )
                    ),
                ),
            ));
