        ...
        'columns' => array(
            ...
            */
            ...
            array(
                ...
                'buttons' => array(
                    'view' => array('visible' => 'Yii::app()->user->checkAccess("B61b08a5.PoFile.View")'),
                    'update' => array('visible' => 'Yii::app()->user->checkAccess("B61b08a5.PoFile.Update")'),
                    'delete' => array('visible' => 'Yii::app()->user->checkAccess("B61b08a5.PoFile.Delete")'),
                ),
