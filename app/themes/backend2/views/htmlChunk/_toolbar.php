            ...
            $this->widget('bootstrap.widgets.TbButtonGroup', array(
                'buttons' => array(
                    array(
                        ...
                        'icon' => 'icon-search',
                        'items' => array(array('label' => 'clonedFrom - HtmlChunk', 'url' => array('//htmlChunk/admin')), array('label' => 'htmlChunks - HtmlChunk', 'url' => array('//htmlChunk/admin')), array('label' => 'node - Node', 'url' => array('//node/admin')), array('label' => 'sectionContents - SectionContent', 'url' => array('//sectionContent/admin'))
                        )
                    ),
                ),
            ));
