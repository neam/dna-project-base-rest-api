            ...
            $this->widget('bootstrap.widgets.TbButtonGroup', array(
                'buttons' => array(
                    array(
                        ...
                        'icon' => 'icon-search',
                        'items' => array(array('label' => 'outEdges - Edge', 'url' => array('//edge/admin')), array('label' => 'outNodes - Node', 'url' => array('//node/admin')), array('label' => 'inEdges - Edge', 'url' => array('//edge/admin')), array('label' => 'inNodes - Node', 'url' => array('//node/admin')), array('label' => 'examQuestionQaStateIdEn - ExamQuestionQaState', 'url' => array('//examQuestionQaState/admin')), array('label' => 'examQuestionQaStateIdCn - ExamQuestionQaState', 'url' => array('//examQuestionQaState/admin')), array('label' => 'examQuestionQaStateIdDe - ExamQuestionQaState', 'url' => array('//examQuestionQaState/admin')), array('label' => 'examQuestionQaStateIdEs - ExamQuestionQaState', 'url' => array('//examQuestionQaState/admin')), array('label' => 'examQuestionQaStateIdFa - ExamQuestionQaState', 'url' => array('//examQuestionQaState/admin')), array('label' => 'examQuestionQaStateIdHi - ExamQuestionQaState', 'url' => array('//examQuestionQaState/admin')), array('label' => 'examQuestionQaStateIdPt - ExamQuestionQaState', 'url' => array('//examQuestionQaState/admin')), array('label' => 'examQuestionQaStateIdSv - ExamQuestionQaState', 'url' => array('//examQuestionQaState/admin')), array('label' => 'clonedFrom - Snapshot', 'url' => array('//snapshot/admin')), array('label' => 'node - Node', 'url' => array('//node/admin')), array('label' => 'sourceNode - Node', 'url' => array('//node/admin')), array('label' => 'owner - Users', 'url' => array('//users/admin')), array('label' => 'examQuestionAlternatives - ExamQuestionAlternative', 'url' => array('//examQuestionAlternative/admin')), array('label' => 'sectionContents - SectionContent', 'url' => array('//sectionContent/admin'))
                        )
                    ),
                ),
            ));
