            ...
            $this->widget('bootstrap.widgets.TbButtonGroup', array(
                'buttons' => array(
                    array(
                        ...
                        'icon' => 'icon-search',
                        'items' => array(array('label' => 'authoringWorkflowExecutionIdDe - EzcExecution', 'url' => array('//ezcExecution/admin')), array('label' => 'clonedFrom - Snapshot', 'url' => array('//snapshot/admin')), array('label' => 'authoringWorkflowExecutionIdEn - EzcExecution', 'url' => array('//ezcExecution/admin')), array('label' => 'authoringWorkflowExecutionIdCn - EzcExecution', 'url' => array('//ezcExecution/admin')), array('label' => 'authoringWorkflowExecutionIdEs - EzcExecution', 'url' => array('//ezcExecution/admin')), array('label' => 'authoringWorkflowExecutionIdFa - EzcExecution', 'url' => array('//ezcExecution/admin')), array('label' => 'authoringWorkflowExecutionIdHi - EzcExecution', 'url' => array('//ezcExecution/admin')), array('label' => 'authoringWorkflowExecutionIdPt - EzcExecution', 'url' => array('//ezcExecution/admin')), array('label' => 'authoringWorkflowExecutionIdSv - EzcExecution', 'url' => array('//ezcExecution/admin')), array('label' => 'node - Node', 'url' => array('//node/admin')), array('label' => 'sourceNode - Node', 'url' => array('//node/admin')), array('label' => 'examQuestionAlternatives - ExamQuestionAlternative', 'url' => array('//examQuestionAlternative/admin')), array('label' => 'sectionContents - SectionContent', 'url' => array('//sectionContent/admin'))
                        )
                    ),
                ),
            ));
