            ...
            $this->widget('bootstrap.widgets.TbButtonGroup', array(
                'buttons' => array(
                    array(
                        ...
                        'icon' => 'icon-search',
                        'items' => array(array('label' => 'dataChunkQaStateIdDe - DataChunkQaState', 'url' => array('//dataChunkQaState/admin')), array('label' => 'dataChunkQaStateIdEn - DataChunkQaState', 'url' => array('//dataChunkQaState/admin')), array('label' => 'dataChunkQaStateIdCn - DataChunkQaState', 'url' => array('//dataChunkQaState/admin')), array('label' => 'dataChunkQaStateIdEs - DataChunkQaState', 'url' => array('//dataChunkQaState/admin')), array('label' => 'dataChunkQaStateIdFa - DataChunkQaState', 'url' => array('//dataChunkQaState/admin')), array('label' => 'dataChunkQaStateIdHi - DataChunkQaState', 'url' => array('//dataChunkQaState/admin')), array('label' => 'dataChunkQaStateIdPt - DataChunkQaState', 'url' => array('//dataChunkQaState/admin')), array('label' => 'dataChunkQaStateIdSv - DataChunkQaState', 'url' => array('//dataChunkQaState/admin')), array('label' => 'clonedFrom - DataChunk', 'url' => array('//dataChunk/admin')), array('label' => 'dataChunks - DataChunk', 'url' => array('//dataChunk/admin')), array('label' => 'dataSource - DataSource', 'url' => array('//dataSource/admin')), array('label' => 'node - Node', 'url' => array('//node/admin')), array('label' => 'fileMedia - P3Media', 'url' => array('//p3Media/admin')), array('label' => 'slideshowFile - SlideshowFile', 'url' => array('//slideshowFile/admin')), array('label' => 'vectorGraphic - VectorGraphic', 'url' => array('//vectorGraphic/admin')), array('label' => 'sectionContents - SectionContent', 'url' => array('//sectionContent/admin'))
                        )
                    ),
                ),
            ));
