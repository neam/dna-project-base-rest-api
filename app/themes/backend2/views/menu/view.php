<?php
$this->breadcrumbs[Yii::t('model', 'Menus')] = array('admin');
$this->breadcrumbs[] = $model->id;
?>
<?php $this->widget("\TbBreadcrumb", array("links" => $this->breadcrumbs)) ?>
<h1>

    <?php echo Yii::t('model', 'Menu'); ?>
    <small>
...
<b><?php echo CHtml::encode($model->getAttributeLabel('menu_qa_state_id')); ?>:</b>
<?php echo CHtml::encode($model->menu_qa_state_id); ?>
<br />
                ...
                'attributes' => array(
                    ...
                    array(
                        ...
                        'value' => ($model->clonedFrom !== null) ? CHtml::link(
                                    ...
                                    array('//menu/view', 'id' => $model->clonedFrom->id),
                                    array('class' => '')) . ' ' . CHtml::link(
                                    '<i class="icon glyphicon-pencil"></i> ',
                                    array('//menu/update', 'id' => $model->clonedFrom->id),
                                    array('class' => '')) : 'n/a',
                        'type' => 'html',
                    ),
                    array(
                    ...
                    array(
                        ...
                        'value' => ($model->menuQaState !== null) ? CHtml::link(
                                    '<i class="icon glyphicon-circle-arrow-left"></i> ' . $model->menuQaState->itemLabel,
                                    array('//menuQaState/view', 'id' => $model->menuQaState->id),
                                    array('class' => '')) . ' ' . CHtml::link(
                                    '<i class="icon glyphicon-pencil"></i> ',
                                    array('//menuQaState/update', 'id' => $model->menuQaState->id),
                                    array('class' => '')) : 'n/a',
                        'type' => 'html',
                    ),
                ),
