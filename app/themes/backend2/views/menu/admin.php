...
$this->breadcrumbs[] = Yii::t('model', 'Menus');
...
<?php Yii::beginProfile('Menu.view.grid'); ?>
        ...
        'columns' => array(
            ...
            */
            ...
            array(
                ...
                'buttons' => array(
                    'view' => array('visible' => 'Yii::app()->user->checkAccess("Menu.View")'),
                    'update' => array('visible' => 'Yii::app()->user->checkAccess("Menu.Update")'),
                    'delete' => array('visible' => 'Yii::app()->user->checkAccess("Menu.Delete")'),
                ),
...
?>
<?php Yii::endProfile('Menu.view.grid'); ?>