<?php
$this->setPageTitle(
    Yii::t('model', 'Waffle Category Qa States')
    . ' - '
    . Yii::t('crud', 'Manage')
);

$this->breadcrumbs[] = Yii::t('model', 'Waffle Category Qa States');
...
<?php $this->widget("\TbBreadcrumb", array("links" => $this->breadcrumbs)) ?>
    <h1>
        ...
        <?php echo Yii::t('model', 'Waffle Category Qa States'); ?>
...
<?php Yii::beginProfile('WaffleCategoryQaState.view.grid'); ?>


<?php
$this->widget('\TbGridView',
    array(
        'id' => 'waffle-category-qa-state-grid',
        ...
        'columns' => array(
            ...
            */
            ...
            array(
                ...
                'buttons' => array(
                    'view' => array('visible' => 'Yii::app()->user->checkAccess("WaffleCategoryQaState.View")'),
                    'update' => array('visible' => 'Yii::app()->user->checkAccess("WaffleCategoryQaState.Update")'),
                    'delete' => array('visible' => 'Yii::app()->user->checkAccess("WaffleCategoryQaState.Delete")'),
                ),
...
?>
<?php Yii::endProfile('WaffleCategoryQaState.view.grid'); ?>