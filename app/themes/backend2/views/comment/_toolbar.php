            ...
            $this->widget('bootstrap.widgets.TbButtonGroup', array(
                'buttons' => array(
                    array(
                        ...
                        'icon' => 'icon-search',
                        'items' => array(array('label' => 'parent - Comment', 'url' => array('//comment/admin')), array('label' => 'comments - Comment', 'url' => array('//comment/admin')), array('label' => 'authorUser - Users', 'url' => array('//users/admin'))
                        )
                    ),
                ),
            ));
