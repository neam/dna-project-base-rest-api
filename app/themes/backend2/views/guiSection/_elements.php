<div class="row">
    <div class="span8"> <!-- main inputs -->
        ...
        <div class="form-horizontal">
            ...
            <?php
            $formId = 'gui-section-i18n_catalog_id-' . \uniqid() . '-form';
            ?>
            ...
            $this->renderPartial('//i18nCatalog/_modal_form', array(
                'formId' => $formId,
                'inputSelector' => '#GuiSection_i18n_catalog_id',
            ...
            <?php
            $formId = 'gui-section-owner_id-' . \uniqid() . '-form';
            ?>
            ...
            $this->renderPartial('//account/_modal_form', array(
                'formId' => $formId,
                'inputSelector' => '#GuiSection_owner_id',
                'model' => new Account,
                'pk' => 'id',
                'field' => 'itemLabel',
            ));
            ...
            <?php echo $form->textFieldRow($model, 'gui_section_qa_state_id', array('maxlength' => 20)); ?>
        </div>
    </div>
    <!-- main inputs -->
