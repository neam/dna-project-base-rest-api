            ...
            $this->widget('\TbButtonGroup', array(
                'buttons' => array(
                    array(
                        ...
                        'icon' => 'glyphicon-search',
                        'items' => array(array('label' => 'outEdges - Edge', 'url' => array('//edge/admin')), array('label' => 'outNodes - Node', 'url' => array('//node/admin')), array('label' => 'inEdges - Edge', 'url' => array('//edge/admin')), array('label' => 'inNodes - Node', 'url' => array('//node/admin')), array('label' => 'owner - Account', 'url' => array('//account/admin')), array('label' => 'clonedFrom - GuiSection', 'url' => array('//guiSection/admin')), array('label' => 'guiSections - GuiSection', 'url' => array('//guiSection/admin')), array('label' => 'i18nCatalog - I18nCatalog', 'url' => array('//i18nCatalog/admin')), array('label' => 'node - Node', 'url' => array('//node/admin')), array('label' => 'guiSectionQaState - GuiSectionQaState', 'url' => array('//guiSectionQaState/admin'))
                        )
                    ),
                ),
            ));
