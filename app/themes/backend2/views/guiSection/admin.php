<?php
$this->setPageTitle(
    Yii::t('model', 'Gui Sections')
    . ' - '
    . Yii::t('crud', 'Manage')
);

$this->breadcrumbs[] = Yii::t('model', 'Gui Sections');
...
<?php Yii::beginProfile('GuiSection.view.grid'); ?>
        ...
        'columns' => array(
            ...
            */
            ...
            array(
                ...
                'buttons' => array(
                    'view' => array('visible' => 'Yii::app()->user->checkAccess("GuiSection.View")'),
                    'update' => array('visible' => 'Yii::app()->user->checkAccess("GuiSection.Update")'),
                    'delete' => array('visible' => 'Yii::app()->user->checkAccess("GuiSection.Delete")'),
                ),
...
?>
<?php Yii::endProfile('GuiSection.view.grid'); ?>