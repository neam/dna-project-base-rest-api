<?php
$this->setPageTitle(
    Yii::t('model', 'Waffle Category Thing Qa States')
    . ' - '
    . Yii::t('crud', 'Manage')
);

$this->breadcrumbs[] = Yii::t('model', 'Waffle Category Thing Qa States');
Yii::app()->clientScript->registerScript('search', "
    ...
    $('.search-form form').submit(function(){
        $.fn.yiiGridView.update(
            'waffle-category-thing-qa-state-grid',
            {data: $(this).serialize()}
        );
        return false;
    });
...
<?php $this->widget("\TbBreadcrumb", array("links" => $this->breadcrumbs)) ?>
    <h1>
        ...
        <?php echo Yii::t('model', 'Waffle Category Thing Qa States'); ?>
...
$this->widget('\TbGridView',
    array(
        'id' => 'waffle-category-thing-qa-state-grid',
