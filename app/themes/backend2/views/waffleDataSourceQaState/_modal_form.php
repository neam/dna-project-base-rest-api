<?php
/* @var $this WaffleDataSourceQaStateController */
...
?>
    ...
    <div class="modal-header">
        ...
        <h3><?php echo Yii::t('model', 'Create {model}', array('{model}' => Yii::t('model', 'Waffle Data Source Qa State'))); ?></h3>
    </div>
    <div class="modal-body">

        <?php
        $this->renderPartial('/waffleDataSourceQaState/_elements', array(
            'model' => $model,
            'form' => $form,
        ));
        ?>
    ...
    <div class="modal-footer">
        ...
        <?php
        echo CHtml::ajaxSubmitButton('Save', CHtml::normalizeUrl(array('waffleDataSourceQaState/editableCreator', 'render' => true)), array(
            'dataType' => 'json',
            'type' => 'post',
