<?php
$this->setPageTitle(
    Yii::t('model', 'Waffle Data Source Qa States')
    . ' - '
    . Yii::t('crud', 'Manage')
);

$this->breadcrumbs[] = Yii::t('model', 'Waffle Data Source Qa States');
Yii::app()->clientScript->registerScript('search', "
    ...
    $('.search-form form').submit(function(){
        $.fn.yiiGridView.update(
            'waffle-data-source-qa-state-grid',
            {data: $(this).serialize()}
        );
        return false;
    });
...
<?php $this->widget("\TbBreadcrumb", array("links" => $this->breadcrumbs)) ?>
    <h1>
        ...
        <?php echo Yii::t('model', 'Waffle Data Source Qa States'); ?>
...
<?php Yii::beginProfile('WaffleDataSourceQaState.view.grid'); ?>


<?php
$this->widget('\TbGridView',
    array(
        'id' => 'waffle-data-source-qa-state-grid',
        ...
        'columns' => array(
            ...
            array(
                ...
                'name' => 'id',
                'editable' => array(
                    'url' => $this->createUrl('/waffleDataSourceQaState/editableSaver'),
                    //'placement' => 'right',
                )
            ),
            array(
            ...
            */
            ...
            array(
                ...
                'buttons' => array(
                    'view' => array('visible' => 'Yii::app()->user->checkAccess("WaffleDataSourceQaState.View")'),
                    'update' => array('visible' => 'Yii::app()->user->checkAccess("WaffleDataSourceQaState.Update")'),
                    'delete' => array('visible' => 'Yii::app()->user->checkAccess("WaffleDataSourceQaState.Delete")'),
                ),
...
?>
<?php Yii::endProfile('WaffleDataSourceQaState.view.grid'); ?>