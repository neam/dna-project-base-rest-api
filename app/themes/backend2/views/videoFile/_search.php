<div class="wide form">
    ...
    <div class="row">
        <?php echo $form->label($model, 'clip_webm_media_id'); ?>
        <?php echo $form->textField($model, 'clip_webm_media_id'); ?>
    </div>

    <div class="row">
        <?php echo $form->label($model, 'clip_mp4_media_id'); ?>
        <?php echo $form->textField($model, 'clip_mp4_media_id'); ?>
    </div>
    ...
    <div class="row">
        <?php echo $form->label($model, 'subtitles_import_media_id'); ?>
        <?php echo $form->textField($model, 'subtitles_import_media_id'); ?>
    </div>
    ...
    <div class="row">
        <?php echo $form->label($model, 'video_file_qa_state_id'); ?>
        <?php echo $form->textField($model, 'video_file_qa_state_id', array('size' => 20, 'maxlength' => 20)); ?>
    </div>
