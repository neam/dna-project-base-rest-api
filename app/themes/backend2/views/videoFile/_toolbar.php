            ...
            $this->widget('\TbButtonGroup', array(
                'buttons' => array(
                    array(
                        ...
                        'icon' => 'glyphicon-search',
                        'items' => array(array('label' => 'outEdges - Edge', 'url' => array('//edge/admin')), array('label' => 'outNodes - Node', 'url' => array('//node/admin')), array('label' => 'inEdges - Edge', 'url' => array('//edge/admin')), array('label' => 'inNodes - Node', 'url' => array('//node/admin')), array('label' => 'node - Node', 'url' => array('//node/admin')), array('label' => 'clipWebmMedia - P3Media', 'url' => array('//p3Media/admin')), array('label' => 'clipMp4Media - P3Media', 'url' => array('//p3Media/admin')), array('label' => 'thumbnailMedia - P3Media', 'url' => array('//p3Media/admin')), array('label' => 'subtitlesImportMedia - P3Media', 'url' => array('//p3Media/admin')), array('label' => 'owner - Account', 'url' => array('//account/admin')), array('label' => 'clonedFrom - VideoFile', 'url' => array('//videoFile/admin')), array('label' => 'videoFiles - VideoFile', 'url' => array('//videoFile/admin')), array('label' => 'videoFileQaState - VideoFileQaState', 'url' => array('//videoFileQaState/admin')), array('label' => 'related - Node', 'url' => array('//node/admin'))
                        )
                    ),
                ),
            ));
