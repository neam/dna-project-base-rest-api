...
<b><?php echo CHtml::encode($model->getAttributeLabel('clip_webm_media_id')); ?>:</b>
<?php echo CHtml::encode($model->clip_webm_media_id); ?>
<br />

<b><?php echo CHtml::encode($model->getAttributeLabel('clip_mp4_media_id')); ?>:</b>
            ...
            array(
                ...
                'attributes' => array(
                    ...
                    array(
                        ...
                        'value' => ($model->clipWebmMedia !== null) ? CHtml::link(
                                    '<i class="icon glyphicon-circle-arrow-left"></i> ' . $model->clipWebmMedia->itemLabel,
                                    array('//p3Media/view', 'id' => $model->clipWebmMedia->id),
                                    array('class' => '')) . ' ' . CHtml::link(
                                    '<i class="icon glyphicon-pencil"></i> ',
                                    array('//p3Media/update', 'id' => $model->clipWebmMedia->id),
                                    array('class' => '')) : 'n/a',
                        'type' => 'html',
                    ),
                    array(
                        'name' => 'clip_mp4_media_id',
                        'value' => ($model->clipMp4Media !== null) ? CHtml::link(
                                    '<i class="icon glyphicon-circle-arrow-left"></i> ' . $model->clipMp4Media->itemLabel,
                                    array('//p3Media/view', 'id' => $model->clipMp4Media->id),
                                    array('class' => '')) . ' ' . CHtml::link(
                                    '<i class="icon glyphicon-pencil"></i> ',
                                    array('//p3Media/update', 'id' => $model->clipMp4Media->id),
                                    array('class' => '')) : 'n/a',
                        'type' => 'html',
                    ),
                    array(
                    ...
                    array(
                        ...
                        'value' => ($model->subtitlesImportMedia !== null) ? CHtml::link(
                                    '<i class="icon glyphicon-circle-arrow-left"></i> ' . $model->subtitlesImportMedia->itemLabel,
                    ...
                    array(
                        ...
                        'value' => ($model->videoFileQaState !== null) ? CHtml::link(
                                    '<i class="icon glyphicon-circle-arrow-left"></i> ' . $model->videoFileQaState->itemLabel,
                                    array('//videoFileQaState/view', 'id' => $model->videoFileQaState->id),
                                    array('class' => '')) . ' ' . CHtml::link(
                                    '<i class="icon glyphicon-pencil"></i> ',
                                    array('//videoFileQaState/update', 'id' => $model->videoFileQaState->id),
                                    array('class' => '')) : 'n/a',
                        'type' => 'html',
                    ),
                    array(
