<div class="row">
    <div class="span8"> <!-- main inputs -->
        ...
        <div class="form-horizontal">
            ...
            <?php
            $formId = 'waffle-category-waffle_id-' . \uniqid() . '-form';
            ?>
            ...
            $this->renderPartial('//waffle/_modal_form', array(
                'formId' => $formId,
                'inputSelector' => '#WaffleCategory_waffle_id',
                'model' => new Waffle,
                'pk' => 'id',
                'field' => 'itemLabel',
            ));
            ...
            <?php
            $formId = 'waffle-category-owner_id-' . \uniqid() . '-form';
            ?>
            ...
            $this->renderPartial('//account/_modal_form', array(
                'formId' => $formId,
                'inputSelector' => '#WaffleCategory_owner_id',
                'model' => new Account,
                'pk' => 'id',
                'field' => 'itemLabel',
            ));
            ...
            <?php echo $form->textFieldRow($model, 'waffle_category_qa_state_id', array('maxlength' => 20)); ?>
        </div>
    </div>
    <!-- main inputs -->
