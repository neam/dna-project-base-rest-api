            ...
            $this->widget('\TbButtonGroup', array(
                'buttons' => array(
                    array(
                        ...
                        'icon' => 'glyphicon-search',
                        'items' => array(array('label' => 'outEdges - Edge', 'url' => array('//edge/admin')), array('label' => 'outNodes - Node', 'url' => array('//node/admin')), array('label' => 'inEdges - Edge', 'url' => array('//edge/admin')), array('label' => 'inNodes - Node', 'url' => array('//node/admin')), array('label' => 'owner - Account', 'url' => array('//account/admin')), array('label' => 'waffle - Waffle', 'url' => array('//waffle/admin')), array('label' => 'node - Node', 'url' => array('//node/admin')), array('label' => 'clonedFrom - WaffleCategory', 'url' => array('//waffleCategory/admin')), array('label' => 'waffleCategories - WaffleCategory', 'url' => array('//waffleCategory/admin')), array('label' => 'waffleCategoryQaState - WaffleCategoryQaState', 'url' => array('//waffleCategoryQaState/admin')), array('label' => 'waffleCategoryThings - WaffleCategoryThing', 'url' => array('//waffleCategoryThing/admin'))
                        )
                    ),
                ),
            ));
