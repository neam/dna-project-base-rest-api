<?php
$this->setPageTitle(
    Yii::t('model', 'Gui Section Qa States')
    . ' - '
    . Yii::t('crud', 'Manage')
);

$this->breadcrumbs[] = Yii::t('model', 'Gui Section Qa States');
...
<?php $this->widget("\TbBreadcrumb", array("links" => $this->breadcrumbs)) ?>
    <h1>
        ...
        <?php echo Yii::t('model', 'Gui Section Qa States'); ?>
...
<?php Yii::beginProfile('GuiSectionQaState.view.grid'); ?>


<?php
$this->widget('\TbGridView',
    array(
        'id' => 'gui-section-qa-state-grid',
        ...
        'columns' => array(
            ...
            array(
                ...
                'name' => 'id',
                'editable' => array(
                    'url' => $this->createUrl('/guiSectionQaState/editableSaver'),
                    //'placement' => 'right',
                )
            ),
            array(
            ...
            */
            ...
            array(
                ...
                'buttons' => array(
                    'view' => array('visible' => 'Yii::app()->user->checkAccess("GuiSectionQaState.View")'),
                    'update' => array('visible' => 'Yii::app()->user->checkAccess("GuiSectionQaState.Update")'),
                    'delete' => array('visible' => 'Yii::app()->user->checkAccess("GuiSectionQaState.Delete")'),
                ),
...
?>
<?php Yii::endProfile('GuiSectionQaState.view.grid'); ?>