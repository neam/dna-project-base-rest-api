<?php
$this->setPageTitle(
    Yii::t('model', 'Gui Section Qa State')
    . ' - '
    . Yii::t('model', 'Update')
    . ': '
    . $model->getItemLabel()
);
$this->breadcrumbs[Yii::t('model', 'Gui Section Qa States')] = array('admin');
...
<h1>
    ...
    <?php echo Yii::t('model', 'Gui Section Qa State'); ?>
    <small>
...
<div class="btn-group">
    <?php $this->widget('\TbButtonGroup', array(
        ...
        'buttons' => array(
            array('label' => Yii::t('model', 'Create'), 'icon' => 'glyphicon-plus', 'url' => array('guiSection/create', 'GuiSection' => array('gui_section_qa_state_id' => $model->id), 'returnUrl' => Yii::app()->request->url), array('class' => ''))
        ),
    ));
    ?></div>
