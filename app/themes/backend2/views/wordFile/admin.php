<?php
$this->setPageTitle(
    Yii::t('model', 'Word Files')
    . ' - '
    . Yii::t('crud', 'Manage')
);

$this->breadcrumbs[] = Yii::t('model', 'Word Files');
...
<?php $this->widget("TbBreadcrumbs", array("links" => $this->breadcrumbs)) ?>
    <h1>
        ...
        <?php echo Yii::t('model', 'Word Files'); ?>
...
$this->widget('TbGridView',
    array(
        ...
        'columns' => array(
            ...
            array(
                'name' => 'cloned_from_id',
                'value' => 'CHtml::value($data, \'wordFiles.itemLabel\')',
                'filter' => CHtml::listData(WordFile::model()->findAll(array('limit' => 1000)), 'id', 'itemLabel'),
            ),
            array(
                'class' => 'TbEditableColumn',
                'name' => 'title_en',
            ...
            */
            ...
            array(
                ...
                'buttons' => array(
                    'view' => array('visible' => 'Yii::app()->user->checkAccess("WordFile.View")'),
                    'update' => array('visible' => 'Yii::app()->user->checkAccess("WordFile.Update")'),
                    'delete' => array('visible' => 'Yii::app()->user->checkAccess("WordFile.Delete")'),
                ),
