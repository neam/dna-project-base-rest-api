...
<?php
$formId = 'word-file-processed_media_id_en-' . \uniqid() . '-form';
?>
...
$this->renderPartial('//p3Media/_modal_form', array(
    'formId' => $formId,
    'inputSelector' => '#WordFile_processed_media_id_en',
    'model' => new P3Media,
    'pk' => 'id',
    'field' => 'itemLabel',
));
...
<?php
$formId = 'word-file-processed_media_id_es-' . \uniqid() . '-form';
?>
...
$this->renderPartial('//p3Media/_modal_form', array(
    'formId' => $formId,
    'inputSelector' => '#WordFile_processed_media_id_es',
    'model' => new P3Media,
    'pk' => 'id',
    'field' => 'itemLabel',
));
...
<?php
$formId = 'word-file-processed_media_id_fa-' . \uniqid() . '-form';
?>
...
$this->renderPartial('//p3Media/_modal_form', array(
    'formId' => $formId,
    'inputSelector' => '#WordFile_processed_media_id_fa',
    'model' => new P3Media,
    'pk' => 'id',
    'field' => 'itemLabel',
));
...
<?php
$formId = 'word-file-processed_media_id_hi-' . \uniqid() . '-form';
?>
...
$this->renderPartial('//p3Media/_modal_form', array(
    'formId' => $formId,
    'inputSelector' => '#WordFile_processed_media_id_hi',
    'model' => new P3Media,
    'pk' => 'id',
    'field' => 'itemLabel',
));
...
<?php
$formId = 'word-file-processed_media_id_pt-' . \uniqid() . '-form';
?>
...
$this->renderPartial('//p3Media/_modal_form', array(
    'formId' => $formId,
    'inputSelector' => '#WordFile_processed_media_id_pt',
    'model' => new P3Media,
    'pk' => 'id',
    'field' => 'itemLabel',
));
...
<?php
$formId = 'word-file-processed_media_id_sv-' . \uniqid() . '-form';
?>
...
$this->renderPartial('//p3Media/_modal_form', array(
    'formId' => $formId,
    'inputSelector' => '#WordFile_processed_media_id_sv',
    'model' => new P3Media,
    'pk' => 'id',
    'field' => 'itemLabel',
));
...
<?php
$formId = 'word-file-processed_media_id_cn-' . \uniqid() . '-form';
?>
...
$this->renderPartial('//p3Media/_modal_form', array(
    'formId' => $formId,
    'inputSelector' => '#WordFile_processed_media_id_cn',
    'model' => new P3Media,
    'pk' => 'id',
    'field' => 'itemLabel',
));
...
<?php
$formId = 'word-file-processed_media_id_de-' . \uniqid() . '-form';
?>
...
$this->renderPartial('//p3Media/_modal_form', array(
    'formId' => $formId,
    'inputSelector' => '#WordFile_processed_media_id_de',
    'model' => new P3Media,
    'pk' => 'id',
    'field' => 'itemLabel',
));
