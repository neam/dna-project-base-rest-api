<?php
$this->setPageTitle(
    Yii::t('model', 'Waffle Unit Qa States')
    . ' - '
    . Yii::t('crud', 'Manage')
);

$this->breadcrumbs[] = Yii::t('model', 'Waffle Unit Qa States');
...
<?php $this->widget("\TbBreadcrumb", array("links" => $this->breadcrumbs)) ?>
    <h1>
        ...
        <?php echo Yii::t('model', 'Waffle Unit Qa States'); ?>
...
<?php Yii::beginProfile('WaffleUnitQaState.view.grid'); ?>


<?php
$this->widget('\TbGridView',
    array(
        'id' => 'waffle-unit-qa-state-grid',
        ...
        'columns' => array(
            ...
            array(
                ...
                'name' => 'id',
                'editable' => array(
                    'url' => $this->createUrl('/waffleUnitQaState/editableSaver'),
                    //'placement' => 'right',
                )
            ),
            array(
            ...
            */
            ...
            array(
                ...
                'buttons' => array(
                    'view' => array('visible' => 'Yii::app()->user->checkAccess("WaffleUnitQaState.View")'),
                    'update' => array('visible' => 'Yii::app()->user->checkAccess("WaffleUnitQaState.Update")'),
                    'delete' => array('visible' => 'Yii::app()->user->checkAccess("WaffleUnitQaState.Delete")'),
                ),
...
?>
<?php Yii::endProfile('WaffleUnitQaState.view.grid'); ?>