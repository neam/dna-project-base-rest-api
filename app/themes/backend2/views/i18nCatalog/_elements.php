    ...
    <div class="span8"> <!-- main inputs -->
        ...
        <div class="form-horizontal">
            ...
            $input = $this->widget(
                ...
                , true);
            echo $form->customRow($model, 'pot_import_media_id', $input);
            ?>

            <?php
            $formId = 'i18n-catalog-pot_import_media_id-' . \uniqid() . '-form';
            ?>
            ...
            <?php
            $formId = 'i18n-catalog-owner_id-' . \uniqid() . '-form';
            ?>
            ...
            $this->renderPartial('//account/_modal_form', array(
                'formId' => $formId,
                'inputSelector' => '#I18nCatalog_owner_id',
                'model' => new Account,
                'pk' => 'id',
                'field' => 'itemLabel',
            ));
            ...
            <?php echo $form->textFieldRow($model, 'i18n_catalog_qa_state_id', array('maxlength' => 20)); ?>
        </div>
    </div>
    <!-- main inputs -->
