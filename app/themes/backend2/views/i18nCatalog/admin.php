<?php
$this->setPageTitle(
    Yii::t('model', 'I18n Catalogs')
    . ' - '
    . Yii::t('crud', 'Manage')
);

$this->breadcrumbs[] = Yii::t('model', 'I18n Catalogs');
...
<?php Yii::beginProfile('I18nCatalog.view.grid'); ?>


<?php
$this->widget('\TbGridView',
    array(
        'id' => 'i18n-catalog-grid',
        ...
        'columns' => array(
            ...
            */
            ...
            array(
                ...
                'buttons' => array(
                    'view' => array('visible' => 'Yii::app()->user->checkAccess("I18nCatalog.View")'),
                    'update' => array('visible' => 'Yii::app()->user->checkAccess("I18nCatalog.Update")'),
                    'delete' => array('visible' => 'Yii::app()->user->checkAccess("I18nCatalog.Delete")'),
                ),
...
?>
<?php Yii::endProfile('I18nCatalog.view.grid'); ?>