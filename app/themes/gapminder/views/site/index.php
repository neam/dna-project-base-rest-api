...
<div class="site-controller index-action">
    <div class="alert alert-info">
        ...
        <p><?php print Yii::t('app', 'We are developing new tools for writing, publishing and translating material. This web site is not intended
            for public use yet, but feel free to snoop around.'); ?></p>
