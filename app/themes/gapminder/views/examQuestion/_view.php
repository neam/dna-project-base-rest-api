...
<div class="exam-question-details">
    ...
    <div class="exam-question-attribute">
        <div class="attribute-label">
            <?php echo e($data->getAttributeLabel('id')); ?>
        </div>
        <div class="attribute-value">
            <?php echo TbHtml::link(CHtml::encode($data->id), array('examQuestion/view', 'id' => $data->id)); ?>
        </div>
    </div>
    <div class="exam-question-attribute">
        <div class="attribute-label">
            <?php echo CHtml::encode($data->getAttributeLabel('version')); ?>
        </div>
        <div class="attribute-value">
    ...
    <div class="exam-question-attribute">
        <div class="attribute-label">
            <?php echo CHtml::encode($data->getAttributeLabel('cloned_from_id')); ?>
        </div>
        <div class="attribute-value">
    ...
    <div class="exam-question-attribute">
        <div class="attribute-label">
            <?php echo CHtml::encode($data->getAttributeLabel('slug_en')); ?>
        </div>
        <div class="attribute-value">
    ...
    <div class="exam-question-attribute">
        <div class="attribute-label">
            <?php echo CHtml::encode($data->getAttributeLabel('_question')); ?>
        </div>
        <div class="attribute-value">
    ...
    <div class="exam-question-attribute">
        <div class="attribute-label">
            <?php echo CHtml::encode($data->getAttributeLabel('source_node_id')); ?>
        </div>
        <div class="attribute-value">
    ...
    */ ?>
    <?php if (Yii::app()->user->checkAccess('ExamQuestion.*')): ?>
        <div class="admin-container hide">
            <?php echo CHtml::link(
                '<i class="glyphicon-edit"></i> ' . Yii::t('model', 'Edit {model}', array('{model}' => Yii::t('model', 'Exam Question'))),
                array('examQuestion/continueAuthoring', 'id' => $data->id, 'returnUrl' => Yii::app()->request->url), array('class' => 'btn')
            ); ?>
        </div>
    <?php endif; ?>
    <?php if (Yii::app()->user->checkAccess('Developer')): ?>
        <div class="admin-container hide">
            ...
            <?php echo CHtml::link(
                '<i class="glyphicon-edit"></i> ' . Yii::t('model', 'Update {model}', array('{model}' => Yii::t('model', 'Exam Question'))),
                array('examQuestion/update', 'id' => $data->id, 'returnUrl' => Yii::app()->request->url), array('class' => 'btn')
            ); ?>
        </div>
    <?php endif; ?>
</div>
