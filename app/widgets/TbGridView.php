...
{
    const POPOVER_SELECTOR = '[data-toggle=popover]';
	 ...
	 */
	public $pager = array('class' => 'yiistrap.widgets.TbPager');
	...
	public function init()
	{
		...
		$popover = self::POPOVER_SELECTOR;
		$tooltip = self::TOOLTIP_SELECTOR;
