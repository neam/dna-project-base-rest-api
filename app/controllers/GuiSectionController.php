...
class GuiSectionController extends Controller
{
    ...
    {
        $model = new GuiSection;
        $model->scenario = $this->scenario;

        $this->performAjaxValidation($model, 'gui-section-form');

        if (isset($_POST['GuiSection'])) {
            $model->attributes = $_POST['GuiSection'];
        ...
        } elseif (isset($_GET['GuiSection'])) {
            $model->attributes = $_GET['GuiSection'];
        }
    ...
    {
        $es = new TbEditableSaver('GuiSection'); // classname of model to be updated
        $es->update();
    }
    ...
    {
        $dataProvider = new CActiveDataProvider('GuiSection');
        $this->render('index', array('dataProvider' => $dataProvider,));
    }

    public function actionAdmin()
    {
        $model = new GuiSection('search');
        $model->unsetAttributes();

        if (isset($_GET['GuiSection'])) {
            $model->attributes = $_GET['GuiSection'];
        }
    ...
    {
        $model = GuiSection::model()->findByPk($id);
        if ($model === null) {
