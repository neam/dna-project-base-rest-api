...
class GroupHasAccountController extends Controller
{
    ...
    public function beforeAction($action)
    {
        ...
        if (!isset($_GET['id']) && isset($_GET['id'])) {
            $model = GroupHasAccount::model()->find(
                'id = :id',
                array(
                    ':id' => $_GET['id']
                )
    ...
    public function actionCreate()
    {
        ...
        $this->performAjaxValidation($model, 'group-has-account-form');

        if (isset($_POST['GroupHasAccount'])) {
            $model->attributes = $_POST['GroupHasAccount'];
        ...
        } elseif (isset($_GET['GroupHasAccount'])) {
            $model->attributes = $_GET['GroupHasAccount'];
        }
    ...
    {
        $es = new TbEditableSaver('GroupHasAccount'); // classname of model to be updated
        $es->update();
    }
    ...
    {
        $dataProvider = new CActiveDataProvider('GroupHasAccount');
        $this->render('index', array('dataProvider' => $dataProvider,));
    }

    public function actionAdmin()
    {
        $model = new GroupHasAccount('search');
        $model->unsetAttributes();

        if (isset($_GET['GroupHasAccount'])) {
            $model->attributes = $_GET['GroupHasAccount'];
        }
    ...
    {
        $model = GroupHasAccount::model()->findByPk($id);
        if ($model === null) {
    ...
    {
        if (isset($_POST['ajax']) && $_POST['ajax'] === 'group-has-account-form') {
