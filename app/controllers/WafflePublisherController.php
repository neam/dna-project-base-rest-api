...
class WafflePublisherController extends Controller
{
    ...
    public function beforeAction($action)
    {
        ...
        if (!isset($_GET['id']) && isset($_GET['id'])) {
            $model = WafflePublisher::model()->find(
                'id = :id',
                array(
                    ':id' => $_GET['id']
                )
    ...
    public function actionCreate()
    {
        ...
        $this->performAjaxValidation($model, 'waffle-publisher-form');

        if (isset($_POST['WafflePublisher'])) {
            $model->attributes = $_POST['WafflePublisher'];
        ...
        } elseif (isset($_GET['WafflePublisher'])) {
            $model->attributes = $_GET['WafflePublisher'];
        }
    ...
    {
        $es = new TbEditableSaver('WafflePublisher'); // classname of model to be updated
        $es->update();
    }
    ...
    {
        $dataProvider = new CActiveDataProvider('WafflePublisher');
        $this->render('index', array('dataProvider' => $dataProvider,));
    }

    public function actionAdmin()
    {
        $model = new WafflePublisher('search');
        $model->unsetAttributes();

        if (isset($_GET['WafflePublisher'])) {
            $model->attributes = $_GET['WafflePublisher'];
        }
    ...
    {
        $model = WafflePublisher::model()->findByPk($id);
        if ($model === null) {
    ...
    {
        if (isset($_POST['ajax']) && $_POST['ajax'] === 'waffle-publisher-form') {
