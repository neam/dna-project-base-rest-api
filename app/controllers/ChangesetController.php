...
class ChangesetController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        $this->performAjaxValidation($model, 'changeset-form');
    ...
    {
        $es = new TbEditableSaver('Changeset'); // classname of model to be updated
        $es->update();
    }
    ...
    {
        $model = Changeset::model()->findByPk($id);
        if ($model === null) {
