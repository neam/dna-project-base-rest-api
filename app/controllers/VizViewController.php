...
class VizViewController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        $this->performAjaxValidation($model, 'viz-view-form');
        ...
        } elseif (isset($_GET['VizView'])) {
            $model->attributes = $_GET['VizView'];
        }
    ...
    {
        $dataProvider = new CActiveDataProvider('VizView');
        $this->render('index', array('dataProvider' => $dataProvider,));
    }

    public function actionAdmin()
    {
        $model = new VizView('search');
        $model->unsetAttributes();

        if (isset($_GET['VizView'])) {
            $model->attributes = $_GET['VizView'];
        }
    ...
    {
        $model = VizView::model()->findByPk($id);
        if ($model === null) {
    ...
    {
        if (isset($_POST['ajax']) && $_POST['ajax'] === 'viz-view-form') {
