...
class MenuQaStateController extends Controller
{
    ...
    {
        $model = new MenuQaState;
        $model->scenario = $this->scenario;

        $this->performAjaxValidation($model, 'menu-qa-state-form');

        if (isset($_POST['MenuQaState'])) {
            $model->attributes = $_POST['MenuQaState'];
        ...
        } elseif (isset($_GET['MenuQaState'])) {
            $model->attributes = $_GET['MenuQaState'];
        }
    ...
    {
        $es = new TbEditableSaver('MenuQaState'); // classname of model to be updated
        $es->update();
    }
    ...
    {
        $dataProvider = new CActiveDataProvider('MenuQaState');
        $this->render('index', array('dataProvider' => $dataProvider,));
    }

    public function actionAdmin()
    {
        $model = new MenuQaState('search');
        $model->unsetAttributes();

        if (isset($_GET['MenuQaState'])) {
            $model->attributes = $_GET['MenuQaState'];
        }
    ...
    {
        $model = MenuQaState::model()->findByPk($id);
        if ($model === null) {
    ...
    {
        if (isset($_POST['ajax']) && $_POST['ajax'] === 'menu-qa-state-form') {
