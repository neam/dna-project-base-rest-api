...
class WaffleIndicatorController extends Controller
{
    ...
    public function beforeAction($action)
    {
        ...
        if (!isset($_GET['id']) && isset($_GET['id'])) {
            $model = WaffleIndicator::model()->find(
                'id = :id',
                array(
                    ':id' => $_GET['id']
                )
    ...
    public function actionCreate()
    {
        ...
        $this->performAjaxValidation($model, 'waffle-indicator-form');

        if (isset($_POST['WaffleIndicator'])) {
            $model->attributes = $_POST['WaffleIndicator'];
        ...
        } elseif (isset($_GET['WaffleIndicator'])) {
            $model->attributes = $_GET['WaffleIndicator'];
        }
    ...
    {
        $es = new TbEditableSaver('WaffleIndicator'); // classname of model to be updated
        $es->update();
    }
    ...
    {
        $dataProvider = new CActiveDataProvider('WaffleIndicator');
        $this->render('index', array('dataProvider' => $dataProvider,));
    }

    public function actionAdmin()
    {
        $model = new WaffleIndicator('search');
        $model->unsetAttributes();

        if (isset($_GET['WaffleIndicator'])) {
            $model->attributes = $_GET['WaffleIndicator'];
        }
    ...
    {
        $model = WaffleIndicator::model()->findByPk($id);
        if ($model === null) {
