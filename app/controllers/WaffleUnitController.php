...
class WaffleUnitController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        $this->performAjaxValidation($model, 'waffle-unit-form');

        if (isset($_POST['WaffleUnit'])) {
            $model->attributes = $_POST['WaffleUnit'];
        ...
        } elseif (isset($_GET['WaffleUnit'])) {
            $model->attributes = $_GET['WaffleUnit'];
        }
    ...
    {
        $es = new TbEditableSaver('WaffleUnit'); // classname of model to be updated
        $es->update();
    }
    ...
    {
        $dataProvider = new CActiveDataProvider('WaffleUnit');
        $this->render('index', array('dataProvider' => $dataProvider,));
    }

    public function actionAdmin()
    {
        $model = new WaffleUnit('search');
        $model->unsetAttributes();

        if (isset($_GET['WaffleUnit'])) {
            $model->attributes = $_GET['WaffleUnit'];
        }
    ...
    {
        $model = WaffleUnit::model()->findByPk($id);
        if ($model === null) {
    ...
    {
        if (isset($_POST['ajax']) && $_POST['ajax'] === 'waffle-unit-form') {
