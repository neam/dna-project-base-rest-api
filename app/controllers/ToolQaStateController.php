...
class ToolQaStateController extends Controller
{
    ...
    {
        $model = new ToolQaState;
        $model->scenario = $this->scenario;

        $this->performAjaxValidation($model, 'tool-qa-state-form');

        if (isset($_POST['ToolQaState'])) {
            $model->attributes = $_POST['ToolQaState'];
        ...
        } elseif (isset($_GET['ToolQaState'])) {
            $model->attributes = $_GET['ToolQaState'];
        }
    ...
    public function actionEditableSaver()
    {
        ...
        $es = new TbEditableSaver('ToolQaState'); // classname of model to be updated
        $es->update();
    }
    ...
    {
        $dataProvider = new CActiveDataProvider('ToolQaState');
        $this->render('index', array('dataProvider' => $dataProvider,));
    }

    public function actionAdmin()
    {
        $model = new ToolQaState('search');
        $model->unsetAttributes();

        if (isset($_GET['ToolQaState'])) {
            $model->attributes = $_GET['ToolQaState'];
        }
    ...
    {
        $model = ToolQaState::model()->findByPk($id);
        if ($model === null) {
    ...
    {
        if (isset($_POST['ajax']) && $_POST['ajax'] === 'tool-qa-state-form') {
