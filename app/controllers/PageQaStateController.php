...
class PageQaStateController extends Controller
{
    ...
    {
        $model = new PageQaState;
        $model->scenario = $this->scenario;

        $this->performAjaxValidation($model, 'page-qa-state-form');

        if (isset($_POST['PageQaState'])) {
            $model->attributes = $_POST['PageQaState'];
        ...
        } elseif (isset($_GET['PageQaState'])) {
            $model->attributes = $_GET['PageQaState'];
        }
    ...
    {
        $es = new TbEditableSaver('PageQaState'); // classname of model to be updated
        $es->update();
    }
    ...
    {
        $dataProvider = new CActiveDataProvider('PageQaState');
        $this->render('index', array('dataProvider' => $dataProvider,));
    }

    public function actionAdmin()
    {
        $model = new PageQaState('search');
        $model->unsetAttributes();

        if (isset($_GET['PageQaState'])) {
            $model->attributes = $_GET['PageQaState'];
        }
    ...
    {
        $model = PageQaState::model()->findByPk($id);
        if ($model === null) {
    ...
    {
        if (isset($_POST['ajax']) && $_POST['ajax'] === 'page-qa-state-form') {
