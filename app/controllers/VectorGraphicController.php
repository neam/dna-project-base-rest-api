...
class VectorGraphicController extends Controller
{
    ...
    public function beforeAction($action)
    {
        ...
        if (!isset($_GET['id']) && isset($_GET['id'])) {
            $model = VectorGraphic::model()->find(
                'id = :id',
                array(
                    ':id' => $_GET['id']
                )
    ...
    public function actionCreate()
    {
        ...
        $this->performAjaxValidation($model, 'vector-graphic-form');

        if (isset($_POST['VectorGraphic'])) {
            $model->attributes = $_POST['VectorGraphic'];
        ...
        } elseif (isset($_GET['VectorGraphic'])) {
            $model->attributes = $_GET['VectorGraphic'];
        }
    ...
    public function actionEditableSaver()
    {
        ...
        $es = new TbEditableSaver('VectorGraphic'); // classname of model to be updated
        $es->update();
    }
    ...
    {
        $dataProvider = new CActiveDataProvider('VectorGraphic');
        $this->render('index', array('dataProvider' => $dataProvider,));
    }

    public function actionAdmin()
    {
        $model = new VectorGraphic('search');
        $model->unsetAttributes();

        if (isset($_GET['VectorGraphic'])) {
            $model->attributes = $_GET['VectorGraphic'];
        }
    ...
    {
        $model = VectorGraphic::model()->findByPk($id);
        if ($model === null) {
    ...
    {
        if (isset($_POST['ajax']) && $_POST['ajax'] === 'vector-graphic-form') {
