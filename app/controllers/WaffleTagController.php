...
class WaffleTagController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        $this->performAjaxValidation($model, 'waffle-tag-form');

        if (isset($_POST['WaffleTag'])) {
            $model->attributes = $_POST['WaffleTag'];
        ...
        } elseif (isset($_GET['WaffleTag'])) {
            $model->attributes = $_GET['WaffleTag'];
        }
    ...
    {
        $es = new TbEditableSaver('WaffleTag'); // classname of model to be updated
        $es->update();
    }
    ...
    {
        $dataProvider = new CActiveDataProvider('WaffleTag');
        $this->render('index', array('dataProvider' => $dataProvider,));
    }

    public function actionAdmin()
    {
        $model = new WaffleTag('search');
        $model->unsetAttributes();

        if (isset($_GET['WaffleTag'])) {
            $model->attributes = $_GET['WaffleTag'];
        }
    ...
    {
        $model = WaffleTag::model()->findByPk($id);
        if ($model === null) {
    ...
    {
        if (isset($_POST['ajax']) && $_POST['ajax'] === 'waffle-tag-form') {
