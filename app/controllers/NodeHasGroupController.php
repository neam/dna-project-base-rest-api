...
class NodeHasGroupController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        $this->performAjaxValidation($model, 'node-has-group-form');

        if (isset($_POST['NodeHasGroup'])) {
            $model->attributes = $_POST['NodeHasGroup'];
        ...
        } elseif (isset($_GET['NodeHasGroup'])) {
            $model->attributes = $_GET['NodeHasGroup'];
        }
    ...
    {
        $es = new TbEditableSaver('NodeHasGroup'); // classname of model to be updated
        $es->update();
    }
    ...
    {
        $dataProvider = new CActiveDataProvider('NodeHasGroup');
        $this->render('index', array('dataProvider' => $dataProvider,));
    }

    public function actionAdmin()
    {
        $model = new NodeHasGroup('search');
        $model->unsetAttributes();

        if (isset($_GET['NodeHasGroup'])) {
            $model->attributes = $_GET['NodeHasGroup'];
        }
    ...
    {
        $model = NodeHasGroup::model()->findByPk($id);
        if ($model === null) {
    ...
    {
        if (isset($_POST['ajax']) && $_POST['ajax'] === 'node-has-group-form') {
