...
class EdgeController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        $this->performAjaxValidation($model, 'edge-form');
        ...
        } elseif (isset($_GET['Edge'])) {
            $model->attributes = $_GET['Edge'];
        }
    ...
    {
        $es = new TbEditableSaver('Edge'); // classname of model to be updated
        $es->update();
    }
    ...
    {
        $dataProvider = new CActiveDataProvider('Edge');
        $this->render('index', array('dataProvider' => $dataProvider,));
    }

    public function actionAdmin()
    {
        $model = new Edge('search');
    ...
    {
        if (isset($_POST['ajax']) && $_POST['ajax'] === 'edge-form') {
