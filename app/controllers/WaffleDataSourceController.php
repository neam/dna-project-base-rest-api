...
class WaffleDataSourceController extends Controller
{
    ...
    public function beforeAction($action)
    {
        ...
        if (!isset($_GET['id']) && isset($_GET['id'])) {
            $model = WaffleDataSource::model()->find(
                'id = :id',
                array(
                    ':id' => $_GET['id']
                )
    ...
    public function actionCreate()
    {
        ...
        $this->performAjaxValidation($model, 'waffle-data-source-form');

        if (isset($_POST['WaffleDataSource'])) {
            $model->attributes = $_POST['WaffleDataSource'];
        ...
        } elseif (isset($_GET['WaffleDataSource'])) {
            $model->attributes = $_GET['WaffleDataSource'];
        }
    ...
    {
        $es = new TbEditableSaver('WaffleDataSource'); // classname of model to be updated
        $es->update();
    }
    ...
    {
        $dataProvider = new CActiveDataProvider('WaffleDataSource');
        $this->render('index', array('dataProvider' => $dataProvider,));
    }

    public function actionAdmin()
    {
        $model = new WaffleDataSource('search');
        $model->unsetAttributes();

        if (isset($_GET['WaffleDataSource'])) {
            $model->attributes = $_GET['WaffleDataSource'];
        }
    ...
    {
        $model = WaffleDataSource::model()->findByPk($id);
        if ($model === null) {
    ...
    {
        if (isset($_POST['ajax']) && $_POST['ajax'] === 'waffle-data-source-form') {
