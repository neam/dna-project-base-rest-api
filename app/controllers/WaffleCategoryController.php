...
class WaffleCategoryController extends Controller
{
    use ItemController;

    public $modelClass = "WaffleCategory";
    ...
    public function beforeAction($action)
    {
        ...
        if (!isset($_GET['id']) && isset($_GET['id'])) {
            $model = WaffleCategory::model()->find(
                'id = :id',
                array(
                    ':id' => $_GET['id']
                )
    ...
    public function actionCreate()
    {
        ...
        $this->performAjaxValidation($model, 'waffle-category-form');

        if (isset($_POST['WaffleCategory'])) {
            $model->attributes = $_POST['WaffleCategory'];
        ...
        } elseif (isset($_GET['WaffleCategory'])) {
            $model->attributes = $_GET['WaffleCategory'];
        }
    ...
    {
        $es = new TbEditableSaver('WaffleCategory'); // classname of model to be updated
        $es->update();
    }
    ...
    {
        $dataProvider = new CActiveDataProvider('WaffleCategory');
        $this->render('index', array('dataProvider' => $dataProvider,));
    }

    public function actionAdmin()
    {
        $model = new WaffleCategory('search');
        $model->unsetAttributes();

        if (isset($_GET['WaffleCategory'])) {
            $model->attributes = $_GET['WaffleCategory'];
        }
    ...
    {
        $model = WaffleCategory::model()->findByPk($id);
        if ($model === null) {
    ...
    {
        if (isset($_POST['ajax']) && $_POST['ajax'] === 'waffle-category-form') {
