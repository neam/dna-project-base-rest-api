...
class ExamQuestionController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        $this->performAjaxValidation($model, 'exam-question-form');
        ...
        } elseif (isset($_GET['ExamQuestion'])) {
    ...
    public function actionEditableSaver()
    {
        ...
        $es = new TbEditableSaver('ExamQuestion'); // classname of model to be updated
        $es->update();
    }
