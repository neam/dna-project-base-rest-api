...
class PresentationController extends Controller
{
	...
	public function beforeAction($action)
	{
		...
		{
			$model = Presentation::model()->find('id = :id', array(
				':id' => $_GET['id']));
			if ($model !== null)
			{
				$_GET['id'] = $model->id;
	...
	public function actionCreate()
	{
		...
		$this->performAjaxValidation($model, 'presentation-form');
	...
	public function actionEditableSaver()
	{
		...
		$es = new EditableSaver('Presentation');  // classname of model to be updated
		$es->update();
	}
