...
class WaffleController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        $this->performAjaxValidation($model, 'waffle-form');

        if (isset($_POST['Waffle'])) {
            $model->attributes = $_POST['Waffle'];
        ...
        } elseif (isset($_GET['Waffle'])) {
            $model->attributes = $_GET['Waffle'];
        }
    ...
    {
        $es = new TbEditableSaver('Waffle'); // classname of model to be updated
        $es->update();
    }
    ...
    {
        $dataProvider = new CActiveDataProvider('Waffle');
        $this->render('index', array('dataProvider' => $dataProvider,));
    }

    public function actionAdmin()
    {
        $model = new Waffle('search');
        $model->unsetAttributes();

        if (isset($_GET['Waffle'])) {
            $model->attributes = $_GET['Waffle'];
        }
    ...
    {
        $model = Waffle::model()->findByPk($id);
        if ($model === null) {
