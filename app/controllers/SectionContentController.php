...
class SectionContentController extends Controller
{
    ...
    public function accessRules()
    {
        return array(
            array(
                ...
                'roles' => array('92f9838d.SectionContent.*'),
            ),
            array(
                'deny',
                'users' => array('*'),
    ...
    public function actionCreate()
    {
        ...
        $this->performAjaxValidation($model, 'section-content-form');

        if (isset($_POST['SectionContent'])) {
            $model->attributes = $_POST['SectionContent'];
        ...
        } elseif (isset($_GET['SectionContent'])) {
            $model->attributes = $_GET['SectionContent'];
        }
    ...
    {
        $dataProvider = new CActiveDataProvider('SectionContent');
        $this->render('index', array('dataProvider' => $dataProvider,));
    }

    public function actionAdmin()
    {
        $model = new SectionContent('search');
        $model->unsetAttributes();

        if (isset($_GET['SectionContent'])) {
            $model->attributes = $_GET['SectionContent'];
        }
    ...
    {
        if (isset($_POST['ajax']) && $_POST['ajax'] === 'section-content-form') {
