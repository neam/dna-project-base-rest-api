...
class TextDocQaStateController extends Controller
{
    ...
    public function beforeAction($action)
    {
        ...
        if (!isset($_GET['id']) && isset($_GET['id'])) {
            $model = TextDocQaState::model()->find(
                'id = :id',
                array(
                    ':id' => $_GET['id']
                )
    ...
    {
        $model = new TextDocQaState;
        $model->scenario = $this->scenario;

        $this->performAjaxValidation($model, 'text-doc-qa-state-form');

        if (isset($_POST['TextDocQaState'])) {
            $model->attributes = $_POST['TextDocQaState'];
        ...
        } elseif (isset($_GET['TextDocQaState'])) {
            $model->attributes = $_GET['TextDocQaState'];
        }
    ...
    public function actionEditableSaver()
    {
        ...
        $es = new TbEditableSaver('TextDocQaState'); // classname of model to be updated
        $es->update();
    }
    ...
    {
        $dataProvider = new CActiveDataProvider('TextDocQaState');
        $this->render('index', array('dataProvider' => $dataProvider,));
    }

    public function actionAdmin()
    {
        $model = new TextDocQaState('search');
        $model->unsetAttributes();

        if (isset($_GET['TextDocQaState'])) {
            $model->attributes = $_GET['TextDocQaState'];
        }
    ...
    {
        $model = TextDocQaState::model()->findByPk($id);
        if ($model === null) {
    ...
    {
        if (isset($_POST['ajax']) && $_POST['ajax'] === 'text-doc-qa-state-form') {
